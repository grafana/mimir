...
func NewMetrics(reg prometheus.Registerer) Metrics {
	return NewMetricsForComponent(reg, "ingester")
}

// NewMetricsForComponent creates lookup-planning metrics for a Mimir component.
func NewMetricsForComponent(reg prometheus.Registerer, component string) Metrics {
	...
	return Metrics{
		planningDuration: promauto.With(reg).NewHistogramVec(prometheus.HistogramOpts{
			Namespace:                       "cortex",
			Subsystem:                       component,
			Name:                            "lookup_planning_duration_seconds",
		...
		FilteredRatio: promauto.With(reg).NewHistogramVec(prometheus.HistogramOpts{
			Namespace:                   "cortex",
			Subsystem:                   component,
			Name:                        "lookup_planning_filtered_ratio",
		...
		IntersectionSizeRatio: promauto.With(reg).NewHistogramVec(prometheus.HistogramOpts{
			Namespace:                   "cortex",
			Subsystem:                   component,
			Name:                        "lookup_planning_index_selection_accuracy_ratio",
		...
		FinalCardinalityRatio: promauto.With(reg).NewHistogramVec(prometheus.HistogramOpts{
			Namespace:                   "cortex",
			Subsystem:                   component,
			Name:                        "lookup_planning_block_cardinality_accuracy_ratio",
