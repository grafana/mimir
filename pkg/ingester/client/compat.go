...
func ToResourceAttributesRequest(startMs, endMs int64, matchers []*labels.Matcher, limit int64, resourceAttrFilters []*ResourceAttrFilter) (*ResourceAttributesRequest, error) {
	ms, err := ToLabelMatchers(matchers)
	if err != nil {
		return nil, err
	}
