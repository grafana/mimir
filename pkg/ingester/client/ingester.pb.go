...
const (
	...
	// FUZZ_ALG_SUBSTRING_LEFT applies no fuzzy matching: a plain substring
	// match, scoring higher for matches further left in the value.
	FUZZ_ALG_SUBSTRING_LEFT SearchFilter_FuzzAlg = 2
	// FUZZ_ALG_SUBSTRING applies no fuzzy matching: a plain substring match,
	// scoring 1.0 regardless of match position.
	FUZZ_ALG_SUBSTRING SearchFilter_FuzzAlg = 3
)

var SearchFilter_FuzzAlg_name = map[int32]string{
	0: "FUZZ_ALG_SUBSEQUENCE",
	1: "FUZZ_ALG_JARO_WINKLER",
	2: "FUZZ_ALG_SUBSTRING_LEFT",
	3: "FUZZ_ALG_SUBSTRING",
}

var SearchFilter_FuzzAlg_value = map[string]int32{
	"FUZZ_ALG_SUBSEQUENCE":    0,
	"FUZZ_ALG_JARO_WINKLER":   1,
	"FUZZ_ALG_SUBSTRING_LEFT": 2,
	"FUZZ_ALG_SUBSTRING":      3,
}

func (SearchFilter_FuzzAlg) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_60f6df4f3586b478, []int{9, 0}
}
...
type SearchFilter struct {
	...
	// Empty means no cursor is in effect. When set, the server excludes
	// values already returned by an earlier page from its own local result
	// set before applying limit, so a resumed search does not re-return the
	// same top-N candidates on every page. See
	...
	// resume_after is non-empty and the effective ordering is sort_by=score;
	// 0.0 is a legitimate score and carries no meaning on its own. The server
	// excludes any candidate whose (score, value) pair — under the same
	// (Score desc, Value asc) total order the merge layer already uses to
	// break score ties — is at or before this resume point. See
	// docs/superpowers/specs/2026-09-23-search-cursor-pagination-score-ordering-design.md.
	ScoreAfter float64 `protobuf:"fixed64,7,opt,name=score_after,json=scoreAfter,proto3" json:"score_after,omitempty"`
}
...
func (m *SearchFilter) GetExpression() string {
	if m != nil {
		return m.Expression
	}
	return ""
...
func (m *SearchFilter) GetResumeAfter() string {
	if m != nil {
...
func (m *SearchFilter) GetScoreAfter() float64 {
	if m != nil {
		return m.ScoreAfter
	}
	return 0
...
func (*SearchResultBatch_Result) Descriptor() ([]byte, []int) {
	return fileDescriptor_60f6df4f3586b478, []int{12, 0}
}
...
var fileDescriptor_60f6df4f3586b478 = []byte{
	...
	,
}
...
func (this *SearchFilter) Equal(that interface{}) bool {
	...
	if this.ResumeAfter != that1.ResumeAfter {
		return false
	}
	if this.ScoreAfter != that1.ScoreAfter {
		return false
	}
	return true
}
...
func (this *SearchFilter) GoString() string {
	...
	s = append(s, "ResumeAfter: "+fmt.Sprintf("%#v", this.ResumeAfter)+",\n")
	s = append(s, "ScoreAfter: "+fmt.Sprintf("%#v", this.ScoreAfter)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *SearchFilter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ScoreAfter != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.ScoreAfter))))
		i--
		dAtA[i] = 0x39
	}
	if len(m.ResumeAfter) > 0 {
		i -= len(m.ResumeAfter)
		copy(dAtA[i:], m.ResumeAfter)
		i = encodeVarintIngester(dAtA, i, uint64(len(m.ResumeAfter)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Expression) > 0 {
		...
		i = encodeVarintIngester(dAtA, i, uint64(len(m.Expression)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *ActiveSeriesResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BucketCount) > 0 {
		dAtA7 := make([]byte, len(m.BucketCount)*10)
		var j6 int
		...
		i = encodeVarintIngester(dAtA, i, uint64(j6))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Metric) > 0 {
...
func (this *SearchFilter) String() string {
	...
	s := strings.Join([]string{`&SearchFilter{`,
		...
		`ResumeAfter:` + fmt.Sprintf("%v", this.ResumeAfter) + `,`,
		`ScoreAfter:` + fmt.Sprintf("%v", this.ScoreAfter) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *SearchFilter) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResumeAfter", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ResumeAfter = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 7:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field ScoreAfter", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			iNdEx += 8
			m.ScoreAfter = float64(math.Float64frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipIngester(dAtA[iNdEx:])
			if err != nil {
