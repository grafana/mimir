...
type LabelValuesCardinalityRequest struct {
	...
	ActiveSeriesOnly bool            `protobuf:"varint,3,opt,name=active_series_only,json=activeSeriesOnly,proto3" json:"active_series_only,omitempty"`
}
...
func (m *LabelValuesCardinalityRequest) GetActiveSeriesOnly() bool {
	if m != nil {
		return m.ActiveSeriesOnly
	}
	return false
}
...
type UserStatsRequest struct {
	ActiveSeriesOnly bool `protobuf:"varint,1,opt,name=active_series_only,json=activeSeriesOnly,proto3" json:"active_series_only,omitempty"`
}
...
func (m *UserStatsRequest) GetActiveSeriesOnly() bool {
	if m != nil {
		return m.ActiveSeriesOnly
	}
	return false
...
var fileDescriptor_60f6df4f3586b478 = []byte{
	...
	,
}
...
func (this *LabelValuesCardinalityRequest) Equal(that interface{}) bool {
	...
	if this.ActiveSeriesOnly != that1.ActiveSeriesOnly {
		return false
	}
	return true
}
...
func (this *LabelValuesCardinalityRequest) GoString() string {
	...
	s = append(s, "ActiveSeriesOnly: "+fmt.Sprintf("%#v", this.ActiveSeriesOnly)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *LabelValuesCardinalityRequest) String() string {
	...
	s := strings.Join([]string{`&LabelValuesCardinalityRequest{`,
		...
		`Matchers:` + repeatedStringForMatchers + `,`,
		`ActiveSeriesOnly:` + fmt.Sprintf("%v", this.ActiveSeriesOnly) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *LabelValuesCardinalityRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ActiveSeriesOnly", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
