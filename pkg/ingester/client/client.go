...
// PushReusable pushes a mimirpb.ReusableWriteRequest.
// It's a copy of the autogenerated ingesterClient.Push, but with changed `in` type.
func (c *ingesterClient) PushReusable(ctx context.Context, in *mimirpb.ReusableWriteRequest, opts ...grpc.CallOption) (*mimirpb.WriteResponse, error) {
...
type ReusableIngesterClient interface {
	PushReusable(ctx context.Context, in *mimirpb.ReusableWriteRequest, opts ...grpc.CallOption) (*mimirpb.WriteResponse, error)
}
