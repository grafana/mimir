...
func newMirroredChunkQuerierWithMeta(comparisonOutcomes *prometheus.CounterVec, minT, maxT int64, blockMeta tsdb.BlockMeta, logger log.Logger, q storage.ChunkQuerier) *mirroredChunkQuerier {
