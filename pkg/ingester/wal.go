...
// Provenance-includes-location: https://github.com/cortexproject/cortex/blob/master/pkg/ingester/wal.go
...
func processCheckpointWithRepair(params walRecoveryParameters) (*userStates, int, error) {
	...
	userStates := newUserStates(params.ingester.limiter, params.ingester.cfg, params.ingester.metrics, params.ingester.logger, params.ingester.activeSeriesMatcher)
