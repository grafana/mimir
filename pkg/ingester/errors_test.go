...
// writeErrorDetails returns the mimirpb.WriteErrorDetails object
// stored in this error's status, if any or nil otherwise.
...
// equals returns true if the given error and this error are equal, i.e.,
// if they are both of type errorWithStatus, if their underlying statuses
// have the same code, messages, and if both have either no details, or
// exactly one detail of type mimirpb.WriteErrorDetails, which are equal too.
