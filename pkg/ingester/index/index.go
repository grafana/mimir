...
// Provenance-includes-location: https://github.com/cortexproject/cortex/blob/master/pkg/ingester/index/index.go
...
func (ii *InvertedIndex) Add(labels []mimirpb.LabelAdapter, fp model.Fingerprint) labels.Labels {
...
func (shard *indexShard) add(metric []mimirpb.LabelAdapter, fp model.Fingerprint) labels.Labels {
	shard.mtx.Lock()
