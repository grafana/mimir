...
type CompactionJobStats struct {
	TotalBlocksBytes uint64 `protobuf:"varint,1,opt,name=total_blocks_bytes,json=totalBlocksBytes,proto3" json:"total_blocks_bytes,omitempty"`
}

func (m *CompactionJobStats) Reset()      { *m = CompactionJobStats{} }
func (*CompactionJobStats) ProtoMessage() {}
func (*CompactionJobStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_cc7d2e2996592602, []int{2}
}
func (m *CompactionJobStats) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CompactionJobStats) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CompactionJobStats.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CompactionJobStats) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CompactionJobStats.Merge(m, src)
}
func (m *CompactionJobStats) XXX_Size() int {
	return m.Size()
}
func (m *CompactionJobStats) XXX_DiscardUnknown() {
	xxx_messageInfo_CompactionJobStats.DiscardUnknown(m)
}

var xxx_messageInfo_CompactionJobStats proto.InternalMessageInfo

func (m *CompactionJobStats) GetTotalBlocksBytes() uint64 {
	if m != nil {
...
type CompactionJob struct {
	...
	Stats    *CompactionJobStats `protobuf:"bytes,3,opt,name=stats,proto3" json:"stats,omitempty"`
}
...
func (m *CompactionJob) GetStats() *CompactionJobStats {
	if m != nil {
		return m.Stats
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*CompactionJobStats)(nil), "compactorschedulerpb.CompactionJobStats")
...
var fileDescriptor_cc7d2e2996592602 = []byte{
	...
	,
}
...
func (this *CompactionJobStats) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CompactionJobStats)
	if !ok {
		that2, ok := that.(CompactionJobStats)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CompactionJobStats) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&compactorschedulerpb.CompactionJobStats{")
...
func (m *CompactionJobStats) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CompactionJobStats) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CompactionJobStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CompactionJobStats) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *CompactionJobStats) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CompactionJobStats{`,
...
func (this *CompactionJob) String() string {
	...
	s := strings.Join([]string{`&CompactionJob{`,
		...
		`Stats:` + strings.Replace(this.Stats.String(), "CompactionJobStats", "CompactionJobStats", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *CompactionJobStats) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CompactionJobStats: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CompactionJobStats: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
