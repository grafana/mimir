...
func (cfg *Config) RegisterFlags(f *flag.FlagSet) {
	...
	f.DurationVar(&cfg.CleanupInterval, "compactor-scheduler.cleanup-interval", 20*time.Minute, "The duration of time between when cleanup jobs are submitted aligned by UTC. Set to 0 to disable cleanup job submission.")
