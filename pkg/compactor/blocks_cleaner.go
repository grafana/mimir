...
type BlocksCleanerConfig struct {
	...
	BlockDeletionMarksMigrationEnabled bool          // TODO Discuss whether we should remove it in Mimir 1.8.0 and document that upgrading to 1.7.0 before 1.8.0 is required.
