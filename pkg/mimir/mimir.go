...
func (c *Config) validateFilesystemPaths(logger log.Logger) error {
	...
	if c.isAnyModuleEnabled(All, Write, Read, Backend, Ingester, Querier, StoreGateway, Compactor, ParquetCompactor, Ruler) && c.BlocksStorage.Bucket.Backend == bucket.Filesystem {
