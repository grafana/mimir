...
func (c *Config) RegisterFlags(f *flag.FlagSet, logger log.Logger) {
	...
	f.DurationVar(&c.CostAttributionCoolDownDuration, "cost-attribution-cool-down-duration", 20*time.Minute, "Duration during which any cost attribution for a user will be marked as __unaccounted__ after exceeding the specified limit, prior to resetting the cache.")
