...
func (t *Mimir) initQueryFrontendTripperware() (serv services.Service, err error) {
	...
	case querier.MimirEngine:
		var err error
		t.QueryFrontendStreamingEngine, err = streamingpromql.NewEngine(mqeOpts, streamingpromql.NewStaticQueryLimitsProvider(0, false), stats.NewQueryMetrics(mqeOpts.CommonOpts.Reg), t.QueryFrontendQueryPlanner)
		if err != nil {
...
func (t *Mimir) initQuerierQueryPlanner() (services.Service, error) {
	...
	if !t.Cfg.isQueryFrontendEnabled() {
		limitsProvider := querier.NewTenantQueryLimitsProvider(t.Overrides, mqeOpts)
