...
func (t *Mimir) initQueryFrontend() (serv services.Service, err error) {
	...
	roundTripper, frontendV1, frontendV2, err := frontend.InitFrontendDownstreamClient(t.Cfg.Frontend, t.Overrides, t.Overrides, t.Cfg.Server.GRPCListenPort, util_log.Logger, t.Registerer)
	if err != nil {
		return nil, err
	}
