...
const (
	// ringNumTokens is how many tokens each parquet-converter should have in the ring. We use a
...
// many options not really required by the parquet-converters ring. This config
...
func (cfg *RingConfig) RegisterFlags(f *flag.FlagSet, logger log.Logger) {
	const flagNamePrefix = "parquet-converter.ring."
	const kvStorePrefix = "parquet-converters/"
	const componentPlural = "parquet-converters"
