...
func (m *StatsData) GetWallTime() time.Duration {
	if m != nil {
		return m.WallTime
	}
	return 0
...
func (m *StatsData) GetFetchedSeriesCount() uint64 {
	if m != nil {
...
func (m *StatsData) GetFetchedChunkBytes() uint64 {
	if m != nil {
...
func (m *StatsData) GetFetchedChunksCount() uint64 {
	if m != nil {
...
func (m *StatsData) GetShardedQueries() uint32 {
	if m != nil {
...
func (m *StatsData) GetSplitQueries() uint32 {
	if m != nil {
...
func (m *StatsData) GetFetchedIndexBytes() uint64 {
	if m != nil {
...
func (m *StatsData) GetEstimatedSeriesCount() uint64 {
	if m != nil {
...
func (m *StatsData) GetQueueTime() time.Duration {
	if m != nil {
		return m.QueueTime
	}
	return 0
...
func (m *StatsData) GetEncodeTime() time.Duration {
	if m != nil {
		return m.EncodeTime
	}
	return 0
...
func (m *StatsData) GetSamplesProcessed() uint64 {
	if m != nil {
...
func (m *StatsData) GetSpunOffSubqueries() uint32 {
	if m != nil {
...
func (m *StatsData) GetSamplesProcessedPerStep() []StepStat {
	if m != nil {
...
func init() {
	proto.RegisterType((*StatsData)(nil), "stats.StatsData")
...
var fileDescriptor_b4756a0aec8b9d44 = []byte{
	...
	,
}

func (this *StatsData) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StatsData)
	if !ok {
		that2, ok := that.(StatsData)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *StatsData) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 17)
	s = append(s, "&stats.StatsData{")
...
func (m *StatsData) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *StatsData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StatsData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (this *StatsData) String() string {
	if this == nil {
		return "nil"
	}
	...
	s := strings.Join([]string{`&StatsData{`,
...
func (m *StatsData) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: StatsData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StatsData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
