...
type Stats struct {
	...
	FetchedChunks uint64 `protobuf:"varint,4,opt,name=fetched_chunks,json=fetchedChunks,proto3" json:"fetched_chunks,omitempty"`
}
...
func (m *Stats) GetFetchedChunks() uint64 {
	if m != nil {
		return m.FetchedChunks
	}
	return 0
}
...
var fileDescriptor_b4756a0aec8b9d44 = []byte{
	...
	,
}
...
func (this *Stats) Equal(that interface{}) bool {
	...
	if this.FetchedChunks != that1.FetchedChunks {
		return false
	}
	return true
}
func (this *Stats) GoString() string {
	...
	s = append(s, "FetchedChunks: "+fmt.Sprintf("%#v", this.FetchedChunks)+",\n")
	s = append(s, "}")
...
func (m *Stats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.FetchedChunks != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.FetchedChunks))
		i--
		dAtA[i] = 0x20
	}
...
func (m *Stats) Size() (n int) {
	...
	if m.FetchedChunks != 0 {
		n += 1 + sovStats(uint64(m.FetchedChunks))
	}
	return n
}
...
func (this *Stats) String() string {
	...
	s := strings.Join([]string{`&Stats{`,
		...
		`FetchedChunks:` + fmt.Sprintf("%v", this.FetchedChunks) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Stats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FetchedChunks", wireType)
			}
			m.FetchedChunks = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FetchedChunks |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
