...
func TestStats_Merge(t *testing.T) {
	t.Run("merge two stats objects", func(t *testing.T) {
		...
		stats1.AddRetries(2)
		stats1.AddReadcacheQueryStreamCalls(3)
		...
		stats2.AddRetries(3)
		stats2.AddReadcacheQueryStreamCalls(4)
		...
		assert.Equal(t, uint32(7), stats1.LoadReadcacheQueryStreamCalls())
	...
	t.Run("merge two nil stats objects", func(t *testing.T) {
		...
		assert.Equal(t, uint32(0), stats1.LoadReadcacheQueryStreamCalls())
...
func TestStats_ConcurrentMerge(t *testing.T) {
	...
	for i := 0; i < numChildren; i++ {
		...
		child.AddRetries(2)
		child.AddReadcacheQueryStreamCalls(3)
	...
	expectedReadcacheQueryStreamCalls := uint32(numChildren * 3)
	...
	assert.Equal(t, expectedReadcacheQueryStreamCalls, parentStats.LoadReadcacheQueryStreamCalls(), "ReadcacheQueryStreamCalls should be sum of all children")
