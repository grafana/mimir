...
func TestTracingMergeQueryable(t *testing.T) {
	...
	assertSpanExists(t, spans,
		"mergeQuerier.Select",
		attribute.String(spanlogger.TenantIDsTagName, "team-a,team-b"), // TODO: oleg fix after we merge https://github.com/grafana/dskit/pull/690
	)
	assertSpanExists(t, spans,
		"mockTenantQuerier.select",
		attribute.String(spanlogger.TenantIDsTagName, "team-a"),
	)
	assertSpanExists(t, spans,
		"mockTenantQuerier.select",
		attribute.String(spanlogger.TenantIDsTagName, "team-b"),
	)
}
