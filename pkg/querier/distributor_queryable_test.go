...
func (m *mockDistributor) SearchLabelNames(ctx context.Context, from, to model.Time, hints *mimirstorage.MimirSearchHints, matchers ...*labels.Matcher) (mimirstorage.SearchResultSet, error) {
	args := m.Called(ctx, from, to, hints, matchers)
	return args.Get(0).(mimirstorage.SearchResultSet), args.Error(1)
}
func (m *mockDistributor) SearchLabelValues(ctx context.Context, from, to model.Time, label model.LabelName, hints *mimirstorage.MimirSearchHints, matchers ...*labels.Matcher) (mimirstorage.SearchResultSet, error) {
