...
// Provenance-includes-location: https://github.com/prometheus-community/parquet-common/blob/382b6ec8ae40fb5dcdcabd8019f69a4be1cd8869/search/materialize.go
...
func (m *Materializer) Materialize(ctx context.Context, rgi int, mint, maxt int64, skipChunks bool, rr []RowRange) ([]prom_storage.ChunkSeries, error) {
	...
	for i, s := range sLbls {
		sortFunc := func(a, b labels.Label) int {
			if a.Name < b.Name {
				return -1
