...
func (MetadataRW2_MetricType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{29, 0}
}
...
type QueryResponse struct {
	...
	// Typed annotation errors for proper merging across sharded queries.
	Warnings []AnnotationError `protobuf:"bytes,10,rep,name=warnings,proto3" json:"warnings"`
	Infos    []AnnotationError `protobuf:"bytes,11,rep,name=infos,proto3" json:"infos"`
}
...
func (m *QueryResponse) GetWarnings() []AnnotationError {
	if m != nil {
		return m.Warnings
	}
	return nil
...
func (m *QueryResponse) GetInfos() []AnnotationError {
	if m != nil {
		return m.Infos
	}
	return nil
...
// AnnotationHistogramQuantileForcedMonotonicityData holds type-specific fields for
// histogramQuantileForcedMonotonicityErr annotations.
type AnnotationHistogramQuantileForcedMonotonicityData struct {
	Count     int32   `protobuf:"varint,1,opt,name=count,proto3" json:"count,omitempty"`
	MinTs     int64   `protobuf:"varint,2,opt,name=min_ts,json=minTs,proto3" json:"min_ts,omitempty"`
	MaxTs     int64   `protobuf:"varint,3,opt,name=max_ts,json=maxTs,proto3" json:"max_ts,omitempty"`
	MinBucket float64 `protobuf:"fixed64,4,opt,name=min_bucket,json=minBucket,proto3" json:"min_bucket,omitempty"`
	MaxBucket float64 `protobuf:"fixed64,5,opt,name=max_bucket,json=maxBucket,proto3" json:"max_bucket,omitempty"`
	MaxDiff   float64 `protobuf:"fixed64,6,opt,name=max_diff,json=maxDiff,proto3" json:"max_diff,omitempty"`
}

func (m *AnnotationHistogramQuantileForcedMonotonicityData) Reset() {
	*m = AnnotationHistogramQuantileForcedMonotonicityData{}
}
func (*AnnotationHistogramQuantileForcedMonotonicityData) ProtoMessage() {}
func (*AnnotationHistogramQuantileForcedMonotonicityData) Descriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{17}
}
func (m *AnnotationHistogramQuantileForcedMonotonicityData) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AnnotationHistogramQuantileForcedMonotonicityData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AnnotationHistogramQuantileForcedMonotonicityData.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AnnotationHistogramQuantileForcedMonotonicityData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AnnotationHistogramQuantileForcedMonotonicityData.Merge(m, src)
}
func (m *AnnotationHistogramQuantileForcedMonotonicityData) XXX_Size() int {
	return m.Size()
}
func (m *AnnotationHistogramQuantileForcedMonotonicityData) XXX_DiscardUnknown() {
	xxx_messageInfo_AnnotationHistogramQuantileForcedMonotonicityData.DiscardUnknown(m)
}

var xxx_messageInfo_AnnotationHistogramQuantileForcedMonotonicityData proto.InternalMessageInfo

func (m *AnnotationHistogramQuantileForcedMonotonicityData) GetCount() int32 {
	if m != nil {
		return m.Count
	}
	return 0
...
func (m *AnnotationHistogramQuantileForcedMonotonicityData) GetMinTs() int64 {
	if m != nil {
		return m.MinTs
	}
	return 0
...
func (m *AnnotationHistogramQuantileForcedMonotonicityData) GetMaxTs() int64 {
	if m != nil {
		return m.MaxTs
	}
	return 0
...
func (m *AnnotationHistogramQuantileForcedMonotonicityData) GetMinBucket() float64 {
	if m != nil {
		return m.MinBucket
	}
	return 0
...
func (m *AnnotationHistogramQuantileForcedMonotonicityData) GetMaxBucket() float64 {
	if m != nil {
		return m.MaxBucket
	}
	return 0
...
func (m *AnnotationHistogramQuantileForcedMonotonicityData) GetMaxDiff() float64 {
	if m != nil {
		return m.MaxDiff
	}
	return 0
...
// AnnotationError represents a typed PromQL annotation that can be properly
// merged across sharded queries, preserving Merge() semantics (e.g. count
// accumulation for histogramQuantileForcedMonotonicityErr).
// The annotation type is determined by which oneof variant is set:
// no variant set = generic annotation; histogram_quantile set = histogramQuantileForcedMonotonicityErr.
type AnnotationError struct {
	// The error message from Err.Error() — used as the deduplication/merge key.
	Message string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
	// Pre-computed "line:col" label (e.g. "1:25") for rendering the position
	// suffix without needing the full query string.
	PositionLabel string `protobuf:"bytes,2,opt,name=position_label,json=positionLabel,proto3" json:"position_label,omitempty"`
	// Type-specific data. No variant set = generic annotation.
	//
	// Types that are valid to be assigned to Data:
	//
	//	*AnnotationError_HistogramQuantile
	Data isAnnotationError_Data `protobuf_oneof:"data"`
}

func (m *AnnotationError) Reset()      { *m = AnnotationError{} }
func (*AnnotationError) ProtoMessage() {}
func (*AnnotationError) Descriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{18}
}
func (m *AnnotationError) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AnnotationError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AnnotationError.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AnnotationError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AnnotationError.Merge(m, src)
}
func (m *AnnotationError) XXX_Size() int {
	return m.Size()
}
func (m *AnnotationError) XXX_DiscardUnknown() {
	xxx_messageInfo_AnnotationError.DiscardUnknown(m)
}

var xxx_messageInfo_AnnotationError proto.InternalMessageInfo

type isAnnotationError_Data interface {
	isAnnotationError_Data()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type AnnotationError_HistogramQuantile struct {
	HistogramQuantile *AnnotationHistogramQuantileForcedMonotonicityData `protobuf:"bytes,3,opt,name=histogram_quantile,json=histogramQuantile,proto3,oneof" json:"histogram_quantile,omitempty"`
}

func (*AnnotationError_HistogramQuantile) isAnnotationError_Data() {}

func (m *AnnotationError) GetData() isAnnotationError_Data {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *AnnotationError) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
...
func (m *AnnotationError) GetPositionLabel() string {
	if m != nil {
		return m.PositionLabel
	}
	return ""
}

func (m *AnnotationError) GetHistogramQuantile() *AnnotationHistogramQuantileForcedMonotonicityData {
	if x, ok := m.GetData().(*AnnotationError_HistogramQuantile); ok {
		return x.HistogramQuantile
	}
	return nil
}

// XXX_OneofWrappers is for the internal use of the proto package.
func (*AnnotationError) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*AnnotationError_HistogramQuantile)(nil),
	}
}
...
func (*ExemplarRW2) Descriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{28}
}
...
func (*MetadataRW2) Descriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{29}
}
...
func init() {
	...
	proto.RegisterType((*AnnotationHistogramQuantileForcedMonotonicityData)(nil), "cortexpb.AnnotationHistogramQuantileForcedMonotonicityData")
	proto.RegisterType((*AnnotationError)(nil), "cortexpb.AnnotationError")
...
var fileDescriptor_86d4d7485f544059 = []byte{
	...
	,
}
...
func (x QueryErrorType) String() string {
	s, ok := QueryErrorType_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *AnnotationHistogramQuantileForcedMonotonicityData) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AnnotationHistogramQuantileForcedMonotonicityData)
	if !ok {
		that2, ok := that.(AnnotationHistogramQuantileForcedMonotonicityData)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.MinTs != that1.MinTs {
		return false
	}
	if this.MaxTs != that1.MaxTs {
		return false
	}
	if this.MinBucket != that1.MinBucket {
		return false
	}
	if this.MaxBucket != that1.MaxBucket {
		return false
	}
	if this.MaxDiff != that1.MaxDiff {
		return false
	}
	return true
}
func (this *AnnotationError) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AnnotationError)
	if !ok {
		that2, ok := that.(AnnotationError)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.PositionLabel != that1.PositionLabel {
		return false
	}
	if that1.Data == nil {
		if this.Data != nil {
...
func (this *AnnotationError_HistogramQuantile) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AnnotationError_HistogramQuantile)
	if !ok {
		that2, ok := that.(AnnotationError_HistogramQuantile)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.HistogramQuantile.Equal(that1.HistogramQuantile) {
		return false
	}
	return true
}
...
func (this *QueryResponse) GoString() string {
	...
	if this.Warnings != nil {
		vs := make([]AnnotationError, len(this.Warnings))
		for i := range vs {
	...
	if this.Infos != nil {
		vs := make([]AnnotationError, len(this.Infos))
		for i := range vs {
			vs[i] = this.Infos[i]
		}
...
func (this *AnnotationHistogramQuantileForcedMonotonicityData) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 10)
	s = append(s, "&mimirpb.AnnotationHistogramQuantileForcedMonotonicityData{")
	s = append(s, "Count: "+fmt.Sprintf("%#v", this.Count)+",\n")
	s = append(s, "MinTs: "+fmt.Sprintf("%#v", this.MinTs)+",\n")
	s = append(s, "MaxTs: "+fmt.Sprintf("%#v", this.MaxTs)+",\n")
	s = append(s, "MinBucket: "+fmt.Sprintf("%#v", this.MinBucket)+",\n")
	s = append(s, "MaxBucket: "+fmt.Sprintf("%#v", this.MaxBucket)+",\n")
	s = append(s, "MaxDiff: "+fmt.Sprintf("%#v", this.MaxDiff)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *AnnotationError) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&mimirpb.AnnotationError{")
	s = append(s, "Message: "+fmt.Sprintf("%#v", this.Message)+",\n")
	s = append(s, "PositionLabel: "+fmt.Sprintf("%#v", this.PositionLabel)+",\n")
	if this.Data != nil {
		s = append(s, "Data: "+fmt.Sprintf("%#v", this.Data)+",\n")
	}
	s = append(s, "}")
...
func (this *AnnotationError_HistogramQuantile) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&mimirpb.AnnotationError_HistogramQuantile{` +
		`HistogramQuantile:` + fmt.Sprintf("%#v", this.HistogramQuantile) + `}`}, ", ")
	return s
}
...
func (m *AnnotationHistogramQuantileForcedMonotonicityData) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AnnotationHistogramQuantileForcedMonotonicityData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AnnotationHistogramQuantileForcedMonotonicityData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.MaxDiff != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.MaxDiff))))
		i--
		dAtA[i] = 0x31
	}
	if m.MaxBucket != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.MaxBucket))))
		i--
		dAtA[i] = 0x29
	}
	if m.MinBucket != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.MinBucket))))
		i--
		dAtA[i] = 0x21
	}
	if m.MaxTs != 0 {
		i = encodeVarintMimir(dAtA, i, uint64(m.MaxTs))
		i--
		dAtA[i] = 0x18
	}
	if m.MinTs != 0 {
		i = encodeVarintMimir(dAtA, i, uint64(m.MinTs))
		i--
		dAtA[i] = 0x10
	}
	if m.Count != 0 {
		i = encodeVarintMimir(dAtA, i, uint64(m.Count))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *AnnotationError) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AnnotationError) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AnnotationError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.PositionLabel) > 0 {
		i -= len(m.PositionLabel)
		copy(dAtA[i:], m.PositionLabel)
		i = encodeVarintMimir(dAtA, i, uint64(len(m.PositionLabel)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Message) > 0 {
		...
		i = encodeVarintMimir(dAtA, i, uint64(len(m.Message)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *AnnotationError_HistogramQuantile) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AnnotationError_HistogramQuantile) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.HistogramQuantile != nil {
		{
			size, err := m.HistogramQuantile.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TimeSeriesRW2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LabelsRefs) > 0 {
		...
		// End modified code.
		i = encodeVarintMimir(dAtA, i, uint64(j22))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ExemplarRW2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LabelsRefs) > 0 {
		...
		slices.Reverse(dAtA[i:start])
		// End modified code.
		i = encodeVarintMimir(dAtA, i, uint64(j24))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ErrorDetails) Size() (n int) {
	...
	if m.RejectedSamples != 0 {
		n += 1 + sovMimir(uint64(m.RejectedSamples))
	}
	return n
}
...
func (m *AnnotationHistogramQuantileForcedMonotonicityData) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.Count != 0 {
		n += 1 + sovMimir(uint64(m.Count))
	}
	if m.MinTs != 0 {
		n += 1 + sovMimir(uint64(m.MinTs))
	}
	if m.MaxTs != 0 {
		n += 1 + sovMimir(uint64(m.MaxTs))
	}
	if m.MinBucket != 0 {
		n += 9
	}
...
func (m *AnnotationError) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AnnotationError_HistogramQuantile) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *QueryResponse) String() string {
	...
	for _, f := range this.Warnings {
		repeatedStringForWarnings += strings.Replace(strings.Replace(f.String(), "AnnotationError", "AnnotationError", 1), `&`, ``, 1) + ","
	}
	repeatedStringForWarnings += "}"
	repeatedStringForInfos := "[]AnnotationError{"
	for _, f := range this.Infos {
		repeatedStringForInfos += strings.Replace(strings.Replace(f.String(), "AnnotationError", "AnnotationError", 1), `&`, ``, 1) + ","
	}
...
func (this *AnnotationHistogramQuantileForcedMonotonicityData) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AnnotationHistogramQuantileForcedMonotonicityData{`,
		`Count:` + fmt.Sprintf("%v", this.Count) + `,`,
		`MinTs:` + fmt.Sprintf("%v", this.MinTs) + `,`,
		`MaxTs:` + fmt.Sprintf("%v", this.MaxTs) + `,`,
		`MinBucket:` + fmt.Sprintf("%v", this.MinBucket) + `,`,
		`MaxBucket:` + fmt.Sprintf("%v", this.MaxBucket) + `,`,
		`MaxDiff:` + fmt.Sprintf("%v", this.MaxDiff) + `,`,
		`}`,
	}, "")
	return s
}
func (this *AnnotationError) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AnnotationError{`,
		`Message:` + fmt.Sprintf("%v", this.Message) + `,`,
		`PositionLabel:` + fmt.Sprintf("%v", this.PositionLabel) + `,`,
		`Data:` + fmt.Sprintf("%v", this.Data) + `,`,
		`}`,
	}, "")
	return s
}
func (this *AnnotationError_HistogramQuantile) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AnnotationError_HistogramQuantile{`,
		`HistogramQuantile:` + strings.Replace(fmt.Sprintf("%v", this.HistogramQuantile), "AnnotationHistogramQuantileForcedMonotonicityData", "AnnotationHistogramQuantileForcedMonotonicityData", 1) + `,`,
		`}`,
	}, "")
	return s
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RejectedSamples |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= QueryStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ErrorType |= QueryErrorType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 10:
			...
			m.Warnings = append(m.Warnings, AnnotationError{})
		...
		case 11:
			...
			m.Infos = append(m.Infos, AnnotationError{})
...
func (m *AnnotationHistogramQuantileForcedMonotonicityData) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AnnotationHistogramQuantileForcedMonotonicityData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AnnotationHistogramQuantileForcedMonotonicityData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 4:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinBucket", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.MinBucket = float64(math.Float64frombits(v))
		case 5:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxBucket", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.MaxBucket = float64(math.Float64frombits(v))
		case 6:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxDiff", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.MaxDiff = float64(math.Float64frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipMimir(dAtA[iNdEx:])
			if err != nil {
...
func (m *AnnotationError) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AnnotationError: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AnnotationError: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PositionLabel", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PositionLabel = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HistogramQuantile", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &AnnotationHistogramQuantileForcedMonotonicityData{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Data = &AnnotationError_HistogramQuantile{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipMimir(dAtA[iNdEx:])
