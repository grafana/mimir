...
type WriteErrorDetails struct {
	Cause ErrorCause `protobuf:"varint,1,opt,name=Cause,proto3,enum=cortexpb.ErrorCause" json:"Cause,omitempty"`
}

func (m *WriteErrorDetails) Reset()      { *m = WriteErrorDetails{} }
func (*WriteErrorDetails) ProtoMessage() {}
func (*WriteErrorDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{2}
}
func (m *WriteErrorDetails) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *WriteErrorDetails) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_WriteErrorDetails.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *WriteErrorDetails) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WriteErrorDetails.Merge(m, src)
}
func (m *WriteErrorDetails) XXX_Size() int {
	return m.Size()
}
func (m *WriteErrorDetails) XXX_DiscardUnknown() {
	xxx_messageInfo_WriteErrorDetails.DiscardUnknown(m)
}

var xxx_messageInfo_WriteErrorDetails proto.InternalMessageInfo

func (m *WriteErrorDetails) GetCause() ErrorCause {
	if m != nil {
		return m.Cause
	}
	return INVALID
...
type MinimizedWriteRequest struct {
	...
	Symbols    string                `protobuf:"bytes,1001,opt,name=symbols,proto3" json:"symbols,omitempty"`
...
func (m *MinimizedWriteRequest) GetSource() int32 {
	if m != nil {
		return m.Source
	}
	return 0
...
func (m *MinimizedWriteRequest) GetMetadata() []*MetricMetadata {
	if m != nil {
		return m.Metadata
	}
	return nil
...
func (m *MinimizedWriteRequest) GetSkipLabelNameValidation() bool {
	if m != nil {
		return m.SkipLabelNameValidation
	}
	return false
...
type MinimizedTimeSeries struct {
	...
	//
	// A reference is a uint32 where the 20 most significant bits are the offset in the symbols table
	// and the 12 least significant bits are the length. This means that the symbols table limits are:
	// - Max 4KB for 1 symbol (max length).
	// - Max 1MB-1 for the entire symbols table (max offset).
	//
	// Beyond this prototype, the idea is that if a label escapes the maximum limits, then its series
	// will be encoded using the standard non-minimized WriteRequest (there's no issue splitting an
	// incoming WriteRequest into multiple requests).
...
type HyperMinimizedWriteRequest struct {
	// The symbols table. All symbols are concatenated strings. To read the symbols table, it's required
	// to know the offset:length range of the actual symbol to read from this string.
	Symbols string `protobuf:"bytes,1001,opt,name=symbols,proto3" json:"symbols,omitempty"`
	// The offset and length of each symbol.
	SymbolOffsets []uint32                   `protobuf:"varint,1002,rep,packed,name=symbol_offsets,json=symbolOffsets,proto3" json:"symbol_offsets,omitempty"`
	SymbolLength  []uint32                   `protobuf:"varint,1003,rep,packed,name=symbol_length,json=symbolLength,proto3" json:"symbol_length,omitempty"`
	Timeseries    []HyperMinimizedTimeSeries `protobuf:"bytes,1,rep,name=timeseries,proto3" json:"timeseries"`
	Source        int32                      `protobuf:"varint,2,opt,name=Source,proto3" json:"Source,omitempty"`
	Metadata      []*MetricMetadata          `protobuf:"bytes,3,rep,name=metadata,proto3" json:"metadata,omitempty"`
	// Skip validation of label names.
	SkipLabelNameValidation bool `protobuf:"varint,1000,opt,name=skip_label_name_validation,json=skipLabelNameValidation,proto3" json:"skip_label_name_validation,omitempty"`
...
func (m *HyperMinimizedWriteRequest) Reset()      { *m = HyperMinimizedWriteRequest{} }
func (*HyperMinimizedWriteRequest) ProtoMessage() {}
func (*HyperMinimizedWriteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{26}
}
func (m *HyperMinimizedWriteRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HyperMinimizedWriteRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HyperMinimizedWriteRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HyperMinimizedWriteRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HyperMinimizedWriteRequest.Merge(m, src)
}
func (m *HyperMinimizedWriteRequest) XXX_Size() int {
	return m.Size()
}
func (m *HyperMinimizedWriteRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_HyperMinimizedWriteRequest.DiscardUnknown(m)
}

var xxx_messageInfo_HyperMinimizedWriteRequest proto.InternalMessageInfo

func (m *HyperMinimizedWriteRequest) GetSymbols() string {
	if m != nil {
		return m.Symbols
	}
	return ""
...
func (m *HyperMinimizedWriteRequest) GetSymbolOffsets() []uint32 {
	if m != nil {
		return m.SymbolOffsets
	}
	return nil
}

func (m *HyperMinimizedWriteRequest) GetSymbolLength() []uint32 {
	if m != nil {
...
func (m *HyperMinimizedWriteRequest) GetTimeseries() []HyperMinimizedTimeSeries {
	if m != nil {
		return m.Timeseries
	}
	return nil
...
func (m *HyperMinimizedWriteRequest) GetSource() int32 {
	if m != nil {
		return m.Source
	}
	return 0
...
func (m *HyperMinimizedWriteRequest) GetMetadata() []*MetricMetadata {
	if m != nil {
		return m.Metadata
	}
	return nil
...
func (m *HyperMinimizedWriteRequest) GetSkipLabelNameValidation() bool {
	if m != nil {
		return m.SkipLabelNameValidation
	}
	return false
...
type HyperMinimizedTimeSeries struct {
	// Sorted list of label name-value pair references. This list is always even. At even indices
	// there's the reference to label name, while at odd indices there's the reference to label value.
	// The value is the index of the symbol in the HyperMinimizedWriteRequest list of symbol offsets
	// and lengths.
	LabelSymbolIds []uint32 `protobuf:"varint,1000,rep,packed,name=label_symbol_ids,json=labelSymbolIds,proto3" json:"label_symbol_ids,omitempty"`
	// Sorted by time, oldest sample first.
	Samples    []Sample    `protobuf:"bytes,2,rep,name=samples,proto3" json:"samples"`
	Exemplars  []Exemplar  `protobuf:"bytes,3,rep,name=exemplars,proto3" json:"exemplars"`
	Histograms []Histogram `protobuf:"bytes,4,rep,name=histograms,proto3" json:"histograms"`
...
func (m *HyperMinimizedTimeSeries) Reset()      { *m = HyperMinimizedTimeSeries{} }
func (*HyperMinimizedTimeSeries) ProtoMessage() {}
func (*HyperMinimizedTimeSeries) Descriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{27}
}
func (m *HyperMinimizedTimeSeries) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HyperMinimizedTimeSeries) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HyperMinimizedTimeSeries.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HyperMinimizedTimeSeries) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HyperMinimizedTimeSeries.Merge(m, src)
}
func (m *HyperMinimizedTimeSeries) XXX_Size() int {
	return m.Size()
}
func (m *HyperMinimizedTimeSeries) XXX_DiscardUnknown() {
	xxx_messageInfo_HyperMinimizedTimeSeries.DiscardUnknown(m)
}

var xxx_messageInfo_HyperMinimizedTimeSeries proto.InternalMessageInfo

func (m *HyperMinimizedTimeSeries) GetLabelSymbolIds() []uint32 {
	if m != nil {
		return m.LabelSymbolIds
	}
	return nil
}

func (m *HyperMinimizedTimeSeries) GetSamples() []Sample {
	if m != nil {
		return m.Samples
	}
	return nil
...
func (m *HyperMinimizedTimeSeries) GetExemplars() []Exemplar {
	if m != nil {
		return m.Exemplars
	}
	return nil
...
func (m *HyperMinimizedTimeSeries) GetHistograms() []Histogram {
	if m != nil {
		return m.Histograms
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*WriteErrorDetails)(nil), "cortexpb.WriteErrorDetails")
	...
	proto.RegisterType((*MinimizedWriteRequest)(nil), "cortexpb.MinimizedWriteRequest")
	proto.RegisterType((*MinimizedTimeSeries)(nil), "cortexpb.MinimizedTimeSeries")
	proto.RegisterType((*HyperMinimizedWriteRequest)(nil), "cortexpb.HyperMinimizedWriteRequest")
	proto.RegisterType((*HyperMinimizedTimeSeries)(nil), "cortexpb.HyperMinimizedTimeSeries")
}
...
var fileDescriptor_86d4d7485f544059 = []byte{
	...
	,
}
...
func (this *WriteErrorDetails) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*WriteErrorDetails)
	if !ok {
		that2, ok := that.(WriteErrorDetails)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *MinimizedWriteRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*MinimizedWriteRequest)
	if !ok {
		that2, ok := that.(MinimizedWriteRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *MinimizedTimeSeries) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*MinimizedTimeSeries)
	if !ok {
		that2, ok := that.(MinimizedTimeSeries)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if len(this.LabelSymbols) != len(that1.LabelSymbols) {
		return false
	}
	for i := range this.LabelSymbols {
		if this.LabelSymbols[i] != that1.LabelSymbols[i] {
			return false
		}
	}
	if len(this.Samples) != len(that1.Samples) {
...
func (this *HyperMinimizedWriteRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HyperMinimizedWriteRequest)
	if !ok {
		that2, ok := that.(HyperMinimizedWriteRequest)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if len(this.SymbolOffsets) != len(that1.SymbolOffsets) {
		return false
	}
	for i := range this.SymbolOffsets {
		if this.SymbolOffsets[i] != that1.SymbolOffsets[i] {
			return false
		}
	}
	if len(this.SymbolLength) != len(that1.SymbolLength) {
		return false
	}
	for i := range this.SymbolLength {
		if this.SymbolLength[i] != that1.SymbolLength[i] {
			return false
		}
	}
	if len(this.Timeseries) != len(that1.Timeseries) {
...
func (this *HyperMinimizedTimeSeries) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HyperMinimizedTimeSeries)
	if !ok {
		that2, ok := that.(HyperMinimizedTimeSeries)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if len(this.LabelSymbolIds) != len(that1.LabelSymbolIds) {
		return false
	}
	for i := range this.LabelSymbolIds {
		if this.LabelSymbolIds[i] != that1.LabelSymbolIds[i] {
			return false
		}
	}
	if len(this.Samples) != len(that1.Samples) {
...
func (this *WriteErrorDetails) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&mimirpb.WriteErrorDetails{")
...
func (this *MinimizedWriteRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 9)
	s = append(s, "&mimirpb.MinimizedWriteRequest{")
	s = append(s, "Symbols: "+fmt.Sprintf("%#v", this.Symbols)+",\n")
	if this.Timeseries != nil {
		vs := make([]*MinimizedTimeSeries, len(this.Timeseries))
		for i := range vs {
...
func (this *MinimizedTimeSeries) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&mimirpb.MinimizedTimeSeries{")
	s = append(s, "LabelSymbols: "+fmt.Sprintf("%#v", this.LabelSymbols)+",\n")
	if this.Samples != nil {
		vs := make([]*Sample, len(this.Samples))
		for i := range vs {
			vs[i] = &this.Samples[i]
...
func (this *HyperMinimizedWriteRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 11)
	s = append(s, "&mimirpb.HyperMinimizedWriteRequest{")
	s = append(s, "Symbols: "+fmt.Sprintf("%#v", this.Symbols)+",\n")
	s = append(s, "SymbolOffsets: "+fmt.Sprintf("%#v", this.SymbolOffsets)+",\n")
	s = append(s, "SymbolLength: "+fmt.Sprintf("%#v", this.SymbolLength)+",\n")
	if this.Timeseries != nil {
		vs := make([]*HyperMinimizedTimeSeries, len(this.Timeseries))
		for i := range vs {
			vs[i] = &this.Timeseries[i]
		}
		s = append(s, "Timeseries: "+fmt.Sprintf("%#v", vs)+",\n")
...
func (this *HyperMinimizedTimeSeries) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&mimirpb.HyperMinimizedTimeSeries{")
	s = append(s, "LabelSymbolIds: "+fmt.Sprintf("%#v", this.LabelSymbolIds)+",\n")
	if this.Samples != nil {
		vs := make([]*Sample, len(this.Samples))
		for i := range vs {
			vs[i] = &this.Samples[i]
...
func (m *WriteErrorDetails) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *WriteErrorDetails) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *WriteErrorDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MinimizedWriteRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Symbols) > 0 {
		...
		i = encodeVarintMimir(dAtA, i, uint64(len(m.Symbols)))
		i--
		dAtA[i] = 0x3e
		i--
		dAtA[i] = 0xca
...
func (m *MinimizedTimeSeries) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LabelSymbols) > 0 {
		dAtA19 := make([]byte, len(m.LabelSymbols)*10)
		var j18 int
		...
		i = encodeVarintMimir(dAtA, i, uint64(j18))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *HyperMinimizedWriteRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HyperMinimizedWriteRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HyperMinimizedWriteRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.SymbolLength) > 0 {
		dAtA21 := make([]byte, len(m.SymbolLength)*10)
		var j20 int
		for _, num := range m.SymbolLength {
			for num >= 1<<7 {
		...
		i = encodeVarintMimir(dAtA, i, uint64(j20))
		i--
		dAtA[i] = 0x3e
		i--
		dAtA[i] = 0xda
	}
	if len(m.SymbolOffsets) > 0 {
		dAtA23 := make([]byte, len(m.SymbolOffsets)*10)
		var j22 int
		for _, num := range m.SymbolOffsets {
			for num >= 1<<7 {
...
func (m *HyperMinimizedTimeSeries) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HyperMinimizedTimeSeries) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HyperMinimizedTimeSeries) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.LabelSymbolIds) > 0 {
		dAtA25 := make([]byte, len(m.LabelSymbolIds)*10)
		var j24 int
		for _, num := range m.LabelSymbolIds {
			for num >= 1<<7 {
...
func (m *WriteErrorDetails) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HyperMinimizedWriteRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.SymbolOffsets) > 0 {
		l = 0
		for _, e := range m.SymbolOffsets {
			l += sovMimir(uint64(e))
		}
		n += 2 + sovMimir(uint64(l)) + l
	}
	if len(m.SymbolLength) > 0 {
		l = 0
		for _, e := range m.SymbolLength {
			l += sovMimir(uint64(e))
		}
		n += 2 + sovMimir(uint64(l)) + l
	}
...
func (m *HyperMinimizedTimeSeries) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.LabelSymbolIds) > 0 {
		l = 0
		for _, e := range m.LabelSymbolIds {
			l += sovMimir(uint64(e))
		}
		n += 2 + sovMimir(uint64(l)) + l
	}
...
func (this *WriteErrorDetails) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&WriteErrorDetails{`,
...
func (this *MinimizedWriteRequest) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForTimeseries := "[]MinimizedTimeSeries{"
	for _, f := range this.Timeseries {
		repeatedStringForTimeseries += strings.Replace(strings.Replace(f.String(), "MinimizedTimeSeries", "MinimizedTimeSeries", 1), `&`, ``, 1) + ","
	}
	...
	repeatedStringForMetadata += "}"
	s := strings.Join([]string{`&MinimizedWriteRequest{`,
...
func (this *MinimizedTimeSeries) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForSamples := "[]Sample{"
	...
	repeatedStringForHistograms += "}"
	s := strings.Join([]string{`&MinimizedTimeSeries{`,
		`LabelSymbols:` + fmt.Sprintf("%v", this.LabelSymbols) + `,`,
		`Samples:` + repeatedStringForSamples + `,`,
		`Exemplars:` + repeatedStringForExemplars + `,`,
		`Histograms:` + repeatedStringForHistograms + `,`,
		`}`,
...
func (this *HyperMinimizedWriteRequest) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForTimeseries := "[]HyperMinimizedTimeSeries{"
	for _, f := range this.Timeseries {
		repeatedStringForTimeseries += strings.Replace(strings.Replace(f.String(), "HyperMinimizedTimeSeries", "HyperMinimizedTimeSeries", 1), `&`, ``, 1) + ","
	}
	repeatedStringForTimeseries += "}"
	repeatedStringForMetadata := "[]*MetricMetadata{"
	for _, f := range this.Metadata {
	...
	repeatedStringForMetadata += "}"
	s := strings.Join([]string{`&HyperMinimizedWriteRequest{`,
		`Timeseries:` + repeatedStringForTimeseries + `,`,
		`Source:` + fmt.Sprintf("%v", this.Source) + `,`,
		`Metadata:` + repeatedStringForMetadata + `,`,
		`SkipLabelNameValidation:` + fmt.Sprintf("%v", this.SkipLabelNameValidation) + `,`,
		`Symbols:` + fmt.Sprintf("%v", this.Symbols) + `,`,
		`SymbolOffsets:` + fmt.Sprintf("%v", this.SymbolOffsets) + `,`,
		`SymbolLength:` + fmt.Sprintf("%v", this.SymbolLength) + `,`,
		`}`,
	}, "")
	return s
}
func (this *HyperMinimizedTimeSeries) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForSamples := "[]Sample{"
	...
	repeatedStringForHistograms += "}"
	s := strings.Join([]string{`&HyperMinimizedTimeSeries{`,
		`Samples:` + repeatedStringForSamples + `,`,
		`Exemplars:` + repeatedStringForExemplars + `,`,
		`Histograms:` + repeatedStringForHistograms + `,`,
		`LabelSymbolIds:` + fmt.Sprintf("%v", this.LabelSymbolIds) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *WriteErrorDetails) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: WriteErrorDetails: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WriteErrorDetails: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *HyperMinimizedWriteRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HyperMinimizedWriteRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HyperMinimizedWriteRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Timeseries = append(m.Timeseries, HyperMinimizedTimeSeries{})
			if err := m.Timeseries[len(m.Timeseries)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		...
		case 1002:
			if wireType == 0 {
				...
				m.SymbolOffsets = append(m.SymbolOffsets, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.SymbolOffsets) == 0 {
					m.SymbolOffsets = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field SymbolOffsets", wireType)
			}
		case 1003:
			if wireType == 0 {
				var v uint32
				...
				m.SymbolLength = append(m.SymbolLength, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.SymbolLength) == 0 {
					m.SymbolLength = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field SymbolLength", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipMimir(dAtA[iNdEx:])
...
func (m *HyperMinimizedTimeSeries) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HyperMinimizedTimeSeries: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HyperMinimizedTimeSeries: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
		...
		case 1000:
			if wireType == 0 {
				...
				m.LabelSymbolIds = append(m.LabelSymbolIds, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.LabelSymbolIds) == 0 {
					m.LabelSymbolIds = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field LabelSymbolIds", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipMimir(dAtA[iNdEx:])
