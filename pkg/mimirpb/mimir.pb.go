...
type AnnotationErrorType int32

const (
	ANNOTATION_GENERIC                                AnnotationErrorType = 0
	ANNOTATION_POSSIBLE_NON_COUNTER                   AnnotationErrorType = 1
	ANNOTATION_HISTOGRAM_QUANTILE_FORCED_MONOTONICITY AnnotationErrorType = 2
)

var AnnotationErrorType_name = map[int32]string{
	0: "ANNOTATION_GENERIC",
	1: "ANNOTATION_POSSIBLE_NON_COUNTER",
	2: "ANNOTATION_HISTOGRAM_QUANTILE_FORCED_MONOTONICITY",
}

var AnnotationErrorType_value = map[string]int32{
	"ANNOTATION_GENERIC":                                0,
	"ANNOTATION_POSSIBLE_NON_COUNTER":                   1,
	"ANNOTATION_HISTOGRAM_QUANTILE_FORCED_MONOTONICITY": 2,
}

func (AnnotationErrorType) EnumDescriptor() ([]byte, []int) {
...
func (MetadataRW2_MetricType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{28, 0}
}
...
// accumulation for possibleNonCounterErr).
type AnnotationError struct {
	Type AnnotationErrorType `protobuf:"varint,1,opt,name=type,proto3,enum=cortexpb.AnnotationErrorType" json:"type,omitempty"`
	// The error message from Err.Error() — used as the deduplication/merge key.
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	// For possibleNonCounterErr and histogramQuantileForcedMonotonicityErr.
	Count int32 `protobuf:"varint,3,opt,name=count,proto3" json:"count,omitempty"`
	// For histogramQuantileForcedMonotonicityErr only.
	...
	MinBucket float64 `protobuf:"fixed64,6,opt,name=min_bucket,json=minBucket,proto3" json:"min_bucket,omitempty"`
	MaxBucket float64 `protobuf:"fixed64,7,opt,name=max_bucket,json=maxBucket,proto3" json:"max_bucket,omitempty"`
	MaxDiff   float64 `protobuf:"fixed64,8,opt,name=max_diff,json=maxDiff,proto3" json:"max_diff,omitempty"`
	// Position of the expression in the query string that triggered this annotation.
	// Used to reconstruct "(line:col)" suffixes after cache round-trips.
	PositionStart int32 `protobuf:"varint,9,opt,name=position_start,json=positionStart,proto3" json:"position_start,omitempty"`
	PositionEnd   int32 `protobuf:"varint,10,opt,name=position_end,json=positionEnd,proto3" json:"position_end,omitempty"`
	// Pre-computed "line:col" label (e.g. "1:25") for rendering the position
	// suffix without needing the full query string.
	PositionLabel string `protobuf:"bytes,11,opt,name=position_label,json=positionLabel,proto3" json:"position_label,omitempty"`
}
...
func (m *AnnotationError) GetType() AnnotationErrorType {
	if m != nil {
		return m.Type
	}
...
func (m *AnnotationError) GetCount() int32 {
	if m != nil {
		return m.Count
	}
	return 0
...
func (m *AnnotationError) GetMinTs() int64 {
	if m != nil {
		return m.MinTs
	}
	return 0
...
func (m *AnnotationError) GetMaxTs() int64 {
	if m != nil {
		return m.MaxTs
	}
	return 0
...
func (m *AnnotationError) GetMinBucket() float64 {
	if m != nil {
		return m.MinBucket
	}
	return 0
...
func (m *AnnotationError) GetMaxBucket() float64 {
	if m != nil {
		return m.MaxBucket
	}
	return 0
...
func (m *AnnotationError) GetMaxDiff() float64 {
	if m != nil {
		return m.MaxDiff
	}
	return 0
...
func (m *AnnotationError) GetPositionStart() int32 {
	if m != nil {
		return m.PositionStart
	}
	return 0
}

func (m *AnnotationError) GetPositionEnd() int32 {
	if m != nil {
		return m.PositionEnd
	}
	return 0
}
...
func init() {
	...
	proto.RegisterEnum("cortexpb.AnnotationErrorType", AnnotationErrorType_name, AnnotationErrorType_value)
...
var fileDescriptor_86d4d7485f544059 = []byte{
	...
	,
}
...
func (x AnnotationErrorType) String() string {
	s, ok := AnnotationErrorType_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *AnnotationError) Equal(that interface{}) bool {
	...
	if this.PositionStart != that1.PositionStart {
		return false
	}
	if this.PositionEnd != that1.PositionEnd {
		return false
	}
...
func (this *AnnotationError) GoString() string {
	...
	s = append(s, "PositionStart: "+fmt.Sprintf("%#v", this.PositionStart)+",\n")
	s = append(s, "PositionEnd: "+fmt.Sprintf("%#v", this.PositionEnd)+",\n")
...
func (m *AnnotationError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PositionEnd != 0 {
		i = encodeVarintMimir(dAtA, i, uint64(m.PositionEnd))
		i--
		dAtA[i] = 0x50
	}
	if m.PositionStart != 0 {
		i = encodeVarintMimir(dAtA, i, uint64(m.PositionStart))
		i--
		dAtA[i] = 0x48
	}
	if m.MaxDiff != 0 {
...
func (m *AnnotationError) Size() (n int) {
	...
	if m.PositionStart != 0 {
		n += 1 + sovMimir(uint64(m.PositionStart))
	}
	if m.PositionEnd != 0 {
		n += 1 + sovMimir(uint64(m.PositionEnd))
	}
...
func (this *AnnotationError) String() string {
	...
	s := strings.Join([]string{`&AnnotationError{`,
		...
		`PositionStart:` + fmt.Sprintf("%v", this.PositionStart) + `,`,
		`PositionEnd:` + fmt.Sprintf("%v", this.PositionEnd) + `,`,
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= AnnotationErrorType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PositionStart", wireType)
			}
			m.PositionStart = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PositionStart |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PositionEnd", wireType)
			}
			m.PositionEnd = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PositionEnd |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
