...
type WriteRequestV2_SourceEnum int32

const (
	SOURCE_API  WriteRequestV2_SourceEnum = 0
	SOURCE_RULE WriteRequestV2_SourceEnum = 1
)

var WriteRequestV2_SourceEnum_name = map[int32]string{
	0: "SOURCE_API",
	1: "SOURCE_RULE",
}

var WriteRequestV2_SourceEnum_value = map[string]int32{
	"SOURCE_API":  0,
	"SOURCE_RULE": 1,
}

func (WriteRequestV2_SourceEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{2, 0}
}
...
type MetricMetadataV2_MetricType int32

const (
	METRIC_TYPE_UNSPECIFIED    MetricMetadataV2_MetricType = 0
	METRIC_TYPE_COUNTER        MetricMetadataV2_MetricType = 1
	METRIC_TYPE_GAUGE          MetricMetadataV2_MetricType = 2
	METRIC_TYPE_HISTOGRAM      MetricMetadataV2_MetricType = 3
	METRIC_TYPE_GAUGEHISTOGRAM MetricMetadataV2_MetricType = 4
	METRIC_TYPE_SUMMARY        MetricMetadataV2_MetricType = 5
	METRIC_TYPE_INFO           MetricMetadataV2_MetricType = 6
	METRIC_TYPE_STATESET       MetricMetadataV2_MetricType = 7
)

var MetricMetadataV2_MetricType_name = map[int32]string{
...
var MetricMetadataV2_MetricType_value = map[string]int32{
...
func (MetricMetadataV2_MetricType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{10, 0}
}
...
func (Histogram_ResetHint) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{14, 0}
}
...
func (QueryResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{21, 0}
}
...
func (QueryResponse_ErrorType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{21, 1}
}
...
type WriteRequestV2 struct {
	Source     WriteRequestV2_SourceEnum `protobuf:"varint,2,opt,name=Source,proto3,enum=cortexpb.WriteRequestV2_SourceEnum" json:"Source,omitempty"`
	Symbols    []string                  `protobuf:"bytes,4,rep,name=symbols,proto3" json:"symbols,omitempty"`
	Timeseries []TimeSeriesV2            `protobuf:"bytes,5,rep,name=timeseries,proto3" json:"timeseries"`
	// Skip validation of label names and values.
	SkipLabelValidation bool `protobuf:"varint,1000,opt,name=skip_label_validation,json=skipLabelValidation,proto3" json:"skip_label_validation,omitempty"`
	// Skip label count validation.
	SkipLabelCountValidation bool `protobuf:"varint,1001,opt,name=skip_label_count_validation,json=skipLabelCountValidation,proto3" json:"skip_label_count_validation,omitempty"`
...
func (m *WriteRequestV2) GetSource() WriteRequestV2_SourceEnum {
	if m != nil {
		return m.Source
	}
	return SOURCE_API
...
func (m *WriteRequestV2) GetTimeseries() []TimeSeriesV2 {
	if m != nil {
		return m.Timeseries
	}
	return nil
...
func (m *WriteRequestV2) GetSkipLabelValidation() bool {
	if m != nil {
		return m.SkipLabelValidation
	}
	return false
...
func (m *WriteRequestV2) GetSkipLabelCountValidation() bool {
	if m != nil {
		return m.SkipLabelCountValidation
	}
	return false
...
type TimeSeriesV2 struct {
	...
	// Identical to V1.
	Samples []Sample `protobuf:"bytes,2,rep,name=samples,proto3" json:"samples"`
	// TODO: Deviating a bit for these two, faster testing and using the V1 equivalents.
	// Histograms is _nearly_ compatible with v1.
	// It's missing a new field added in V2 (custom_values) but is a subset otherwise.
	...
	Metadata         MetricMetadataV2 `protobuf:"bytes,5,opt,name=metadata,proto3" json:"metadata"`
...
func (m *TimeSeriesV2) GetMetadata() MetricMetadataV2 {
	if m != nil {
		return m.Metadata
	}
...
type MetricMetadataV2 struct {
	Type MetricMetadataV2_MetricType `protobuf:"varint,1,opt,name=type,proto3,enum=cortexpb.MetricMetadataV2_MetricType" json:"type,omitempty"`
...
func (m *MetricMetadataV2) Reset()      { *m = MetricMetadataV2{} }
func (*MetricMetadataV2) ProtoMessage() {}
func (*MetricMetadataV2) Descriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{10}
}
func (m *MetricMetadataV2) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MetricMetadataV2) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MetricMetadataV2.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MetricMetadataV2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MetricMetadataV2.Merge(m, src)
}
func (m *MetricMetadataV2) XXX_Size() int {
	return m.Size()
}
func (m *MetricMetadataV2) XXX_DiscardUnknown() {
	xxx_messageInfo_MetricMetadataV2.DiscardUnknown(m)
}

var xxx_messageInfo_MetricMetadataV2 proto.InternalMessageInfo

func (m *MetricMetadataV2) GetType() MetricMetadataV2_MetricType {
	if m != nil {
		return m.Type
	}
...
func (m *MetricMetadataV2) GetHelpRef() uint32 {
	if m != nil {
		return m.HelpRef
	}
	return 0
...
func (m *MetricMetadataV2) GetUnitRef() uint32 {
	if m != nil {
		return m.UnitRef
	}
	return 0
...
func (m *ExemplarV2) GetTimestampMs() int64 {
	if m != nil {
		return m.TimestampMs
	}
	return 0
...
func init() {
	...
	proto.RegisterEnum("cortexpb.WriteRequestV2_SourceEnum", WriteRequestV2_SourceEnum_name, WriteRequestV2_SourceEnum_value)
	proto.RegisterEnum("cortexpb.MetricMetadata_MetricType", MetricMetadata_MetricType_name, MetricMetadata_MetricType_value)
	proto.RegisterEnum("cortexpb.MetricMetadataV2_MetricType", MetricMetadataV2_MetricType_name, MetricMetadataV2_MetricType_value)
	...
	proto.RegisterType((*MetricMetadataV2)(nil), "cortexpb.MetricMetadataV2")
...
var fileDescriptor_86d4d7485f544059 = []byte{
	...
	,
}
...
func (x WriteRequestV2_SourceEnum) String() string {
	s, ok := WriteRequestV2_SourceEnum_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (x MetricMetadataV2_MetricType) String() string {
	s, ok := MetricMetadataV2_MetricType_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *MetricMetadataV2) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*MetricMetadataV2)
	if !ok {
		that2, ok := that.(MetricMetadataV2)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *WriteRequestV2) GoString() string {
	...
	s := make([]string, 0, 9)
	s = append(s, "&mimirpb.WriteRequestV2{")
	s = append(s, "Source: "+fmt.Sprintf("%#v", this.Source)+",\n")
	s = append(s, "Symbols: "+fmt.Sprintf("%#v", this.Symbols)+",\n")
	if this.Timeseries != nil {
		vs := make([]TimeSeriesV2, len(this.Timeseries))
		for i := range vs {
...
func (this *WriteResponseV2) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&mimirpb.WriteResponseV2{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *TimeSeriesV2) GoString() string {
	...
	s := make([]string, 0, 10)
	s = append(s, "&mimirpb.TimeSeriesV2{")
...
func (this *MetricMetadataV2) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&mimirpb.MetricMetadataV2{")
	s = append(s, "Type: "+fmt.Sprintf("%#v", this.Type)+",\n")
...
func (m *MetricMetadataV2) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MetricMetadataV2) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MetricMetadataV2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ExemplarV2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LabelsRefs) > 0 {
		...
		i = encodeVarintMimir(dAtA, i, uint64(j4))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Histogram) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PositiveDeltas) > 0 {
		...
		i = encodeVarintMimir(dAtA, i, uint64(j8))
		i--
		dAtA[i] = 0x62
	}
	...
	if len(m.NegativeDeltas) > 0 {
		...
		i = encodeVarintMimir(dAtA, i, uint64(j12))
		i--
		dAtA[i] = 0x4a
	}
...
func (m *FloatHistogram) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CustomValues) > 0 {
		for iNdEx := len(m.CustomValues) - 1; iNdEx >= 0; iNdEx-- {
			f15 := math.Float64bits(float64(m.CustomValues[iNdEx]))
			i -= 8
	...
	if len(m.PositiveBuckets) > 0 {
		for iNdEx := len(m.PositiveBuckets) - 1; iNdEx >= 0; iNdEx-- {
			f16 := math.Float64bits(float64(m.PositiveBuckets[iNdEx]))
			i -= 8
	...
	if len(m.NegativeBuckets) > 0 {
		for iNdEx := len(m.NegativeBuckets) - 1; iNdEx >= 0; iNdEx-- {
			f17 := math.Float64bits(float64(m.NegativeBuckets[iNdEx]))
			i -= 8
...
func (m *MetricMetadataV2) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *WriteRequestV2) String() string {
	...
	repeatedStringForTimeseries := "[]TimeSeriesV2{"
	for _, f := range this.Timeseries {
		repeatedStringForTimeseries += strings.Replace(strings.Replace(f.String(), "TimeSeriesV2", "TimeSeriesV2", 1), `&`, ``, 1) + ","
	}
...
func (this *TimeSeriesV2) String() string {
	...
	s := strings.Join([]string{`&TimeSeriesV2{`,
		...
		`Histograms:` + repeatedStringForHistograms + `,`,
		`Exemplars:` + repeatedStringForExemplars + `,`,
		`Metadata:` + strings.Replace(strings.Replace(this.Metadata.String(), "MetricMetadataV2", "MetricMetadataV2", 1), `&`, ``, 1) + `,`,
...
func (this *MetricMetadataV2) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&MetricMetadataV2{`,
		`Type:` + fmt.Sprintf("%v", this.Type) + `,`,
...
func (m *MetricMetadataV2) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MetricMetadataV2: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MetricMetadataV2: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= MetricMetadataV2_MetricType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
