...
func newValidationConfig(userID, tenantWithMetadata string, overrides *validation.Overrides) validationConfig {
	return validationConfig{
		...
		labels: labelValidationConfig{
			...
			nameValidationScheme:              overrides.NameValidationScheme(tenantWithMetadata),
		},
		metadata: metadataValidationConfig{
