...
func (c *MimirAppender) Append(_ storage.SeriesRef, ls labels.Labels, st, t int64, v float64, h *histogram.Histogram, fh *histogram.FloatHistogram, opts storage.AppendV2Options) (storage.SeriesRef, error) {
	ct := c.recalcCreatedTimestamp(t, st)
...
// Commit implements storage.AppenderTransaction.
func (c *MimirAppender) Commit() error {
	return nil
}

// Rollback implements storage.AppenderTransaction.
