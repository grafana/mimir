...
// supplierFunc should return either a non-nil body or a non-nil error.
type supplierFunc func() (req mimirpb.IWriteRequest, err error)
...
func (r *Request) WriteRequest() (mimirpb.IWriteRequest, error) {
	if r.request == nil && r.err == nil {
		...
		r.AddCleanup(r.request.Cleanup)
	}
