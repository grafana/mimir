...
func (c *MimirConverter) createAttributes(resource pcommon.Resource, attributes pcommon.Map, scope scope, settings Settings,
...
func (c *MimirConverter) getPromExemplars(ctx context.Context, exemplars pmetric.ExemplarSlice) ([]exemplar.Exemplar, error) {
	if exemplars.Len() == 0 {
		return nil, nil
	}
...
func (c *MimirConverter) addLabels(name string, baseLabels labels.Labels, extras ...string) labels.Labels {
...
func (c *MimirConverter) addResourceTargetInfo(resource pcommon.Resource, settings Settings, earliestTimestamp, latestTimestamp time.Time) error {
