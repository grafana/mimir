...
func (d *Distributor) wrapPushWithMiddlewares(distributorWrapper func(next push.Func) push.Func, next push.Func) push.Func {
	...
	if distributorWrapper != nil {
		middlewares = append(middlewares, distributorWrapper)
	}
