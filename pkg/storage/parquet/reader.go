...
// Provenance-includes-location: https://github.com/cortexproject/cortex/blob/26344c3ec7409713fcf52a9c41cd0dce537b3100/pkg/storage/parquet/reader.go
...
const (
// TODO this sets off the linter as it is not used yet
...
func (pr *ParquetReader) getPage(ctx context.Context, rgi int, c string, offset parquet.OffsetIndex, pagesToRead []int) *parquet.FilePages {
	...
	pages := colChunk.PagesFrom(bufferedReader)
