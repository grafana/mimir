...
//		decbufFactory: streamencoding.NewFilePoolDecbufFactory(binPath, cfg.MaxIdleFileHandles, metrics.filePool),
//	}
//
//	if r.toc, r.indexHeaderVersion, err = TOCFromIndexHeader(castagnoliTable, r.decbufFactory, logger); err != nil {
...
//	if err = r.symbolsTable.ForEachSymbol(labelNames, func(sym string, offset uint32) error {
