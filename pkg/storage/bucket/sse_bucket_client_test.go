...
// Provenance-includes-location: https://github.com/cortexproject/cortex/blob/master/pkg/storage/bucket/sse_bucket_client_test.go
...
func (m *mockTenantConfigProvider) S3SSECEncryptionKeyPath(_ string) string {
	return m.s3EncryptionKey
}
