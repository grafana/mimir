...
// IngesterZonalPartition returns the partition ID to use to write to a specific ingester partition.
...
//
// Deprecated: the experimental ingest storage is moving to partition IDs which are not based on the ingester zone.
func IngesterZonalPartition(ingesterID string) (int32, error) {
