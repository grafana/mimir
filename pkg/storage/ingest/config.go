...
type KafkaConfig struct {
	...
	ProducerUseZstdCompression                bool  `yaml:"producer_use_zstd_compression"`
...
func (cfg *KafkaConfig) RegisterFlagsWithPrefix(prefix string, f *flag.FlagSet) {
	...
	f.BoolVar(&cfg.ProducerUseZstdCompression, prefix+"producer-use-zstd-compression", false, "Whether to uze Zstd compression for produced records instead of the default snappy.")
