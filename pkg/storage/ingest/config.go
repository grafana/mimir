...
func (cfg *KafkaConfig) RegisterFlagsWithPrefix(prefix string, f *flag.FlagSet) {
	...
	f.IntVar(&cfg.MaxBufferedBytes, prefix+".max-buffered-bytes", 100_000_000, "The maximum number of bytes for buffered responses to fetch requests. This limit is applied on the sum of all MaxBytes requests that are ongoing. 0 to disable the limit.")
