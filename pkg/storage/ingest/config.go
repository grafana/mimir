...
var (
	...
	ErrInvalidProducerCompressionType    = fmt.Errorf("the configured producer compression type is invalid, must be one of: %s", strings.Join(producerCompressionTypeOptions, ", "))
	...
	producerCompressionTypeOptions = []string{compressionTypeSnappy, compressionTypeNone, compressionTypeGzip, compressionTypeLz4, compressionTypeZstd}
...
type KafkaConfig struct {
	...
	ProducerCompressionType    string `yaml:"producer_compression_type"`
...
func (cfg *KafkaConfig) RegisterFlagsWithPrefix(prefix string, f *flag.FlagSet) {
	...
	f.StringVar(&cfg.ProducerCompressionType, prefix+"producer-compression-type", compressionTypeSnappy, fmt.Sprintf("The compression algorithm used by Kafka producer when producing records. Supported values: %s.", strings.Join(producerCompressionTypeOptions, ", ")))
...
func (cfg *KafkaConfig) Validate() error {
	...
	if !slices.Contains(producerCompressionTypeOptions, cfg.ProducerCompressionType) {
		return ErrInvalidProducerCompressionType
	}
