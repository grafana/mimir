...
type KafkaConfig struct {
	...
	ProducerMaxBufferedRecords int `yaml:"producer_max_buffered_records"`
...
func (cfg *KafkaConfig) RegisterFlagsWithPrefix(prefix string, f *flag.FlagSet) {
	...
	f.IntVar(&cfg.ProducerMaxBufferedRecords, prefix+".producer-max-buffered-records", 0, "The maximum number of buffered and unacknowledged produced records sent to Kafka. The produce request fails once this limit is reached. This limit is applied per Kafka client. 0 to disable the limit.")
