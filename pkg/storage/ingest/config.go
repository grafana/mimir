...
func (cfg *KafkaConfig) RegisterFlagsWithPrefix(prefix string, f *flag.FlagSet) {
	...
	f.IntVar(&cfg.MaxBufferedBytes, prefix+".max-buffered-bytes", 100_000_000, "The maximum number of bytes for buffered responses to fetch requests. This limit applies to the sum of all ongoing MaxBytes requests. Set to 0 to disable the limit.")
