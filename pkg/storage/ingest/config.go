...
type KafkaConfig struct {
	...
	ProducerUseZstdCompression                int   `yaml:"producer_use_zstd_compression"`
	ProducerUseGzipCompression                bool  `yaml:"producer_use_gzip_compression"`
	ProducerUseGzipBestSpeedCompression       bool  `yaml:"producer_use_gzip_best_speed_compression"`
	ProducerUseGzipBestCompressionCompression bool  `yaml:"producer_use_gzip_best_compression_compression"`
	ProducerUseGzipHuffmanOnlyCompression     bool  `yaml:"producer_use_gzip_huffman_only_compression"`
	ProducerUseLZ4Compression                 int   `yaml:"producer_use_lz4_compression"`
...
func (cfg *KafkaConfig) RegisterFlagsWithPrefix(prefix string, f *flag.FlagSet) {
	...
	f.IntVar(&cfg.ProducerUseZstdCompression, prefix+"producer-use-zstd-compression", -1, "Whether to uze Zstd compression for produced records instead of the default snappy. -1=disabled, [0,2]=fastest, [3,5]=default, [6,9]=bettercomp, [10,inf)=bettercomp")
	f.BoolVar(&cfg.ProducerUseGzipCompression, prefix+"producer-use-gzip-compression", false, "Whether to uze Zstd compression for produced records instead of the default snappy.")
	f.BoolVar(&cfg.ProducerUseGzipBestSpeedCompression, prefix+"producer-use-gzip-compression-best-speed", false, "Whether to uze Zstd compression for produced records instead of the default snappy.")
	f.BoolVar(&cfg.ProducerUseGzipBestCompressionCompression, prefix+"producer-use-gzip-compression-best-compression", false, "Whether to uze Zstd compression for produced records instead of the default snappy.")
	f.BoolVar(&cfg.ProducerUseGzipHuffmanOnlyCompression, prefix+"producer-use-gzip-compression-huffman-only", false, "Whether to uze Zstd compression for produced records instead of the default snappy.")
	f.IntVar(&cfg.ProducerUseLZ4Compression, prefix+"producer-use-lz4-compression", -1, "lz4 compression level, -1=off, 0=fastest, 1-9=increasing compression")
