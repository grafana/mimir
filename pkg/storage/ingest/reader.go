...
func (r *PartitionReader) start(ctx context.Context) error {
	...
	r.segmentReader = NewSegmentReader(r.bucketClient, r.metadataStore, r.partitionID, startFromOffset, r.config.BufferSize, r.config.ReadHedgeDelay, r.config.ReadTimeout, r.reg, r.logger)
