...
const (
	...
	// VoluntaryNoCompactReason is used when the compactor proactively marks a compacted block as no-compact
	...
	VoluntaryNoCompactReason NoCompactReason = "voluntary"
)
