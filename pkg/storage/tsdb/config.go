...
func (cfg *BucketStoreConfig) RegisterFlags(f *flag.FlagSet) {
	...
	f.IntVar(&cfg.IndexHeaderLazyLoadingConcurrency, "blocks-storage.bucket-store.index-header-lazy-loading-concurrency", 200, "Maximum number of concurrent index headers being loaded in per tenant.")
