...
func (cfg *TSDBConfig) RegisterFlags(f *flag.FlagSet) {
	...
	f.IntVar(&cfg.DeprecatedMaxTSDBOpeningConcurrencyOnStartup, maxTSDBOpeningConcurrencyOnStartupFlag, 10, "limit the number of concurrently opening TSDB's on startup")
