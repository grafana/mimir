...
type TSDBConfig struct {
	...
	TimelyHeadCompaction bool `yaml:"timely_head_compaction" category:"experimental"`
}
...
func (cfg *TSDBConfig) RegisterFlags(f *flag.FlagSet) {
	...
	f.BoolVar(&cfg.TimelyHeadCompaction, "blocks-storage.tsdb.timely-head-compaction", false, "Allows head compaction to happen when the min block range can no longer be appended, without requiring 1.5x the chunk range worth of data in the head.")
