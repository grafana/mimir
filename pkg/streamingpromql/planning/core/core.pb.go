...
type BinaryExpressionHints struct {
	...
	// the RHS of a binary operation. Only meaningful when without_matching is
	// true. See without_matching for details.
	Exclude []string `protobuf:"bytes,2,rep,name=exclude,proto3" json:"exclude,omitempty"`
	// without_matching indicates that this binary operation uses "without" or
	// default (no on/without) label matching semantics, and that the RHS should
	// be filtered using all LHS labels except those in exclude. This flag is
	// required for backwards compatibility: a new querier receiving a plan from
	// an old query-frontend (where hints is nil) must not interpret the absence
	// of exclude labels as "use all labels for extra matchers". Similarly, we
	// cannot reuse the include slice for excluded labels because old queriers
	// would misinterpret a list of excluded labels as a list of included labels.
	WithoutMatching bool `protobuf:"varint,3,opt,name=without_matching,json=withoutMatching,proto3" json:"without_matching,omitempty"`
}
...
func (m *BinaryExpressionHints) GetWithoutMatching() bool {
	if m != nil {
		return m.WithoutMatching
	}
	return false
}
...
var fileDescriptor_f7e43720d1edc0fe = []byte{
	...
	,
}
...
func (this *BinaryExpressionHints) GoString() string {
	...
	s = append(s, "WithoutMatching: "+fmt.Sprintf("%#v", this.WithoutMatching)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *BinaryExpressionHints) String() string {
	...
	s := strings.Join([]string{`&BinaryExpressionHints{`,
		...
		`WithoutMatching:` + fmt.Sprintf("%v", this.WithoutMatching) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *BinaryExpressionHints) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field WithoutMatching", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
