...
type VectorSelectorDetails struct {
	...
	TimestampFromStartOrEndModifier          bool             `protobuf:"varint,12,opt,name=timestampFromStartOrEndModifier,proto3" json:"timestampFromStartOrEndModifier,omitempty"`
...
func (m *VectorSelectorDetails) GetTimestampFromStartOrEndModifier() bool {
	if m != nil {
		return m.TimestampFromStartOrEndModifier
	}
	return false
}
...
type MatrixSelectorDetails struct {
	Matchers                        []*LabelMatcher  `protobuf:"bytes,1,rep,name=matchers,proto3" json:"matchers,omitempty"`
	Timestamp                       *time.Time       `protobuf:"bytes,2,opt,name=timestamp,proto3,stdtime" json:"timestamp,omitempty"`
	TimestampFromStartOrEndModifier bool             `protobuf:"varint,13,opt,name=timestampFromStartOrEndModifier,proto3" json:"timestampFromStartOrEndModifier,omitempty"`
	Offset                          time.Duration    `protobuf:"bytes,3,opt,name=offset,proto3,stdduration" json:"offset"`
...
func (m *MatrixSelectorDetails) GetTimestampFromStartOrEndModifier() bool {
	if m != nil {
		return m.TimestampFromStartOrEndModifier
	}
	return false
...
var fileDescriptor_f7e43720d1edc0fe = []byte{
	...
	,
}
...
func (this *VectorSelectorDetails) GoString() string {
	...
	s = append(s, "TimestampFromStartOrEndModifier: "+fmt.Sprintf("%#v", this.TimestampFromStartOrEndModifier)+",\n")
...
func (m *VectorSelectorDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.TimestampFromStartOrEndModifier {
		i--
		if m.TimestampFromStartOrEndModifier {
			dAtA[i] = 1
		} else {
...
func (this *VectorSelectorDetails) String() string {
	...
	s := strings.Join([]string{`&VectorSelectorDetails{`,
		...
		`TimestampFromStartOrEndModifier:` + fmt.Sprintf("%v", this.TimestampFromStartOrEndModifier) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *VectorSelectorDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TimestampFromStartOrEndModifier", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TimestampFromStartOrEndModifier = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipCore(dAtA[iNdEx:])
			if err != nil {
