...
type NameDropDetails struct {
}

func (m *NameDropDetails) Reset()      { *m = NameDropDetails{} }
func (*NameDropDetails) ProtoMessage() {}
func (*NameDropDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7e43720d1edc0fe, []int{14}
}
func (m *NameDropDetails) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *NameDropDetails) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_NameDropDetails.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *NameDropDetails) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NameDropDetails.Merge(m, src)
}
func (m *NameDropDetails) XXX_Size() int {
	return m.Size()
}
func (m *NameDropDetails) XXX_DiscardUnknown() {
	xxx_messageInfo_NameDropDetails.DiscardUnknown(m)
}

var xxx_messageInfo_NameDropDetails proto.InternalMessageInfo

func (*NameDropDetails) XXX_MessageName() string {
	return "core.NameDropDetails"
}
func init() {
	...
	proto.RegisterType((*NameDropDetails)(nil), "core.NameDropDetails")
}
...
var fileDescriptor_f7e43720d1edc0fe = []byte{
	...
	,
}
...
func (this *NameDropDetails) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 4)
	s = append(s, "&core.NameDropDetails{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *NameDropDetails) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *NameDropDetails) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *NameDropDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *NameDropDetails) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *NameDropDetails) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&NameDropDetails{`,
		`}`,
	}, "")
	return s
}
...
func (m *NameDropDetails) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NameDropDetails: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NameDropDetails: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
