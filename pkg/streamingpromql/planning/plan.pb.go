...
type EncodedQueryPlan struct {
	...
	// cacheDisabled carries the request's Cache-Control: no-store option to the querier, where the
	// splitting/caching passes run and cannot otherwise see the request's options.
	CacheDisabled bool `protobuf:"varint,8,opt,name=cacheDisabled,proto3" json:"cacheDisabled,omitempty"`
}
...
func (m *EncodedQueryPlan) GetCacheDisabled() bool {
	if m != nil {
...
type EncodedNode struct {
	...
	// Optional ID for this node unique within the plan
	PlanningId int64 `protobuf:"varint,7,opt,name=planningId,proto3" json:"planningId,omitempty"`
}
...
func (m *EncodedNode) GetPlanningId() int64 {
	if m != nil {
		return m.PlanningId
	}
	return 0
...
var fileDescriptor_2d655ab2f7683c23 = []byte{
	...
	,
}
...
func (this *EncodedNode) Equal(that interface{}) bool {
	...
	if this.PlanningId != that1.PlanningId {
		return false
	}
	return true
}
...
func (this *EncodedNode) GoString() string {
	...
	s = append(s, "PlanningId: "+fmt.Sprintf("%#v", this.PlanningId)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *EncodedNode) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.PlanningId != 0 {
		i = encodeVarintPlan(dAtA, i, uint64(m.PlanningId))
		i--
		dAtA[i] = 0x38
	}
...
func (m *EncodedNode) Size() (n int) {
	...
	if m.PlanningId != 0 {
		n += 1 + sovPlan(uint64(m.PlanningId))
	}
	return n
}
...
func (this *EncodedNode) String() string {
	...
	s := strings.Join([]string{`&EncodedNode{`,
		...
		`PlanningId:` + fmt.Sprintf("%v", this.PlanningId) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *EncodedNode) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PlanningId", wireType)
			}
			m.PlanningId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PlanningId |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
