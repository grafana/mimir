...
func TestHandler(t *testing.T) {
	...
	handler := NewHandler(planner, streamingpromql.NewStaticQueryLimitsProvider())
...
func TestHandler_Sharding(t *testing.T) {
	...
	handler := middleware.AuthenticateUser(NewHandler(planner, streamingpromql.NewStaticQueryLimitsProvider()))
