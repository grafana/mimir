...
type AggregateExpressionDetails struct {
	Op                 github_com_prometheus_prometheus_promql_parser.ItemType `protobuf:"varint,1,opt,name=op,proto3,casttype=github.com/prometheus/prometheus/promql/parser.ItemType" json:"op,omitempty"`
...
func (m *AggregateExpressionDetails) GetOp() github_com_prometheus_prometheus_promql_parser.ItemType {
	if m != nil {
		return m.Op
	}
	return 0
...
func (m *BinaryExpressionDetails) GetOp() github_com_prometheus_prometheus_promql_parser.ItemType {
	if m != nil {
		return m.Op
	}
	return 0
...
func (m *UnaryExpressionDetails) GetOp() github_com_prometheus_prometheus_promql_parser.ItemType {
	if m != nil {
		return m.Op
	}
	return 0
...
var fileDescriptor_7eb8f36059a94977 = []byte{
	...
	,
}
...
func (m *VectorSelectorDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i -= n9
	i = encodeVarintCoreTypes(dAtA, i, uint64(n9))
	i--
	dAtA[i] = 0x1a
	if m.Timestamp != nil {
		{
...
func (m *MatrixSelectorDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i -= n13
	i = encodeVarintCoreTypes(dAtA, i, uint64(n13))
	i--
	dAtA[i] = 0x1a
	if m.Timestamp != nil {
		{
...
func (m *SubqueryDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i -= n18
	i = encodeVarintCoreTypes(dAtA, i, uint64(n18))
	i--
	dAtA[i] = 0x12
	if m.Timestamp != nil {
		{
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Op |= github_com_prometheus_prometheus_promql_parser.ItemType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
