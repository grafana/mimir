	...
	for _, c := range cases {
		...
		b.Run(c.Name(), func(b *testing.B) {
			if !skipCompareResults {
				...
				testutils.RequireEqualResults(b, c.Expr, prometheusResult, mimirResult, false, false)
...
func TestBothEnginesReturnSameResultsForBenchmarkQueries(t *testing.T) {
	...
	for _, c := range cases {
		t.Run(c.Name(), func(t *testing.T) {
			...
			testutils.RequireEqualResults(t, c.Expr, prometheusResult, mimirResult, false, false)
