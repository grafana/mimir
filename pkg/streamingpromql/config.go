...
type EngineOpts struct {
	...
	EnableRangeVectorCommonSubexpressionElimination bool `yaml:"enable_range_vector_common_subexpression_elimination" category:"experimental"`
...
func (o *EngineOpts) RegisterFlags(f *flag.FlagSet) {
	...
	f.BoolVar(&o.EnableRangeVectorCommonSubexpressionElimination, "querier.mimir-query-engine.enable-range-vector-common-subexpression-elimination", false, "Enable deduplication of range vector selectors in range queries as part of common subexpression elimination. Requires common subexpression elimination to be enabled.")
...
func NewTestEngineOpts() EngineOpts {
	return EngineOpts{
		...
		EnableRangeVectorCommonSubexpressionElimination: true,
	}
}
