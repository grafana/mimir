				...
				Nodes: []*planning.EncodedNode{
					{
						...
						Type:        "VectorSelector",
						Description: `{__name__="some_metric"} @ 3000 (1970-01-01T00:00:03Z, from start()/end())`,
					},
					{
						NodeType:       planning.NODE_TYPE_STEP_INVARIANT_EXPRESSION,
						Details:        marshalDetails(&core.StepInvariantExpressionDetails{}),
				...
				Nodes: []*planning.EncodedNode{
					{
						...
						Type:        "VectorSelector",
						Description: `{__name__="some_metric"} @ 5000 (1970-01-01T00:00:05Z, from start()/end())`,
					},
					{
						NodeType:       planning.NODE_TYPE_STEP_INVARIANT_EXPRESSION,
						Details:        marshalDetails(&core.StepInvariantExpressionDetails{}),
				...
				Nodes: []*planning.EncodedNode{
					{
						...
						Type:        "MatrixSelector",
						Description: `{__name__="some_metric"}[1m0s] @ 3000 (1970-01-01T00:00:03Z, from start()/end())`,
					},
					{
				...
				Nodes: []*planning.EncodedNode{
					{
						...
						Type:        "MatrixSelector",
						Description: `{__name__="some_metric"}[1m0s] @ 5000 (1970-01-01T00:00:05Z, from start()/end())`,
					},
					{
						NodeType: planning.NODE_TYPE_FUNCTION_CALL,
						Details: marshalDetails(&core.FunctionCallDetails{
