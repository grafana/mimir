...
func setupRingBufferTestingPools(t *testing.T) {
	...
	putFPointSliceForRingBuffer = func(_ []promql.FPoint, _ *limiter.MemoryConsumptionTracker) []promql.FPoint { return nil }
	...
	putHPointSliceForRingBuffer = func(_ []promql.HPoint, _ *limiter.MemoryConsumptionTracker) []promql.HPoint { return nil }
