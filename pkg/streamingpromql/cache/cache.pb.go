...
type CachedSeries struct {
	...
	Results  []IntermediateResult `protobuf:"bytes,6,rep,name=results,proto3" json:"results"`
}
...
func (m *IntermediateResult) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IntermediateResult) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_IntermediateResult.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *IntermediateResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IntermediateResult.Merge(m, src)
}
func (m *IntermediateResult) XXX_Size() int {
	return m.Size()
}
func (m *IntermediateResult) XXX_DiscardUnknown() {
	xxx_messageInfo_IntermediateResult.DiscardUnknown(m)
}

var xxx_messageInfo_IntermediateResult proto.InternalMessageInfo

func init() {
	proto.RegisterType((*CachedSeries)(nil), "thanos.CachedSeries")
	proto.RegisterType((*IntermediateResult)(nil), "thanos.IntermediateResult")
}
...
var fileDescriptor_5fca3b110c9bbf3a = []byte{
	...
	,
}
...
func (this *IntermediateResult) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*IntermediateResult)
	if !ok {
		that2, ok := that.(IntermediateResult)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CachedSeries) GoString() string {
	...
	if this.Results != nil {
		vs := make([]IntermediateResult, len(this.Results))
		for i := range vs {
			vs[i] = this.Results[i]
		}
...
func (this *IntermediateResult) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&storepb.IntermediateResult{")
...
func (m *IntermediateResult) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IntermediateResult) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IntermediateResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *IntermediateResult) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *CachedSeries) String() string {
	...
	repeatedStringForResults := "[]IntermediateResult{"
	for _, f := range this.Results {
		repeatedStringForResults += strings.Replace(strings.Replace(f.String(), "IntermediateResult", "IntermediateResult", 1), `&`, ``, 1) + ","
	}
...
func (this *IntermediateResult) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&IntermediateResult{`,
...
func (m *CachedSeries) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.Results = append(m.Results, IntermediateResult{})
...
func (m *IntermediateResult) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IntermediateResult: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IntermediateResult: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 1 {
