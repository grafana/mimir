...
func TestFloatTransformationFunc(t *testing.T) {
	...
	require.Equal(t, types.FPointSize*2+types.HPointSize*1, memoryConsumptionTracker.CurrentEstimatedMemoryConsumptionBytes.Load())
}
...
func TestFloatTransformationDropHistogramsFunc(t *testing.T) {
	...
	require.Equal(t, types.FPointSize*2, memoryConsumptionTracker.CurrentEstimatedMemoryConsumptionBytes.Load())
}
