...
func (s *SortByLabel) SeriesMetadata(ctx context.Context, selector *types.Selector) ([]types.SeriesMetadata, error) {
	innerMetadata, err := s.inner.SeriesMetadata(ctx, selector)
	if err != nil {
		return nil, err
	}
