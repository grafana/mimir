...
func (a *AndUnlessBinaryOperation) PrepareCompleted(ctx context.Context) error {
	if err := a.Left.PrepareCompleted(ctx); err != nil {
		return err
	}

	return a.Right.PrepareCompleted(ctx)
}
