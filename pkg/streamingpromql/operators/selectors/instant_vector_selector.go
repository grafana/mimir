...
func (v *InstantVectorSelector) SeriesMetadata(ctx context.Context, selectors *types.SeriesSelectors) ([]types.SeriesMetadata, error) {
	return v.Selector.SeriesMetadata(ctx, selectors)
}
