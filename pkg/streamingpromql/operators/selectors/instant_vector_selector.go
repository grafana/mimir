...
func (v *InstantVectorSelector) SeriesMetadata(ctx context.Context, selector *types.Selector) ([]types.SeriesMetadata, error) {
	return v.Selector.SeriesMetadata(ctx, selector)
}
