...
func (g *StddevStdvarAggregationGroup) ComputeOutputSeries(_ types.ScalarData, timeRange types.QueryTimeRange, memoryConsumptionTracker *limiting.MemoryConsumptionTracker, _ types.EmitAnnotationParamFunc) (types.InstantVectorSeriesData, bool, error) {
	floatPointCount := 0
