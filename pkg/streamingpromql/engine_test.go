...
func TestMemoryConsumptionLimit_SingleQueries(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"histogram: limit enabled, but query does not exceed limit": {
			...
			rangeQueryExpectedPeak: 8*types.HistogramPointerSize + 8*types.HPointSize + types.SeriesMetadataSize + 8*types.ByteSize,
			rangeQueryLimit:        8*types.HistogramPointerSize + 8*types.HPointSize + types.SeriesMetadataSize + 8*types.ByteSize,
		...
		"histogram: limit enabled, and query exceeds limit": {
			...
			instantQueryExpectedPeak: types.HPointSize + types.SeriesMetadataSize + types.HistogramPointerSize + types.ByteSize,
