...
func (c *Cache[T]) Get(
	...
	if err != nil {
		return nil, querierpb.Annotations{}, nil, nil, false, err
	}
	...
	if !ok || len(data) == 0 {
		return nil, querierpb.Annotations{}, nil, nil, false, nil
	}
	...
	if err != nil {
		return nil, querierpb.Annotations{}, nil, nil, false, fmt.Errorf("unmarshaling cached results: %w", err)
	}
