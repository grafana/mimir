...
func TestComputeSplitRanges(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			actual, err := computeSplitRanges(tt.startTs, tt.endTs, tt.splitInterval, newOOOCacheabilityChecker(tt.endTs+1))
...
func TestComputeSplitRangesWithOOOWindow(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			actual, err := computeSplitRanges(tt.startTs, tt.endTs, tt.splitInterval, newOOOCacheabilityChecker(tt.oooThreshold))
			require.NoError(t, err)
