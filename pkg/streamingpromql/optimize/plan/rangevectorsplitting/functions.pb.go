...
type AvgOverTimeIntermediate struct {
	SumF               float64            `protobuf:"fixed64,1,opt,name=sumF,proto3" json:"sumF,omitempty"`
	CompF              float64            `protobuf:"fixed64,2,opt,name=compF,proto3" json:"compF,omitempty"`
	IncrementalAvg     float64            `protobuf:"fixed64,3,opt,name=incrementalAvg,proto3" json:"incrementalAvg,omitempty"`
	CountF             float64            `protobuf:"fixed64,4,opt,name=countF,proto3" json:"countF,omitempty"`
	UseIncrementalCalc bool               `protobuf:"varint,5,opt,name=useIncrementalCalc,proto3" json:"useIncrementalCalc,omitempty"`
	AvgH               *mimirpb.Histogram `protobuf:"bytes,6,opt,name=avgH,proto3" json:"avgH,omitempty"`
	CntH               int64              `protobuf:"varint,7,opt,name=cntH,proto3" json:"cntH,omitempty"`
...
var fileDescriptor_83a6426a31b44db4 = []byte{
	...
	,
}
...
func (this *AvgOverTimeIntermediate) GoString() string {
	...
	s = append(s, "CntH: "+fmt.Sprintf("%#v", this.CntH)+",\n")
	s = append(s, "ForceEmptyResult: "+fmt.Sprintf("%#v", this.ForceEmptyResult)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *AvgOverTimeIntermediate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CntH != 0 {
		i = encodeVarintFunctions(dAtA, i, uint64(m.CntH))
		i--
		dAtA[i] = 0x38
	}
	if m.AvgH != nil {
...
func (m *AvgOverTimeIntermediate) Size() (n int) {
	...
	if m.CntH != 0 {
		n += 1 + sovFunctions(uint64(m.CntH))
	}
	if m.ForceEmptyResult {
		n += 2
	}
...
func (m *AvgOverTimeIntermediate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CntH", wireType)
			}
			m.CntH = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
