...
type SumOverTimeIntermediate struct {
	...
	CompH            *mimirpb.Histogram `protobuf:"bytes,6,opt,name=compH,proto3" json:"compH,omitempty"`
...
type RateIntermediate struct {
	...
	// For floats
	FirstSample *mimirpb.FloatSample `protobuf:"bytes,3,opt,name=first_sample,json=firstSample,proto3" json:"first_sample,omitempty"`
	LastSample  *mimirpb.FloatSample `protobuf:"bytes,4,opt,name=last_sample,json=lastSample,proto3" json:"last_sample,omitempty"`
...
type AvgOverTimeIntermediate struct {
	...
	// compH carries the Kahan compensation for avgH, kept separate for the same reason as compF.
	CompH            *mimirpb.Histogram `protobuf:"bytes,9,opt,name=compH,proto3" json:"compH,omitempty"`
...
func (m *PresentOverTimeIntermediate) Reset()      { *m = PresentOverTimeIntermediate{} }
func (*PresentOverTimeIntermediate) ProtoMessage() {}
func (*PresentOverTimeIntermediate) Descriptor() ([]byte, []int) {
	return fileDescriptor_83a6426a31b44db4, []int{12}
}
func (m *PresentOverTimeIntermediate) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PresentOverTimeIntermediate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PresentOverTimeIntermediate.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PresentOverTimeIntermediate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PresentOverTimeIntermediate.Merge(m, src)
}
func (m *PresentOverTimeIntermediate) XXX_Size() int {
	return m.Size()
}
func (m *PresentOverTimeIntermediate) XXX_DiscardUnknown() {
	xxx_messageInfo_PresentOverTimeIntermediate.DiscardUnknown(m)
}

var xxx_messageInfo_PresentOverTimeIntermediate proto.InternalMessageInfo

type PresentOverTimeIntermediateList struct {
	Results []PresentOverTimeIntermediate `protobuf:"bytes,1,rep,name=results,proto3" json:"results"`
}

func (m *PresentOverTimeIntermediateList) Reset()      { *m = PresentOverTimeIntermediateList{} }
func (*PresentOverTimeIntermediateList) ProtoMessage() {}
func (*PresentOverTimeIntermediateList) Descriptor() ([]byte, []int) {
	return fileDescriptor_83a6426a31b44db4, []int{13}
}
func (m *PresentOverTimeIntermediateList) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PresentOverTimeIntermediateList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PresentOverTimeIntermediateList.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PresentOverTimeIntermediateList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PresentOverTimeIntermediateList.Merge(m, src)
}
func (m *PresentOverTimeIntermediateList) XXX_Size() int {
	return m.Size()
}
func (m *PresentOverTimeIntermediateList) XXX_DiscardUnknown() {
	xxx_messageInfo_PresentOverTimeIntermediateList.DiscardUnknown(m)
}

var xxx_messageInfo_PresentOverTimeIntermediateList proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*PresentOverTimeIntermediate)(nil), "rangevectorsplitting.PresentOverTimeIntermediate")
	proto.RegisterType((*PresentOverTimeIntermediateList)(nil), "rangevectorsplitting.PresentOverTimeIntermediateList")
}
...
var fileDescriptor_83a6426a31b44db4 = []byte{
	...
	,
}
...
func (this *SumOverTimeIntermediate) Equal(that interface{}) bool {
	...
	if !this.CompH.Equal(that1.CompH) {
		return false
	}
...
func (this *SumOverTimeIntermediate) GoString() string {
	...
	if this.CompH != nil {
		s = append(s, "CompH: "+fmt.Sprintf("%#v", this.CompH)+",\n")
	}
...
func (this *PresentOverTimeIntermediate) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&rangevectorsplitting.PresentOverTimeIntermediate{")
	s = append(s, "Present: "+fmt.Sprintf("%#v", this.Present)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *PresentOverTimeIntermediateList) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&rangevectorsplitting.PresentOverTimeIntermediateList{")
	if this.Results != nil {
		vs := make([]PresentOverTimeIntermediate, len(this.Results))
		for i := range vs {
			vs[i] = this.Results[i]
		}
		s = append(s, "Results: "+fmt.Sprintf("%#v", vs)+",\n")
...
func (m *SumOverTimeIntermediate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CompH != nil {
		{
			size, err := m.CompH.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *PresentOverTimeIntermediate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PresentOverTimeIntermediateList) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *SumOverTimeIntermediate) String() string {
	...
	s := strings.Join([]string{`&SumOverTimeIntermediate{`,
		...
		`CompH:` + strings.Replace(fmt.Sprintf("%v", this.CompH), "Histogram", "mimirpb.Histogram", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *RateIntermediate) String() string {
	...
	s := strings.Join([]string{`&RateIntermediate{`,
		...
		`FirstSample:` + strings.Replace(fmt.Sprintf("%v", this.FirstSample), "FloatSample", "mimirpb.FloatSample", 1) + `,`,
		`LastSample:` + strings.Replace(fmt.Sprintf("%v", this.LastSample), "FloatSample", "mimirpb.FloatSample", 1) + `,`,
...
func (this *PresentOverTimeIntermediate) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&PresentOverTimeIntermediate{`,
		`Present:` + fmt.Sprintf("%v", this.Present) + `,`,
		`}`,
	}, "")
	return s
}
func (this *PresentOverTimeIntermediateList) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForResults := "[]PresentOverTimeIntermediate{"
	for _, f := range this.Results {
		repeatedStringForResults += strings.Replace(strings.Replace(f.String(), "PresentOverTimeIntermediate", "PresentOverTimeIntermediate", 1), `&`, ``, 1) + ","
	}
	repeatedStringForResults += "}"
	s := strings.Join([]string{`&PresentOverTimeIntermediateList{`,
		`Results:` + repeatedStringForResults + `,`,
		`}`,
	}, "")
	return s
...
func (m *SumOverTimeIntermediate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CompH", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CompH == nil {
				m.CompH = &mimirpb.Histogram{}
			}
			if err := m.CompH.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *RateIntermediate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.FirstSample == nil {
				m.FirstSample = &mimirpb.FloatSample{}
			}
		...
		case 4:
			...
			if m.LastSample == nil {
				m.LastSample = &mimirpb.FloatSample{}
			}
...
func (m *PresentOverTimeIntermediate) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PresentOverTimeIntermediate: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PresentOverTimeIntermediate: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *PresentOverTimeIntermediateList) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PresentOverTimeIntermediateList: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PresentOverTimeIntermediateList: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
