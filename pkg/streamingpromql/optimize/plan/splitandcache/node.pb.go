...
var fileDescriptor_0c843d59d2d938e7 = []byte{
	...
	0x06, 0x3a, 0x71, 0x9c, 0xb8, 0x27, 0xcf, 0x30, 0xe3, 0xbe, 0x3c, 0x63, 0x10, 0xaa, 0x4e, 0xa5,
	0x48, 0x2e, 0x1e, 0x67, 0x90, 0x13, 0xa9, 0x6f, 0xb4, 0x93, 0xc5, 0x85, 0x87, 0x72, 0x0c, 0x37,
	0x1e, 0xca, 0x31, 0x7c, 0x78, 0x28, 0xc7, 0xd8, 0xf0, 0x48, 0x8e, 0x71, 0xc5, 0x23, 0x39, 0x86,
	...
	0x39, 0x86, 0x1b, 0x8f, 0xe5, 0x18, 0x92, 0xd8, 0xc0, 0xb6, 0x18, 0x03, 0x02, 0x00, 0x00, 0xff,
	0xff, 0x1f, 0x37, 0xa6, 0xb8, 0x52, 0x01, 0x00, 0x00,
}
...
func (m *TimeRangeSplitDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n1, err1 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.SplitInterval, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.SplitInterval):])
	if err1 != nil {
		return 0, err1
	}
	i -= n1
...
func (m *CacheDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n2, err2 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.SplitInterval, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.SplitInterval):])
	if err2 != nil {
		return 0, err2
	}
	i -= n2
...
func (m *TimeRangeSplitDetails) Size() (n int) {
	...
	var l int
	_ = l
	l = github_com_gogo_protobuf_types.SizeOfStdDuration(m.SplitInterval)
...
func (m *TimeRangeSplitDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := github_com_gogo_protobuf_types.StdDurationUnmarshal(&m.SplitInterval, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
