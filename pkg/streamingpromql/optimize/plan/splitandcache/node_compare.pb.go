...
// Per-message value-comparison methods (Equal + Compare) for github.com/grafana/mimir/pkg/streamingpromql/optimize/plan/splitandcache/node.proto.
//
...
func (this *TimeRangeSplitDetails) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}
