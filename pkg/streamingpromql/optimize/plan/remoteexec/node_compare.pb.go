...
// Per-message value-comparison methods (Equal + Compare) for github.com/grafana/mimir/pkg/streamingpromql/optimize/plan/remoteexec/node.proto.
//
...
func (this *RemoteExecutionGroupDetails) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
...
func (this *RemoteExecutionConsumerDetails) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
