...
func TestPruneToggles(t *testing.T) {
	testCases := map[string]string{
		...
		`vector(0)`:                                `vector(0)`,
		`up < -Inf`:                                `up < -Inf`,
		`avg(rate(foo[1m])) < (-Inf)`:              `avg(rate(foo[1m])) < (-Inf)`,
		`Inf * -1`:                                 `Inf * -1`,
		`avg(rate(foo[1m])) < (-1 * +Inf)`:         `avg(rate(foo[1m])) < (-1 * +Inf)`,
		`(-1 * -Inf) < avg(rate(foo[1m]))`:         `(-1 * -Inf) < avg(rate(foo[1m]))`,
		`vector(0) < -Inf or avg(rate(foo[1m]))`:   `vector(0) < -Inf or avg(rate(foo[1m]))`,
		`avg(rate(foo[1m])) or vector(0) < -Inf`:   `avg(rate(foo[1m])) or vector(0) < -Inf`,
		`avg(rate(foo[1m])) or (vector(0) < -Inf)`: `avg(rate(foo[1m])) or (vector(0) < -Inf)`,
		`((-1 * -Inf) < avg(rate(foo[2m]))) or avg(rate(foo[1m]))`:                                                      `((-1 * -Inf) < avg(rate(foo[2m]))) or avg(rate(foo[1m]))`,
		`(avg(rate(foo[2m])) < (+1 * -Inf)) or avg(rate(foo[1m]))`:                                                      `(avg(rate(foo[2m])) < (+1 * -Inf)) or avg(rate(foo[1m]))`,
		`((-1 * -Inf) == avg(rate(foo[2m]))) or avg(rate(foo[1m]))`:                                                     `((-1 * -Inf) == avg(rate(foo[2m]))) or avg(rate(foo[1m]))`,
		`avg(rate(foo[1m])) unless ((-1 * -Inf) < avg(rate(foo[2m])))`:                                                  `avg(rate(foo[1m])) unless ((-1 * -Inf) < avg(rate(foo[2m])))`,
		`((2 * +Inf) < avg(rate(foo[2m]))) or avg(rate(foo[1m]))`:                                                       `((2 * +Inf) < avg(rate(foo[2m]))) or avg(rate(foo[1m]))`,
		`(((-1 * -Inf) < avg(rate(foo[3m]))) unless avg(rate(foo[2m]))) or avg(rate(foo[1m]))`:                          `(((-1 * -Inf) < avg(rate(foo[3m]))) unless avg(rate(foo[2m]))) or avg(rate(foo[1m]))`,
		`((((-1 * -Inf) < avg(rate(foo[4m]))) unless avg(rate(foo[3m]))) and avg(rate(foo[2m]))) or avg(rate(foo[1m]))`: `((((-1 * -Inf) < avg(rate(foo[4m]))) unless avg(rate(foo[3m]))) and avg(rate(foo[2m]))) or avg(rate(foo[1m]))`,
