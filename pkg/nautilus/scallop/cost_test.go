...
func TestStateCostTerms(t *testing.T) {
	...
	require.InDelta(t, 2, cost.Fragmentation, 1e-12)
	...
	require.InDelta(t, 6, cost.WeightedFragmentation, 1e-12)
	require.InDelta(t, 8, cost.WeightedResolution, 1e-9)
	require.InDelta(t, 15.5, cost.WeightedTotal, 1e-9)
}
...
func TestTransitionCostTermsAndLocality(t *testing.T) {
	...
	require.InDelta(t, 0.5, cost.TransitionEvents, 1e-12)
	...
	require.InDelta(t, 0.5, cost.WeightedTransitionEvents, 1e-12)
	...
	require.InDelta(t, 2.75, cost.WeightedTotal, 1e-12)
	...
	require.InDelta(t, 1.75, cost.WeightedTotal, 1e-12)
}
