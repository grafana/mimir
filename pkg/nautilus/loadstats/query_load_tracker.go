...
//
// At tick=15s, alpha=0.5 yields a 15-second half-life:
// 1 - 2^(-15s/15s) = 0.5. This keeps the rebalancer responsive to
// traffic shifts while retaining one tick of smoothing.
const Alpha = 0.5
