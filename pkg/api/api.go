...
func (a *API) RegisterDistributor(d *distributor.Distributor, pushConfig distributor.Config, reg prometheus.Registerer, separateMetricsLabelGetter push.GetSeparateMetricsLabel) {
	...
	a.RegisterRoute("/otlp/v1/metrics", push.OTLPHandler(pushConfig.MaxRecvMsgSize, a.sourceIPs, separateMetricsLabelGetter, a.cfg.SkipLabelNameValidationHeader, reg, pushFn), true, false, "POST")
