...
package uninternedquerywithenumpb
...
func (s QueryResponse_Status) ToPrometheusString() (string, error) {
	...
	case QueryResponse_ERROR:
		return "error", nil
	default:
		return "", fmt.Errorf("unknown QueryResponse_ErrorType value: %v (%v)", s, s.String())
	}
}
...
func (t QueryResponse_ErrorType) ToPrometheusString() (string, error) {
	...
	default:
		return "", fmt.Errorf("unknown QueryResponse_ErrorType value: %v (%v)", t, t.String())
	}
}
