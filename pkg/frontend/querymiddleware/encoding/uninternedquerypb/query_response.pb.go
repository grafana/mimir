...
type Histogram struct {
	...
	ResetHint      Histogram_ResetHint `protobuf:"varint,14,opt,name=reset_hint,json=resetHint,proto3,enum=uninternedquerypb.Histogram_ResetHint" json:"reset_hint,omitempty"`
...
func init() {
	proto.RegisterEnum("uninternedquerypb.Histogram_ResetHint", Histogram_ResetHint_name, Histogram_ResetHint_value)
	...
	proto.RegisterType((*VectorHistogram)(nil), "uninternedquerypb.VectorHistogram")
	...
	proto.RegisterType((*Histogram)(nil), "uninternedquerypb.Histogram")
	proto.RegisterType((*BucketSpan)(nil), "uninternedquerypb.BucketSpan")
}
...
var fileDescriptor_8ab2c8ecc140befb = []byte{
	...
	,
}
...
func (this *VectorHistogram) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&uninternedquerypb.VectorHistogram{")
	s = append(s, "Metric: "+fmt.Sprintf("%#v", this.Metric)+",\n")
...
func (this *Histogram) GoString() string {
	...
	s := make([]string, 0, 19)
	s = append(s, "&uninternedquerypb.Histogram{")
	if this.Count != nil {
...
func (this *Histogram_CountInt) GoString() string {
	...
	s := strings.Join([]string{`&uninternedquerypb.Histogram_CountInt{` +
...
func (this *Histogram_CountFloat) GoString() string {
	...
	s := strings.Join([]string{`&uninternedquerypb.Histogram_CountFloat{` +
...
func (this *Histogram_ZeroCountInt) GoString() string {
	...
	s := strings.Join([]string{`&uninternedquerypb.Histogram_ZeroCountInt{` +
...
func (this *Histogram_ZeroCountFloat) GoString() string {
	...
	s := strings.Join([]string{`&uninternedquerypb.Histogram_ZeroCountFloat{` +
...
func (this *BucketSpan) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&uninternedquerypb.BucketSpan{")
...
func (m *Histogram) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PositiveCounts) > 0 {
		for iNdEx := len(m.PositiveCounts) - 1; iNdEx >= 0; iNdEx-- {
			f5 := math.Float64bits(float64(m.PositiveCounts[iNdEx]))
			i -= 8
	...
	if len(m.PositiveDeltas) > 0 {
		var j6 int
		dAtA8 := make([]byte, len(m.PositiveDeltas)*10)
	...
	if len(m.NegativeCounts) > 0 {
		for iNdEx := len(m.NegativeCounts) - 1; iNdEx >= 0; iNdEx-- {
			f9 := math.Float64bits(float64(m.NegativeCounts[iNdEx]))
			i -= 8
	...
	if len(m.NegativeDeltas) > 0 {
		var j10 int
		dAtA12 := make([]byte, len(m.NegativeDeltas)*10)
