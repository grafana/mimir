...
type SymbolTable struct {
	...
	SymbolLengths []uint64 `protobuf:"varint,2,rep,packed,name=SymbolLengths,proto3" json:"SymbolLengths,omitempty"`
}
...
func (m *SymbolTable) GetSymbolLengths() []uint64 {
	if m != nil {
		return m.SymbolLengths
	}
	return nil
}
...
var fileDescriptor_8ab2c8ecc140befb = []byte{
	...
	,
}
...
func (this *SymbolTable) Equal(that interface{}) bool {
	...
	if len(this.SymbolLengths) != len(that1.SymbolLengths) {
		return false
	}
	for i := range this.SymbolLengths {
		if this.SymbolLengths[i] != that1.SymbolLengths[i] {
			return false
		}
	}
	return true
...
func (this *SymbolTable) GoString() string {
	...
	s = append(s, "SymbolLengths: "+fmt.Sprintf("%#v", this.SymbolLengths)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *SymbolTable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SymbolLengths) > 0 {
		dAtA5 := make([]byte, len(m.SymbolLengths)*10)
		var j4 int
		for _, num := range m.SymbolLengths {
			for num >= 1<<7 {
...
func (m *VectorData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Values) > 0 {
		for iNdEx := len(m.Values) - 1; iNdEx >= 0; iNdEx-- {
			f8 := math.Float64bits(float64(m.Values[iNdEx]))
			i -= 8
...
func (m *MatrixSeries) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MetricSymbols) > 0 {
		dAtA17 := make([]byte, len(m.MetricSymbols)*10)
		var j16 int
		for _, num := range m.MetricSymbols {
			for num >= 1<<7 {
...
func (this *SymbolTable) String() string {
	...
	s := strings.Join([]string{`&SymbolTable{`,
		...
		`SymbolLengths:` + fmt.Sprintf("%v", this.SymbolLengths) + `,`,
		`}`,
	}, "")
	return s
}
	...
	for iNdEx < l {
		...
		case 2:
			if wireType == 0 {
				...
				m.SymbolLengths = append(m.SymbolLengths, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.SymbolLengths) == 0 {
					m.SymbolLengths = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field SymbolLengths", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipQueryResponse(dAtA[iNdEx:])
