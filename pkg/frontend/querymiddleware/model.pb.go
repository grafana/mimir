...
type PrometheusLabelNamesQueryRequest struct {
	...
	Start              int64    `protobuf:"varint,2,opt,name=start,proto3" json:"start,omitempty"`
	End                int64    `protobuf:"varint,3,opt,name=end,proto3" json:"end,omitempty"`
	MatcherSetsStrings []string `protobuf:"bytes,4,rep,name=matcherSetsStrings,proto3" json:"matcherSetsStrings,omitempty"`
...
func (m *PrometheusLabelNamesQueryRequest) GetMatcherSetsStrings() []string {
	if m != nil {
		return m.MatcherSetsStrings
	}
	return nil
}

func (m *PrometheusLabelNamesQueryRequest) GetMatcherSets() []*LabelMatchers {
	if m != nil {
		return m.MatcherSets
	}
	return nil
}
...
func (m *PrometheusLabelNamesQueryRequest) GetOptions() Options {
	if m != nil {
		return m.Options
	}
	return Options{}
...
var fileDescriptor_4c16552f9fdb66d8 = []byte{
	...
	,
}
...
func (this *PrometheusLabelNamesQueryRequest) Equal(that interface{}) bool {
	...
	if len(this.MatcherSetsStrings) != len(that1.MatcherSetsStrings) {
		return false
	}
	for i := range this.MatcherSetsStrings {
		if this.MatcherSetsStrings[i] != that1.MatcherSetsStrings[i] {
			return false
		}
	}
	if len(this.MatcherSets) != len(that1.MatcherSets) {
		return false
	}
	for i := range this.MatcherSets {
		if !this.MatcherSets[i].Equal(that1.MatcherSets[i]) {
			return false
		}
	}
	if this.Id != that1.Id {
...
func (this *PrometheusLabelNamesQueryRequest) GoString() string {
	...
	s = append(s, "Start: "+fmt.Sprintf("%#v", this.Start)+",\n")
	s = append(s, "End: "+fmt.Sprintf("%#v", this.End)+",\n")
	s = append(s, "MatcherSetsStrings: "+fmt.Sprintf("%#v", this.MatcherSetsStrings)+",\n")
	if this.MatcherSets != nil {
		s = append(s, "MatcherSets: "+fmt.Sprintf("%#v", this.MatcherSets)+",\n")
	}
	s = append(s, "Id: "+fmt.Sprintf("%#v", this.Id)+",\n")
	s = append(s, "Options: "+strings.Replace(this.Options.GoString(), `&`, ``, 1)+",\n")
	s = append(s, "}")
...
func (m *PrometheusLabelNamesQueryRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MatcherSetsStrings) > 0 {
		for iNdEx := len(m.MatcherSetsStrings) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.MatcherSetsStrings[iNdEx])
			copy(dAtA[i:], m.MatcherSetsStrings[iNdEx])
			i = encodeVarintModel(dAtA, i, uint64(len(m.MatcherSetsStrings[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
...
func (m *PrometheusLabelNamesQueryRequest) Size() (n int) {
	...
	if len(m.MatcherSetsStrings) > 0 {
		for _, s := range m.MatcherSetsStrings {
			l = len(s)
			n += 1 + l + sovModel(uint64(l))
		}
	}
...
func (this *PrometheusLabelNamesQueryRequest) String() string {
	...
	repeatedStringForMatcherSets := "[]*LabelMatchers{"
	for _, f := range this.MatcherSets {
		repeatedStringForMatcherSets += strings.Replace(f.String(), "LabelMatchers", "LabelMatchers", 1) + ","
	}
	repeatedStringForMatcherSets += "}"
	s := strings.Join([]string{`&PrometheusLabelNamesQueryRequest{`,
		`Path:` + fmt.Sprintf("%v", this.Path) + `,`,
		`Start:` + fmt.Sprintf("%v", this.Start) + `,`,
		`End:` + fmt.Sprintf("%v", this.End) + `,`,
		`MatcherSetsStrings:` + fmt.Sprintf("%v", this.MatcherSetsStrings) + `,`,
		`MatcherSets:` + repeatedStringForMatcherSets + `,`,
		`Id:` + fmt.Sprintf("%v", this.Id) + `,`,
		`Options:` + strings.Replace(strings.Replace(this.Options.String(), "Options", "Options", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
...
func (m *PrometheusLabelNamesQueryRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MatcherSetsStrings", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MatcherSetsStrings = append(m.MatcherSetsStrings, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
			...
			m.MatcherSets = append(m.MatcherSets, &LabelMatchers{})
