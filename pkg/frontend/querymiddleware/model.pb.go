...
type CachedLimitedQuery struct {
	Key          string `protobuf:"bytes,1,opt,name=key,proto3" json:"key"`
	LimitedQuery string `protobuf:"bytes,2,opt,name=limitedQuery,proto3" json:"limitedQuery"`
	// Unix timestamp of last allowed query execution time
	LastAllowedTime int64 `protobuf:"varint,3,opt,name=lastAllowedTime,proto3" json:"lastAllowedTime"`
}

func (m *CachedLimitedQuery) Reset()      { *m = CachedLimitedQuery{} }
func (*CachedLimitedQuery) ProtoMessage() {}
func (*CachedLimitedQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_4c16552f9fdb66d8, []int{5}
}
func (m *CachedLimitedQuery) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CachedLimitedQuery) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CachedLimitedQuery.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CachedLimitedQuery) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CachedLimitedQuery.Merge(m, src)
}
func (m *CachedLimitedQuery) XXX_Size() int {
	return m.Size()
}
func (m *CachedLimitedQuery) XXX_DiscardUnknown() {
	xxx_messageInfo_CachedLimitedQuery.DiscardUnknown(m)
}

var xxx_messageInfo_CachedLimitedQuery proto.InternalMessageInfo

func (m *CachedLimitedQuery) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *CachedLimitedQuery) GetLimitedQuery() string {
	if m != nil {
		return m.LimitedQuery
	}
	return ""
}

func (m *CachedLimitedQuery) GetLastAllowedTime() int64 {
	if m != nil {
		return m.LastAllowedTime
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*CachedLimitedQuery)(nil), "queryrange.CachedLimitedQuery")
...
var fileDescriptor_4c16552f9fdb66d8 = []byte{
	...
	,
}
...
func (this *CachedLimitedQuery) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CachedLimitedQuery)
	if !ok {
		that2, ok := that.(CachedLimitedQuery)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.LimitedQuery != that1.LimitedQuery {
		return false
	}
	if this.LastAllowedTime != that1.LastAllowedTime {
		return false
	}
	return true
}
...
func (this *CachedLimitedQuery) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&querymiddleware.CachedLimitedQuery{")
	s = append(s, "Key: "+fmt.Sprintf("%#v", this.Key)+",\n")
	s = append(s, "LimitedQuery: "+fmt.Sprintf("%#v", this.LimitedQuery)+",\n")
	s = append(s, "LastAllowedTime: "+fmt.Sprintf("%#v", this.LastAllowedTime)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *CachedLimitedQuery) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CachedLimitedQuery) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CachedLimitedQuery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.LastAllowedTime != 0 {
		i = encodeVarintModel(dAtA, i, uint64(m.LastAllowedTime))
		i--
		dAtA[i] = 0x18
	}
	if len(m.LimitedQuery) > 0 {
		i -= len(m.LimitedQuery)
		copy(dAtA[i:], m.LimitedQuery)
		i = encodeVarintModel(dAtA, i, uint64(len(m.LimitedQuery)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Key) > 0 {
...
func (m *CachedLimitedQuery) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	l = len(m.LimitedQuery)
	if l > 0 {
		n += 1 + l + sovModel(uint64(l))
	}
	if m.LastAllowedTime != 0 {
		n += 1 + sovModel(uint64(m.LastAllowedTime))
	}
	return n
}
...
func (this *CachedLimitedQuery) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CachedLimitedQuery{`,
		`Key:` + fmt.Sprintf("%v", this.Key) + `,`,
		`LimitedQuery:` + fmt.Sprintf("%v", this.LimitedQuery) + `,`,
		`LastAllowedTime:` + fmt.Sprintf("%v", this.LastAllowedTime) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *CachedLimitedQuery) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CachedLimitedQuery: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CachedLimitedQuery: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LimitedQuery", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LimitedQuery = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastAllowedTime", wireType)
			}
			m.LastAllowedTime = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastAllowedTime |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
