...
// Merge folds other into d, so that concurrently executed sub-queries can each populate their own
// QueryDetails and have the results combined afterwards. Time ranges are widened to cover both, and
// counters are summed. Both a nil receiver and a nil other are no-ops.
