...
type QueryComponent int32

const (
	UNSPECIFIED         QueryComponent = 0
	INGESTERS_ONLY      QueryComponent = 1
	STORE_GATEWAYS_ONLY QueryComponent = 2
	...
	INGESTERS_AND_STORE_GATEWAYS QueryComponent = 3
)

var QueryComponent_name = map[int32]string{
	0: "UNSPECIFIED",
	1: "INGESTERS_ONLY",
	2: "STORE_GATEWAYS_ONLY",
	3: "INGESTERS_AND_STORE_GATEWAYS",
}

var QueryComponent_value = map[string]int32{
	"UNSPECIFIED":                  0,
	"INGESTERS_ONLY":               1,
...
func (QueryComponent) EnumDescriptor() ([]byte, []int) {
...
type FrontendToScheduler struct {
	...
	QueryComponentHint QueryComponent `protobuf:"varint,7,opt,name=queryComponentHint,proto3,enum=schedulerpb.QueryComponent" json:"queryComponentHint,omitempty"`
	...
	ShouldQueryIngesters     bool `protobuf:"varint,8,opt,name=shouldQueryIngesters,proto3" json:"shouldQueryIngesters,omitempty"`
	ShouldQueryStoreGateways bool `protobuf:"varint,9,opt,name=shouldQueryStoreGateways,proto3" json:"shouldQueryStoreGateways,omitempty"`
	...
	AdditionalQueueDimensions []string `protobuf:"bytes,10,rep,name=additionalQueueDimensions,proto3" json:"additionalQueueDimensions,omitempty"`
	...
	SecondQueueDimension string `protobuf:"bytes,11,opt,name=secondQueueDimension,proto3" json:"secondQueueDimension,omitempty"`
}
...
func (m *FrontendToScheduler) GetQueryComponentHint() QueryComponent {
	if m != nil {
		return m.QueryComponentHint
	}
	return UNSPECIFIED
}

func (m *FrontendToScheduler) GetShouldQueryIngesters() bool {
	if m != nil {
...
func (m *FrontendToScheduler) GetShouldQueryStoreGateways() bool {
	if m != nil {
		return m.ShouldQueryStoreGateways
	}
	return false
}
...
func (m *FrontendToScheduler) GetSecondQueueDimension() string {
	if m != nil {
		return m.SecondQueueDimension
	}
	return ""
}
...
func init() {
	...
	proto.RegisterEnum("schedulerpb.QueryComponent", QueryComponent_name, QueryComponent_value)
...
var fileDescriptor_2b3fc28395a6d9c5 = []byte{
	...
	,
}
...
func (x QueryComponent) String() string {
	s, ok := QueryComponent_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *FrontendToScheduler) Equal(that interface{}) bool {
	...
	if this.QueryComponentHint != that1.QueryComponentHint {
		return false
	}
	if this.ShouldQueryIngesters != that1.ShouldQueryIngesters {
		return false
	}
	if this.ShouldQueryStoreGateways != that1.ShouldQueryStoreGateways {
		return false
	}
	...
	if this.SecondQueueDimension != that1.SecondQueueDimension {
		return false
	}
	return true
}
...
func (this *FrontendToScheduler) GoString() string {
	...
	s = append(s, "StatsEnabled: "+fmt.Sprintf("%#v", this.StatsEnabled)+",\n")
	s = append(s, "QueryComponentHint: "+fmt.Sprintf("%#v", this.QueryComponentHint)+",\n")
	s = append(s, "ShouldQueryIngesters: "+fmt.Sprintf("%#v", this.ShouldQueryIngesters)+",\n")
	s = append(s, "ShouldQueryStoreGateways: "+fmt.Sprintf("%#v", this.ShouldQueryStoreGateways)+",\n")
	s = append(s, "AdditionalQueueDimensions: "+fmt.Sprintf("%#v", this.AdditionalQueueDimensions)+",\n")
	s = append(s, "SecondQueueDimension: "+fmt.Sprintf("%#v", this.SecondQueueDimension)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *FrontendToScheduler) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SecondQueueDimension) > 0 {
		i -= len(m.SecondQueueDimension)
		copy(dAtA[i:], m.SecondQueueDimension)
		i = encodeVarintScheduler(dAtA, i, uint64(len(m.SecondQueueDimension)))
		i--
		dAtA[i] = 0x5a
	}
	...
	if m.QueryComponentHint != 0 {
		i = encodeVarintScheduler(dAtA, i, uint64(m.QueryComponentHint))
		i--
		dAtA[i] = 0x38
	}
	if m.StatsEnabled {
...
func (m *FrontendToScheduler) Size() (n int) {
	...
	if m.QueryComponentHint != 0 {
		n += 1 + sovScheduler(uint64(m.QueryComponentHint))
	}
	if m.ShouldQueryIngesters {
		n += 2
	}
...
func (this *FrontendToScheduler) String() string {
	...
	s := strings.Join([]string{`&FrontendToScheduler{`,
		...
		`HttpRequest:` + strings.Replace(fmt.Sprintf("%v", this.HttpRequest), "HTTPRequest", "httpgrpc.HTTPRequest", 1) + `,`,
		`StatsEnabled:` + fmt.Sprintf("%v", this.StatsEnabled) + `,`,
		`QueryComponentHint:` + fmt.Sprintf("%v", this.QueryComponentHint) + `,`,
		`ShouldQueryIngesters:` + fmt.Sprintf("%v", this.ShouldQueryIngesters) + `,`,
		`ShouldQueryStoreGateways:` + fmt.Sprintf("%v", this.ShouldQueryStoreGateways) + `,`,
		`AdditionalQueueDimensions:` + fmt.Sprintf("%v", this.AdditionalQueueDimensions) + `,`,
		`SecondQueueDimension:` + fmt.Sprintf("%v", this.SecondQueueDimension) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *FrontendToScheduler) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field QueryComponentHint", wireType)
			}
			m.QueryComponentHint = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowScheduler
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.QueryComponentHint |= QueryComponent(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ShouldQueryStoreGateways", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ShouldQueryStoreGateways = bool(v != 0)
		case 10:
			if wireType != 2 {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecondQueueDimension", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SecondQueueDimension = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipScheduler(dAtA[iNdEx:])
