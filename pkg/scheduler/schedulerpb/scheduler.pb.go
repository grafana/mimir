...
type SchedulerToQuerier struct {
	...
	// Zero means unknown.
	ParentQueryID uint64 `protobuf:"varint,8,opt,name=parentQueryID,proto3" json:"parentQueryID,omitempty"`
}
...
func (m *SchedulerToQuerier) GetParentQueryID() uint64 {
	if m != nil {
...
type FrontendToScheduler struct {
	...
	// Identifies the user query this request is a sub-request of. Each frontend manages its own
	// parentQueryIDs, so it is only unique within a single frontend. Zero means unknown, which is
	// the case for queries that did not come through the frontend's HTTP transport handler.
	ParentQueryID uint64 `protobuf:"varint,9,opt,name=parentQueryID,proto3" json:"parentQueryID,omitempty"`
}
...
func (m *FrontendToScheduler) GetParentQueryID() uint64 {
	if m != nil {
		return m.ParentQueryID
	}
	return 0
...
var fileDescriptor_2b3fc28395a6d9c5 = []byte{
	...
	,
}
...
func (m *SchedulerToQuerier) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ParentQueryID != 0 {
		i = encodeVarintScheduler(dAtA, i, uint64(m.ParentQueryID))
		i--
		dAtA[i] = 0x40
	}
	if m.Payload != nil {
...
func (m *SchedulerToQuerier) Size() (n int) {
	...
	if m.ParentQueryID != 0 {
		n += 1 + sovScheduler(uint64(m.ParentQueryID))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 8:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ParentQueryID |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
