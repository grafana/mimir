...
type SchedulerToQuerier struct {
	...
	// Identifies the user query this request is a sub-request of, as reported by the frontend.
	// An empty value means unknown.
	ParentQueryID string `protobuf:"bytes,8,opt,name=parentQueryID,proto3" json:"parentQueryID,omitempty"`
}
...
func (m *SchedulerToQuerier) GetParentQueryID() string {
	if m != nil {
		return m.ParentQueryID
	}
	return ""
}
...
type FrontendToScheduler struct {
	...
	// Identifies the user query this request is a sub-request of. The frontend allocates it as a
	// random UUID, so it is globally unique. An empty value means unknown, which is the case for
	// queries that did not come through the frontend's HTTP transport handler.
	ParentQueryID string `protobuf:"bytes,9,opt,name=parentQueryID,proto3" json:"parentQueryID,omitempty"`
}
...
func (m *FrontendToScheduler) GetParentQueryID() string {
	if m != nil {
		return m.ParentQueryID
	}
	return ""
...
var fileDescriptor_2b3fc28395a6d9c5 = []byte{
	...
	,
}
...
func (this *SchedulerToQuerier) Equal(that interface{}) bool {
	...
	if this.ParentQueryID != that1.ParentQueryID {
		return false
	}
	return true
}
...
func (this *SchedulerToQuerier) GoString() string {
	...
	s = append(s, "ParentQueryID: "+fmt.Sprintf("%#v", this.ParentQueryID)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *SchedulerToQuerier) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ParentQueryID) > 0 {
		i -= len(m.ParentQueryID)
		copy(dAtA[i:], m.ParentQueryID)
		i = encodeVarintScheduler(dAtA, i, uint64(len(m.ParentQueryID)))
		i--
		dAtA[i] = 0x42
	}
	if m.Payload != nil {
...
func (this *SchedulerToQuerier) String() string {
	...
	s := strings.Join([]string{`&SchedulerToQuerier{`,
		...
		`ParentQueryID:` + fmt.Sprintf("%v", this.ParentQueryID) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *SchedulerToQuerier) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ParentQueryID", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ParentQueryID = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipScheduler(dAtA[iNdEx:])
