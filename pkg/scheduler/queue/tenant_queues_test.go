...
func TestQueues_NoShuffleSharding(t *testing.T) {
	...
	for _, tt := range treeTypes {
		t.Run(tt.name, func(t *testing.T) {
			qb := newQueueBroker(0, true, tt.algorithm, 0)
			assert.NotNil(t, qb)
...
func TestQueuesRespectMaxTenantQueueSizeWithSubQueues(t *testing.T) {
	...
	for _, tt := range treeTypes {
		t.Run(tt.name, func(t *testing.T) {
			...
			qb := newQueueBroker(maxTenantQueueSize, true, tt.algorithm, 0)
		...
		t.Run(tt.name, func(t *testing.T) {
			for testName, testData := range tests {
				t.Run(testName, func(t *testing.T) {
					qb := newQueueBroker(0, true, tt.algorithm, testData.forgetDelay)
					assert.NotNil(t, qb)
					assert.NoError(t, isConsistent(qb))
...
func TestQueues_ForgetDelay(t *testing.T) {
	...
	for _, tt := range treeTypes {
		t.Run(tt.name, func(t *testing.T) {
			now := time.Now()
			qb := newQueueBroker(0, true, tt.algorithm, forgetDelay)
			assert.NotNil(t, qb)
			assert.NoError(t, isConsistent(qb))
