...
func Test_QuerierConnManager(t *testing.T) {
	querierManager := newQuerierConnManager(0)
	...
	querierManager.addQuerierWorkerConn(querier1Conn4)
...
func Test_QuerierConnManagerPanics(t *testing.T) {
	...
	querierManager := newQuerierConnManager(10 * time.Second)
	...
	require.PanicsWithValue(
		...
		func() { querierManager.removeQuerierWorkerConn(querierConn, time.Now()) },
	)
	// now register the first worker for the querier
	//tqa.addQuerierWorkerConn(querierConn)
	querierManager.addQuerierWorkerConn(querierConn)
	...
	require.PanicsWithValue(
		...
		func() { querierManager.addQuerierWorkerConn(querierConn) },
	)
	...
	require.PanicsWithValue(
		...
		func() {
			querierManager.removeQuerierWorkerConn(
