...
// SearchFilter carries filter and sort parameters so the store-gateway can apply
...
type SearchFilter struct {
	...
	SortBy          SortBy    `protobuf:"varint,5,opt,name=sort_by,json=sortBy,proto3,enum=thanos.SortBy" json:"sort_by,omitempty"`
	SortOrder       SortOrder `protobuf:"varint,6,opt,name=sort_order,json=sortOrder,proto3,enum=thanos.SortOrder" json:"sort_order,omitempty"`
...
type SearchLabelNamesRequest struct {
	...
	Limit        int64                   `protobuf:"varint,7,opt,name=limit,proto3" json:"limit,omitempty"`
	RequestHints *LabelNamesRequestHints `protobuf:"bytes,8,opt,name=request_hints,json=requestHints,proto3" json:"request_hints,omitempty"`
	SearchFilter *SearchFilter           `protobuf:"bytes,9,opt,name=search_filter,json=searchFilter,proto3" json:"search_filter,omitempty"`
}
...
type SearchLabelValuesRequest struct {
	...
	Limit        int64                    `protobuf:"varint,8,opt,name=limit,proto3" json:"limit,omitempty"`
	RequestHints *LabelValuesRequestHints `protobuf:"bytes,9,opt,name=request_hints,json=requestHints,proto3" json:"request_hints,omitempty"`
	SearchFilter *SearchFilter            `protobuf:"bytes,10,opt,name=search_filter,json=searchFilter,proto3" json:"search_filter,omitempty"`
}
...
// StoreSearchResult is a single result (value + score) streamed from a store-gateway search RPC.
type StoreSearchResult struct {
	Value string  `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty"`
	Score float64 `protobuf:"fixed64,2,opt,name=score,proto3" json:"score,omitempty"`
}

func (m *StoreSearchResult) Reset()      { *m = StoreSearchResult{} }
func (*StoreSearchResult) ProtoMessage() {}
func (*StoreSearchResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{17}
}
func (m *StoreSearchResult) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StoreSearchResult) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StoreSearchResult.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StoreSearchResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StoreSearchResult.Merge(m, src)
}
func (m *StoreSearchResult) XXX_Size() int {
	return m.Size()
}
func (m *StoreSearchResult) XXX_DiscardUnknown() {
	xxx_messageInfo_StoreSearchResult.DiscardUnknown(m)
}

var xxx_messageInfo_StoreSearchResult proto.InternalMessageInfo

// StoreSearchResponseHints carries metadata about the blocks queried to serve a search request.
type StoreSearchResponseHints struct {
	QueriedBlocks []Block `protobuf:"bytes,1,rep,name=queried_blocks,json=queriedBlocks,proto3" json:"queried_blocks"`
}

func (m *StoreSearchResponseHints) Reset()      { *m = StoreSearchResponseHints{} }
func (*StoreSearchResponseHints) ProtoMessage() {}
func (*StoreSearchResponseHints) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{18}
}
func (m *StoreSearchResponseHints) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StoreSearchResponseHints) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StoreSearchResponseHints.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StoreSearchResponseHints) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StoreSearchResponseHints.Merge(m, src)
}
func (m *StoreSearchResponseHints) XXX_Size() int {
	return m.Size()
}
func (m *StoreSearchResponseHints) XXX_DiscardUnknown() {
	xxx_messageInfo_StoreSearchResponseHints.DiscardUnknown(m)
}

var xxx_messageInfo_StoreSearchResponseHints proto.InternalMessageInfo

// StoreSearchResponse is a streaming batch from SearchLabelNames / SearchLabelValues.
// The final message in the stream carries response_hints; all other messages carry results.
type StoreSearchResponse struct {
	Results       []*StoreSearchResult      `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
	Warnings      []string                  `protobuf:"bytes,2,rep,name=warnings,proto3" json:"warnings,omitempty"`
	ResponseHints *StoreSearchResponseHints `protobuf:"bytes,3,opt,name=response_hints,json=responseHints,proto3" json:"response_hints,omitempty"`
}

func (m *StoreSearchResponse) Reset()      { *m = StoreSearchResponse{} }
func (*StoreSearchResponse) ProtoMessage() {}
func (*StoreSearchResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{19}
}
func (m *StoreSearchResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StoreSearchResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StoreSearchResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StoreSearchResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StoreSearchResponse.Merge(m, src)
}
func (m *StoreSearchResponse) XXX_Size() int {
	return m.Size()
}
func (m *StoreSearchResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_StoreSearchResponse.DiscardUnknown(m)
}

var xxx_messageInfo_StoreSearchResponse proto.InternalMessageInfo

func init() {
	proto.RegisterEnum("thanos.SortBy", SortBy_name, SortBy_value)
	proto.RegisterEnum("thanos.SortOrder", SortOrder_name, SortOrder_value)
	...
	proto.RegisterType((*StoreSearchResult)(nil), "thanos.StoreSearchResult")
	proto.RegisterType((*StoreSearchResponseHints)(nil), "thanos.StoreSearchResponseHints")
	proto.RegisterType((*StoreSearchResponse)(nil), "thanos.StoreSearchResponse")
}
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
...
func (this *SearchLabelNamesRequest) Equal(that interface{}) bool {
	...
	if !this.SearchFilter.Equal(that1.SearchFilter) {
		return false
	}
	return true
}
...
func (this *StoreSearchResult) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StoreSearchResult)
	if !ok {
		that2, ok := that.(StoreSearchResult)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *StoreSearchResponseHints) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StoreSearchResponseHints)
	if !ok {
		that2, ok := that.(StoreSearchResponseHints)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *StoreSearchResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StoreSearchResponse)
	if !ok {
		that2, ok := that.(StoreSearchResponse)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *SearchLabelNamesRequest) GoString() string {
	...
	if this.SearchFilter != nil {
		s = append(s, "SearchFilter: "+fmt.Sprintf("%#v", this.SearchFilter)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *StoreSearchResult) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&storepb.StoreSearchResult{")
	s = append(s, "Value: "+fmt.Sprintf("%#v", this.Value)+",\n")
	s = append(s, "Score: "+fmt.Sprintf("%#v", this.Score)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *StoreSearchResponseHints) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&storepb.StoreSearchResponseHints{")
	if this.QueriedBlocks != nil {
		vs := make([]Block, len(this.QueriedBlocks))
		for i := range vs {
			vs[i] = this.QueriedBlocks[i]
...
func (this *StoreSearchResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&storepb.StoreSearchResponse{")
	if this.Results != nil {
...
func (m *SearchFilter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FuzzAlg) > 0 {
		...
		i = encodeVarintRpc(dAtA, i, uint64(len(m.FuzzAlg)))
		i--
		dAtA[i] = 0x3a
	}
	if m.SortOrder != 0 {
	...
	if m.SortBy != 0 {
		i = encodeVarintRpc(dAtA, i, uint64(m.SortBy))
		i--
		dAtA[i] = 0x28
	}
	...
	if len(m.SearchTerms) > 0 {
		for iNdEx := len(m.SearchTerms) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintRpc(dAtA, i, uint64(len(m.SearchTerms[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *SearchLabelNamesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SearchFilter != nil {
		{
			size, err := m.SearchFilter.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *StoreSearchResult) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StoreSearchResult) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StoreSearchResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *StoreSearchResponseHints) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StoreSearchResponseHints) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StoreSearchResponseHints) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *StoreSearchResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StoreSearchResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StoreSearchResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *StoreSearchResult) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StoreSearchResponseHints) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StoreSearchResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *SearchLabelNamesRequest) String() string {
	...
	s := strings.Join([]string{`&SearchLabelNamesRequest{`,
		...
		`Limit:` + fmt.Sprintf("%v", this.Limit) + `,`,
		`RequestHints:` + strings.Replace(this.RequestHints.String(), "LabelNamesRequestHints", "LabelNamesRequestHints", 1) + `,`,
		`SearchFilter:` + strings.Replace(this.SearchFilter.String(), "SearchFilter", "SearchFilter", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *StoreSearchResult) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StoreSearchResult{`,
...
func (this *StoreSearchResponseHints) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForQueriedBlocks := "[]Block{"
	...
	repeatedStringForQueriedBlocks += "}"
	s := strings.Join([]string{`&StoreSearchResponseHints{`,
		`QueriedBlocks:` + repeatedStringForQueriedBlocks + `,`,
		`}`,
	}, "")
	return s
}
func (this *StoreSearchResponse) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForResults := "[]*StoreSearchResult{"
	for _, f := range this.Results {
		repeatedStringForResults += strings.Replace(f.String(), "StoreSearchResult", "StoreSearchResult", 1) + ","
	}
	repeatedStringForResults += "}"
	s := strings.Join([]string{`&StoreSearchResponse{`,
		`Results:` + repeatedStringForResults + `,`,
		`Warnings:` + fmt.Sprintf("%v", this.Warnings) + `,`,
		`ResponseHints:` + strings.Replace(this.ResponseHints.String(), "StoreSearchResponseHints", "StoreSearchResponseHints", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *SearchLabelNamesRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			if err := m.SearchFilter.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *StoreSearchResult) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StoreSearchResult: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StoreSearchResult: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *StoreSearchResponseHints) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StoreSearchResponseHints: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StoreSearchResponseHints: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *StoreSearchResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StoreSearchResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StoreSearchResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Results = append(m.Results, &StoreSearchResult{})
		...
		case 3:
			...
			if m.ResponseHints == nil {
				m.ResponseHints = &StoreSearchResponseHints{}
			}
			if err := m.ResponseHints.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
