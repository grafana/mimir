...
type SeriesResponse_StreamingSeries struct {
	StreamingSeries *CustomStreamingSeriesBatch `protobuf:"bytes,5,opt,name=streaming_series,json=streamingSeries,proto3,oneof,customtype=CustomStreamingSeriesBatch"`
}
type SeriesResponse_StreamingChunks struct {
	StreamingChunks *CustomStreamingChunksBatch `protobuf:"bytes,6,opt,name=streaming_chunks,json=streamingChunks,proto3,oneof,customtype=CustomStreamingChunksBatch"`
}
