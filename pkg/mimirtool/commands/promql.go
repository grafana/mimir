...
func (c *PromQLCommand) Register(app *kingpin.Application, _ EnvVarNames) {
	...
	promqlCmd.Flag("enable-experimental-duration-expressions", "If set, enables parsing experimental duration expressions.").BoolVar(&parser.ExperimentalDurationExpr)
