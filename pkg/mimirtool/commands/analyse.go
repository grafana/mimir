...
func (cmd *AnalyzeCommand) Register(app *kingpin.Application, envVars EnvVarNames) {
	...
	analyzeCmd.Flag("enable-experimental-duration-expressions", "If set, enables parsing experimental duration expressions.").BoolVar(&parser.ExperimentalDurationExpr)
