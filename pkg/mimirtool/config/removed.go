...
var removedConfigPaths = []string{
	...
	"alertmanager.cluster.push_pull_interval",
	"alertmanager.sharding_enabled",
	"alertmanager.storage.azure.download_buffer_size",
	"alertmanager.storage.azure.environment",
	"alertmanager.storage.azure.max_retry_delay",
	"alertmanager.storage.azure.min_retry_delay",
	"alertmanager.storage.azure.request_timeout",
	"alertmanager.storage.azure.upload_buffer_count",
	"alertmanager.storage.azure.upload_buffer_size",
	"alertmanager.storage.gcs.chunk_buffer_size",
	"alertmanager.storage.gcs.enable_opencensus",
	"alertmanager.storage.gcs.request_timeout",
	"alertmanager.storage.s3.s3forcepathstyle",

	// ruler.storage removal
	"ruler.storage.azure.download_buffer_size",
	"ruler.storage.azure.environment",
	"ruler.storage.azure.max_retry_delay",
	"ruler.storage.azure.min_retry_delay",
	"ruler.storage.azure.request_timeout",
	"ruler.storage.azure.upload_buffer_count",
	"ruler.storage.azure.upload_buffer_size",
	"ruler.storage.gcs.chunk_buffer_size",
	"ruler.storage.gcs.enable_opencensus",
	"ruler.storage.gcs.request_timeout",
	"ruler.storage.s3.s3forcepathstyle",

	// removed support for configdb
	"alertmanager.storage.configdb.client_timeout",
	"alertmanager.storage.configdb.configs_api_url",
	"alertmanager.storage.configdb.tls_ca_path",
	"alertmanager.storage.configdb.tls_cert_path",
	"alertmanager.storage.configdb.tls_insecure_skip_verify",
	"alertmanager.storage.configdb.tls_key_path",
	"alertmanager.storage.configdb.tls_server_name",
	"alertmanager_storage.configdb.client_timeout",
	"alertmanager_storage.configdb.configs_api_url",
	"alertmanager_storage.configdb.tls_ca_path",
	"alertmanager_storage.configdb.tls_cert_path",
	"alertmanager_storage.configdb.tls_insecure_skip_verify",
	"alertmanager_storage.configdb.tls_key_path",
	"alertmanager_storage.configdb.tls_server_name",
	"ruler_storage.configdb.client_timeout",
	"ruler_storage.configdb.configs_api_url",
	"ruler_storage.configdb.tls_ca_path",
	"ruler_storage.configdb.tls_cert_path",
	"ruler_storage.configdb.tls_insecure_skip_verify",
	"ruler_storage.configdb.tls_key_path",
	"ruler_storage.configdb.tls_server_name",
	"ruler_storage.configdb.client_timeout",
	"ruler_storage.configdb.configs_api_url",
	"ruler_storage.configdb.tls_ca_path",
	"ruler_storage.configdb.tls_cert_path",
	...
	"query_range.results_cache.cache.default_validity",
	"query_range.results_cache.cache.memcached.expiration",
	"query_range.results_cache.cache.memcached_client.circuit_breaker_consecutive_failures",
	"query_range.results_cache.cache.memcached_client.circuit_breaker_interval",
	"query_range.results_cache.cache.memcached_client.circuit_breaker_timeout",
	"query_range.results_cache.cache.memcached_client.consistent_hash",
	"query_range.results_cache.cache.memcached_client.update_interval",
	"query_range.results_cache.enable_fifocache",
	"query_range.results_cache.fifocache.max_size_bytes",
	"query_range.results_cache.fifocache.max_size_items",
	"query_range.results_cache.fifocache.size",
	"query_range.results_cache.fifocache.validity",
	"query_range.results_cache.redis.db",
	"query_range.results_cache.redis.endpoint",
	"query_range.results_cache.redis.expiration",
	"query_range.results_cache.redis.idle_timeout",
	"query_range.results_cache.redis.master_name",
	"query_range.results_cache.redis.max_connection_age",
	"query_range.results_cache.redis.password",
	"query_range.results_cache.redis.pool_size",
	"query_range.results_cache.redis.timeout",
	"query_range.results_cache.redis.tls_enabled",
	"query_range.results_cache.redis.tls_insecure_skip_verify",

	// the rest
	"alertmanager.auto_webhook_root",
	"api.response_compression_enabled",
	"compactor.sharding_enabled",
	"distributor.extra_queue_delay",
	"distributor.ingestion_rate_strategy",
	"distributor.shard_by_all_labels",
	"distributor.sharding_strategy",
	"frontend_worker.parallelism",
	"http_prefix",
	"limits.reject_old_samples",
	"limits.reject_old_samples_max_age",
	"querier.at_modifier_enabled",
	"querier.ingester_streaming",
	"querier.query_store_for_labels_enabled",
	"querier.store_gateway_addresses",
	"ruler.enable_alertmanager_v2",
	"ruler.enable_sharding",
	"ruler.sharding_strategy",
	"store_gateway.sharding_enabled",
	"store_gateway.sharding_strategy",
}
