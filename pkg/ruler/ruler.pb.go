...
type RulesRequest struct {
	...
	MaxGroups uint64                `protobuf:"varint,5,opt,name=max_groups,json=maxGroups,proto3" json:"max_groups,omitempty"`
	NextToken uint64                `protobuf:"varint,6,opt,name=next_token,json=nextToken,proto3" json:"next_token,omitempty"`
}
...
func (m *RulesRequest) GetMaxGroups() uint64 {
	if m != nil {
		return m.MaxGroups
	}
	return 0
...
func (m *RulesRequest) GetNextToken() uint64 {
	if m != nil {
		return m.NextToken
	}
	return 0
...
var fileDescriptor_9ecbec0a4cfddea6 = []byte{
	...
	,
}
...
func (m *RulesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.NextToken != 0 {
		i = encodeVarintRuler(dAtA, i, uint64(m.NextToken))
		i--
		dAtA[i] = 0x30
	}
	if m.MaxGroups != 0 {
...
func (m *RulesRequest) Size() (n int) {
	...
	if m.NextToken != 0 {
		n += 1 + sovRuler(uint64(m.NextToken))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxGroups |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
