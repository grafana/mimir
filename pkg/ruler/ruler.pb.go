...
type RulesRequest struct {
	Filter        RulesRequest_RuleType `protobuf:"varint,1,opt,name=filter,proto3,enum=ruler.RulesRequest.RuleType" json:"filter,omitempty"`
...
type AlertStateDesc struct {
	...
	Labels          []mimirpb.LabelAdapter `protobuf:"bytes,2,rep,name=labels,proto3" json:"labels,omitempty"`
	Annotations     []mimirpb.LabelAdapter `protobuf:"bytes,3,rep,name=annotations,proto3" json:"annotations,omitempty"`
	...
	KeepFiringSince time.Time              `protobuf:"bytes,10,opt,name=keep_firing_since,json=keepFiringSince,proto3" json:"keep_firing_since,omitempty"`
}
...
func (m *AlertStateDesc) Size() int {
	...
	if !m.KeepFiringSince.IsZero() {
		inner := protohelpers.SizeStdTime(m.KeepFiringSince)
		n += 1 + protowire.SizeVarint(uint64(inner)) + inner
	}
	return n
}
...
func (m *RulesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NextToken) > 0 {
		...
		if len(m.NextToken) <= 0x7F {
			dAtA[i-1] = uint8(len(m.NextToken))
			i--
		} else {
...
func (m *SyncRulesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	for iNdEx := len(m.UserIds) - 1; iNdEx >= 0; iNdEx-- {
		...
		if len(m.UserIds[iNdEx]) <= 0x7F {
			dAtA[i-1] = uint8(len(m.UserIds[iNdEx]))
			i--
		} else {
...
func (m *AlertStateDesc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if !m.KeepFiringSince.IsZero() {
		start := i
		i = protohelpers.EncodeStdTime(dAtA, i, m.KeepFiringSince)
		inner := start - i
		i = protohelpers.EncodeVarint(dAtA, i, uint64(inner))
		i--
		dAtA[i] = 0x52
...
func (m *RulesRequest) UnmarshalNoPrescan(dAtA []byte) error {
...
func (m *RulesResponse) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *SyncRulesRequest) UnmarshalWithDepth(b []byte, depth int) error {
	if depth < 0 {
		depth = 0
	}
	return m.unmarshal(b, depth)
...
func (m *SyncRulesRequest) unmarshal(dAtA []byte, depth int) error {
	if depth > protohelpers.MaxUnmarshalDepth {
		return fmt.Errorf("exceeded max recursion depth")
	}
	l := len(dAtA)
	...
	if l >= 256 && depth >= 0 {
		...
		if c := field1count; c > 0 {
			...
			if len(m.UserIds) == 0 && cap(m.UserIds) < c {
				m.UserIds = make([]string, 0, c)
			}
		}
	}
	for iNdEx < l {
...
func (m *SyncRulesRequest) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *SyncRulesResponse) UnmarshalWithDepth(b []byte, depth int) error {
	if depth < 0 {
		depth = 0
	}
	return m.unmarshal(b, depth)
...
func (m *SyncRulesResponse) unmarshal(dAtA []byte, depth int) error {
	if depth > protohelpers.MaxUnmarshalDepth {
		return fmt.Errorf("exceeded max recursion depth")
	}
	l := len(dAtA)
...
func (m *GroupStateDesc) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *RuleStateDesc) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
	...
	if l >= 256 && depth >= 0 {
		...
		if c := field3count; c > 0 {
			...
			if len(m.Annotations) == 0 && cap(m.Annotations) < c {
				m.Annotations = make([]mimirpb.LabelAdapter, 0, c)
			}
		}
	}
	for iNdEx < l {
...
func (m *AlertStateDesc) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
