...
import (
	...
	_ "github.com/grafana/mimir/pkg/mimirpb_custom"
	github_com_grafana_mimir_pkg_mimirpb_custom "github.com/grafana/mimir/pkg/mimirpb_custom"
...
type AlertStateDesc struct {
	...
	Labels          []github_com_grafana_mimir_pkg_mimirpb_custom.LabelAdapter `protobuf:"bytes,2,rep,name=labels,proto3,customtype=github.com/grafana/mimir/pkg/mimirpb_custom.LabelAdapter" json:"labels"`
	Annotations     []github_com_grafana_mimir_pkg_mimirpb_custom.LabelAdapter `protobuf:"bytes,3,rep,name=annotations,proto3,customtype=github.com/grafana/mimir/pkg/mimirpb_custom.LabelAdapter" json:"annotations"`
...
var fileDescriptor_9ecbec0a4cfddea6 = []byte{
	...
	,
}
...
func (m *AlertStateDesc) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Labels = append(m.Labels, github_com_grafana_mimir_pkg_mimirpb_custom.LabelAdapter{})
		...
		case 3:
			...
			m.Annotations = append(m.Annotations, github_com_grafana_mimir_pkg_mimirpb_custom.LabelAdapter{})
