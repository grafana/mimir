...
func newHTTPRoundTripper(cfg *HTTPConfig, tracer opentracing.Tracer) http.RoundTripper {
...
func dialQueryFrontendHTTP(cfg QueryFrontendConfig, _ prometheus.Registerer, _ log.Logger) (http.RoundTripper, *url.URL, error) {
	...
	return newHTTPRoundTripper(&cfg.HTTPClientConfig, opentracing.GlobalTracer()), url, nil
}
