...
type Config struct {
	...
	DrainNotificationQueueOnShutdown bool `yaml:"drain_notification_queue_on_shutdown" category:"advanced"`
...
func (cfg *Config) RegisterFlags(f *flag.FlagSet, logger log.Logger) {
	...
	f.BoolVar(&cfg.DrainNotificationQueueOnShutdown, "ruler.drain-notification-queue-on-shutdown", true, "Drain all outstanding alert notifications when shutting down. If false, any outstanding alert notifications are dropped when shutting down.")
