...
type mockRoundTripper func(ctx context.Context, req *httpgrpc.HTTPRequest) (*httpgrpc.HTTPResponse, error)
...
func TestQuerier_ReadPrometheusHTTPrefix(t *testing.T) {
	...
	mockTr := func(ctx context.Context, req *httpgrpc.HTTPRequest) (*httpgrpc.HTTPResponse, error) {
		inReq = req
	...
	q := New(mockRoundTripper(mockTr), "/prometheus", log.NewNopLogger())
