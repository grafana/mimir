...
// Per-message value-comparison methods (Equal + Compare) for github.com/grafana/mimir/pkg/ruler/ruler.proto.
//
...
func (this *SyncRulesRequest) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
...
func (this *SyncRulesResponse) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
...
func (this *AlertStateDesc) Compare(that interface{}) int {
	...
	if c := this.KeepFiringSince.Compare(that1.KeepFiringSince); c != 0 {
		return c
	}
	return 0
}
