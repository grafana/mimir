...
type RuleGroupDesc struct {
	...
	Options       []*anypb.Any `protobuf:"bytes,9,rep,name=options,proto3" json:"options,omitempty"`
	...
	EvaluationDelay               time.Duration          `protobuf:"bytes,11,opt,name=evaluationDelay,proto3" json:"evaluationDelay,omitempty"`
	QueryOffset                   time.Duration          `protobuf:"bytes,13,opt,name=queryOffset,proto3" json:"queryOffset,omitempty"`
	...
	Labels                        []mimirpb.LabelAdapter `protobuf:"bytes,14,rep,name=labels,proto3" json:"labels,omitempty"`
...
type RuleDesc struct {
	...
	KeepFiringFor time.Duration          `protobuf:"bytes,13,opt,name=keep_firing_for,json=keepFiringFor,proto3" json:"keep_firing_for,omitempty"`
	Labels        []mimirpb.LabelAdapter `protobuf:"bytes,5,rep,name=labels,proto3" json:"labels,omitempty"`
	Annotations   []mimirpb.LabelAdapter `protobuf:"bytes,6,rep,name=annotations,proto3" json:"annotations,omitempty"`
}
...
func (m *RuleGroupDesc) GetOptions() []*anypb.Any {
	if m != nil {
		return m.Options
	}
	return nil
...
func (m *RuleGroupDesc) Size() int {
	...
	if m.EvaluationDelay != 0 {
		inner := protohelpers.SizeStdDuration(m.EvaluationDelay)
		n += 1 + protowire.SizeVarint(uint64(inner)) + inner
	}
	if m.QueryOffset != 0 {
		inner := protohelpers.SizeStdDuration(m.QueryOffset)
		n += 1 + protowire.SizeVarint(uint64(inner)) + inner
	}
...
func (m *RuleDesc) Size() int {
	...
	if m.KeepFiringFor != 0 {
		inner := protohelpers.SizeStdDuration(m.KeepFiringFor)
		n += 1 + protowire.SizeVarint(uint64(inner)) + inner
	}
	for i := range m.Labels {
		s := m.Labels[i].SizeWiresmith()
...
func (m *RuleGroupDesc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.QueryOffset != 0 {
		start := i
		i = protohelpers.EncodeStdDuration(dAtA, i, m.QueryOffset)
		inner := start - i
	...
	if m.EvaluationDelay != 0 {
		start := i
		i = protohelpers.EncodeStdDuration(dAtA, i, m.EvaluationDelay)
		inner := start - i
		i = protohelpers.EncodeVarint(dAtA, i, uint64(inner))
		i--
		dAtA[i] = 0x5a
	...
	for iNdEx := len(m.SourceTenants) - 1; iNdEx >= 0; iNdEx-- {
		...
		if len(m.SourceTenants[iNdEx]) <= 0x7F {
			dAtA[i-1] = uint8(len(m.SourceTenants[iNdEx]))
			i--
		} else {
...
func (m *RuleDesc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.KeepFiringFor != 0 {
		start := i
		i = protohelpers.EncodeStdDuration(dAtA, i, m.KeepFiringFor)
		inner := start - i
		i = protohelpers.EncodeVarint(dAtA, i, uint64(inner))
		i--
		dAtA[i] = 0x6a
...
func (m *RuleGroupDesc) unmarshal(dAtA []byte, depth int) error {
	...
	if l >= 256 && depth >= 0 {
		...
		if c := field10count; c > 0 {
			...
			if len(m.SourceTenants) == 0 && cap(m.SourceTenants) < c {
				m.SourceTenants = make([]string, 0, c)
			}
		}
	...
	for iNdEx < l {
		...
		case 9: // options
			...
			if err := m.Options[len(m.Options)-1].UnmarshalWithDepth(dAtA[iNdEx:postIndex], depth+1); err != nil {
				return err
			}
			iNdEx = postIndex
		...
		case 11: // evaluationDelay
			...
			m.EvaluationDelay = stddurationVal
			iNdEx = postIndex
		case 13: // queryOffset
			if wireType != 2 {
				n, err := protohelpers.SkipValue(dAtA[iNdEx:], wireType, fieldNum)
...
func (m *RuleDesc) unmarshal(dAtA []byte, depth int) error {
	...
	for iNdEx < l {
		...
		case 13: // keep_firing_for
			...
			m.KeepFiringFor = stddurationVal
			iNdEx = postIndex
		case 5: // labels
			if wireType != 2 {
				n, err := protohelpers.SkipValue(dAtA[iNdEx:], wireType, fieldNum)
