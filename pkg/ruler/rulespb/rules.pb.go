...
type RuleDesc struct {
	...
	Labels      []github_com_grafana_mimir_pkg_cortexpb.LabelAdapter `protobuf:"bytes,5,rep,name=labels,proto3,customtype=github.com/grafana/mimir/pkg/cortexpb.LabelAdapter" json:"labels"`
	Annotations []github_com_grafana_mimir_pkg_cortexpb.LabelAdapter `protobuf:"bytes,6,rep,name=annotations,proto3,customtype=github.com/grafana/mimir/pkg/cortexpb.LabelAdapter" json:"annotations"`
}
...
func (m *RemoteWriteConfig) Reset()      { *m = RemoteWriteConfig{} }
func (*RemoteWriteConfig) ProtoMessage() {}
func (*RemoteWriteConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_8e722d3e922f0937, []int{2}
}
func (m *RemoteWriteConfig) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RemoteWriteConfig) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RemoteWriteConfig.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RemoteWriteConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RemoteWriteConfig.Merge(m, src)
}
func (m *RemoteWriteConfig) XXX_Size() int {
	return m.Size()
}
func (m *RemoteWriteConfig) XXX_DiscardUnknown() {
	xxx_messageInfo_RemoteWriteConfig.DiscardUnknown(m)
}

var xxx_messageInfo_RemoteWriteConfig proto.InternalMessageInfo

func (m *RemoteWriteConfig) GetUrl() string {
	if m != nil {
		return m.Url
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*RemoteWriteConfig)(nil), "rules.RemoteWriteConfig")
}
...
var fileDescriptor_8e722d3e922f0937 = []byte{
	...
	,
}
...
func (this *RemoteWriteConfig) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*RemoteWriteConfig)
	if !ok {
		that2, ok := that.(RemoteWriteConfig)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *RemoteWriteConfig) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&rulespb.RemoteWriteConfig{")
...
func (m *RemoteWriteConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RemoteWriteConfig) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RemoteWriteConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Url) > 0 {
		i -= len(m.Url)
		copy(dAtA[i:], m.Url)
		i = encodeVarintRules(dAtA, i, uint64(len(m.Url)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *RemoteWriteConfig) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *RemoteWriteConfig) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&RemoteWriteConfig{`,
...
func (m *RemoteWriteConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RemoteWriteConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RemoteWriteConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
