...
func TestTrackerStore_HappyCase(t *testing.T) {
	...
	tracker := newTrackerStore(idleTimeout, 85, log.NewNopLogger(), limits, noopEvents{}, false, 0, newTestShardFactory())
...
func TestTrackerStore_CreatedSeriesCommunication(t *testing.T) {
	...
	tracker1 := newTrackerStore(idleTimeout, 85, log.NewNopLogger(), limits, &tracker1Events, false, 0, newTestShardFactory())
	tracker2Events := eventsPipe{}
	tracker2 := newTrackerStore(idleTimeout, 85, log.NewNopLogger(), limits, &tracker2Events, false, 0, newTestShardFactory())
...
func TestTrackerStore_Snapshot_E2E(t *testing.T) {
	...
	tracker2 := newTrackerStore(idleTimeoutMinutes*time.Minute, 85, log.NewNopLogger(), limiterMock{}, noopEvents{}, false, 0, newTestShardFactory())
...
func TestTrackerStore_Snapshot_Size(t *testing.T) {
	...
	tr := newTrackerStore(idleTimeoutMinutes*time.Minute, 85, log.NewNopLogger(), limiterMock{}, noopEvents{}, false, 0, newTestShardFactory())
...
func TestTrackerStore_Cleanup_MinTimeBetweenShardsCleanup(t *testing.T) {
	...
	now := time.Date(2020, 1, 1, 1, 2, 3, 0, time.UTC)
	tracker := newTrackerStore(time.Minute, 85, log.NewNopLogger(), limiterMock{}, noopEvents{}, false, delay, newTestShardFactory())
...
func TestTrackerStore_Cleanup_Concurrency(t *testing.T) {
	...
	tracker := newTrackerStore(idleTimeoutMinutes*time.Minute, 85, log.NewNopLogger(), limiterMock{}, createdSeries, false, 0, newTestShardFactory())
...
func TestTrackerStore_PrometheusCollector(t *testing.T) {
	...
	tracker := newTrackerStore(defaultIdleTimeout, 85, log.NewNopLogger(), limiterMock{}, noopEvents{}, false, 0, newTestShardFactory())
...
func TestTrackerStore_VerboseSeriesMetrics_Enabled(t *testing.T) {
	...
	tracker := newTrackerStore(defaultIdleTimeout, 85, log.NewNopLogger(), limiterMock{}, noopEvents{}, true, 0, newTestShardFactory())
