...
func TestTrackerStore_HappyCase(t *testing.T) {
	...
	tracker := newTrackerStore(idleTimeout, 85, 25000, log.NewNopLogger(), limits, noopEvents{})
...
func TestTrackerStore_CreatedSeriesCommunication(t *testing.T) {
	...
	tracker1 := newTrackerStore(idleTimeout, 85, 25000, log.NewNopLogger(), limits, &tracker1Events)
	tracker2Events := eventsPipe{}
	tracker2 := newTrackerStore(idleTimeout, 85, 25000, log.NewNopLogger(), limits, &tracker2Events)
...
func TestTrackerStore_Snapshot_E2E(t *testing.T) {
	...
	tracker1 := newTrackerStore(idleTimeoutMinutes*time.Minute, 85, 25000, log.NewNopLogger(), limiterMock{}, noopEvents{})
	...
	tracker2 := newTrackerStore(idleTimeoutMinutes*time.Minute, 85, 25000, log.NewNopLogger(), limiterMock{}, noopEvents{})
...
func TestTrackerStore_Snapshot_Size(t *testing.T) {
	...
	tr := newTrackerStore(idleTimeoutMinutes*time.Minute, 85, 25000, log.NewNopLogger(), limiterMock{}, noopEvents{})
...
func TestTrackerStore_Cleanup_OffByOneError(t *testing.T) {
	...
	now := time.Date(2020, 1, 1, 1, 2, 3, 0, time.UTC)
	tracker := newTrackerStore(time.Minute, 85, 25000, log.NewNopLogger(), limiterMock{}, noopEvents{})
...
func TestTrackerStore_Cleanup_Tenants(t *testing.T) {
	...
	tracker := newTrackerStore(defaultIdleTimeout, 85, 25000, log.NewNopLogger(), limits, noopEvents{})
...
func TestTrackerStore_Cleanup_Concurrency(t *testing.T) {
	...
	tracker := newTrackerStore(idleTimeoutMinutes*time.Minute, 85, 25000, log.NewNopLogger(), limiterMock{}, createdSeries)
...
func TestTrackerStore_PrometheusCollector(t *testing.T) {
	...
	tracker := newTrackerStore(defaultIdleTimeout, 85, 25000, log.NewNopLogger(), limiterMock{}, noopEvents{})
