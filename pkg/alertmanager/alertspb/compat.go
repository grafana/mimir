...
func ToGrafanaProto(cfg, user, hash string, createdAtTimestamp int64, isDefault, isPromoted bool, externalURL string, smtpFrom string, staticHeaders map[string]string) GrafanaAlertConfigDesc {
