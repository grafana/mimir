...
// Provenance-includes-location: https://github.com/cortexproject/cortex/blob/master/pkg/alertmanager/merger/v2_alert_groups_test.go
...
func TestV2AlertGroups(t *testing.T) {
	...
	in := [][]byte{
		...
		[]byte(`[` +
			...
			`"receivers":[{"active":true,"integrations":[],"name":"dummy"}],"startsAt":"2021-04-21T09:47:32.161+02:00",` +
			`"status":{"inhibitedBy":[],"silencedBy":[],"state":"unprocessed"},` +
			`"updatedAt":"2021-04-21T07:47:32.163Z","labels":{"group":"group_1","name":"alert_1"}}],` +
			`"labels":{"group":"group_1"},"receiver":{"active":true,"integrations":[],"name":"dummy"}},` +
			`{"alerts":[{"annotations":{},"endsAt":"2021-04-21T10:47:32.165+02:00","fingerprint":"465de60f606461c3",` +
			`"receivers":[{"active":true,"integrations":[],"name":"dummy"}],"startsAt":"2021-04-21T09:47:32.165+02:00",` +
			`"status":{"inhibitedBy":[],"silencedBy":[],"state":"unprocessed"},` +
			`"updatedAt":"2021-04-21T07:47:32.167Z","labels":{"group":"group_2","name":"alert_3"}}],` +
			`"labels":{"group":"group_2"},"receiver":{"active":true,"integrations":[],"name":"dummy"}}` +
			`]`),
		[]byte(`[` +
			`{"alerts":[{"annotations":{},"endsAt":"2021-04-21T10:47:32.163+02:00","fingerprint":"c4b8b79a607bee77",` +
			`"receivers":[{"active":true,"integrations":[],"name":"dummy"}],"startsAt":"2021-04-21T09:47:32.163+02:00",` +
			`"status":{"inhibitedBy":[],"silencedBy":[],"state":"unprocessed"},` +
