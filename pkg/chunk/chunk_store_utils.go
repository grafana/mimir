...
// Provenance-includes-location: https://github.com/cortexproject/cortex/blob/master/pkg/chunk/chunk_store_utils.go
...
func (c *Fetcher) FetchChunks(ctx context.Context, chunks []Chunk, keys []string) ([]Chunk, error) {
	...
	if err != nil {
		// Don't rely on Mimir error translation here.
