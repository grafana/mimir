...
// Provenance-includes-location: https://github.com/cortexproject/cortex/blob/master/pkg/chunk/cache/memcached.go
...
type Memcached struct {
	cfg      MemcachedConfig
	memcache GetterSetterMemcached
	name     string
...
func NewMemcached(cfg MemcachedConfig, client GetterSetterMemcached, name string, reg prometheus.Registerer, logger log.Logger) *Memcached {
	c := &Memcached{
		cfg:      cfg,
		memcache: client,
		name:     name,
