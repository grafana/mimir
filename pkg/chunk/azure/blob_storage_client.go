...
// Provenance-includes-location: https://github.com/cortexproject/cortex/blob/master/pkg/chunk/azure/blob_storage_client.go
...
func (c *BlobStorageConfig) RegisterFlagsWithPrefix(prefix string, f *flag.FlagSet) {
	...
	f.StringVar(&c.ContainerName, prefix+"azure.container-name", "cortex", "Name of the blob container used to store chunks. This container must be created before running mimir.")
