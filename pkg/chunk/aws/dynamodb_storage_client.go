...
// Provenance-includes-location: https://github.com/cortexproject/cortex/blob/master/pkg/chunk/aws/dynamodb_storage_client.go
...
func (cfg *DynamoDBConfig) RegisterFlags(f *flag.FlagSet) {
	...
	f.IntVar(&cfg.ChunkGangSize, "dynamodb.chunk-gang-size", 10, "Number of chunks to group together to parallelize fetches (zero to disable)")
