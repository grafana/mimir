...
// Provenance-includes-location: https://github.com/cortexproject/cortex/blob/master/pkg/chunk/aws/sse_config.go
...
func NewSSEParsedConfig(cfg mimir_s3.SSEConfig) (*SSEParsedConfig, error) {
	switch cfg.Type {
	case mimir_s3.SSES3:
		return &SSEParsedConfig{
			ServerSideEncryption: sseS3Type,
		}, nil
	case mimir_s3.SSEKMS:
		if cfg.KMSKeyID == "" {
