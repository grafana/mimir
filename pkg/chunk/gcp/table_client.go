...
// Provenance-includes-location: https://github.com/cortexproject/cortex/blob/master/pkg/chunk/gcp/table_client.go
...
// ListTables lists all of the correctly specified mimir tables in bigtable
