...
type Limits struct {
	...
	DistributorArtificialIngestionDelay         model.Duration      `yaml:"distributor_artificial_ingestion_delay" json:"distributor_artificial_ingestion_delay" category:"experimental"`
