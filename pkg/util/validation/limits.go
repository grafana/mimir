...
const (
	...
	enableServiceUnavailableErrorOnRateLimitFlag = "distributor.enable_service_unavailable_error_on_rate_limit"
...
type Limits struct {
	...
	EnableServiceUnavailableErrorOnRateLimit bool                `yaml:"enable_service_unavailable_error_on_rate_limit" json:"enable_service_unavailable_error_on_rate_limit" category:"experimental"`
...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.BoolVar(&l.EnableServiceUnavailableErrorOnRateLimit, enableServiceUnavailableErrorOnRateLimitFlag, false, "Flag to determines the error code returned when distributor rate limits are reached. If set to true, the error code will be 503; if set to false, a 429 error is returned")
...
// EnableServiceUnavailableErrorOnRateLimit return whether the distributor uses error code 503 instead of 429 when the rate limit is exceeded.
func (o *Overrides) EnableServiceUnavailableErrorOnRateLimit(userID string) bool {
	return o.getOverridesForUser(userID).EnableServiceUnavailableErrorOnRateLimit
}
