...
type Limits struct {
	...
	EphemeralSeriesMatchers ephemeral.SeriesMatchers `yaml:"ephemeral_series_matchers" json:"ephemeral_series_matchers" doc:"nocli|description=Matchers to check if a series should be marked ephemeral, matching series get marked to be stored in the ephemeral store." category:"experimental"`
}
