...
type Limits struct {
	...
	CustomUserLabelValue string `yaml:"custom_user_label" json:"custom_user_label"`
...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.StringVar(&l.CustomUserLabelValue, "validation.custom-user-label-value", "team", "User configured label value to be added to specific metrics") // Where will these metrics be documented/defined?
...
// CustomUserLabelValue returns the user defined label applied to specific metrics
func (o *Overrides) CustomUserLabelValue(userID string) string {
	return o.getOverridesForUser(userID).CustomUserLabelValue
}
