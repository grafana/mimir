...
type Limits struct {
	...
	OTelLogTargetInfoLabelNameCollisions     bool                         `yaml:"otel_log_target_info_label_name_collisions" json:"otel_log_target_info_label_name_collisions" category:"experimental"`
...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.BoolVar(&l.OTelLogTargetInfoLabelNameCollisions, "distributor.otel-log-target-info-label-name-collisions", false, "Whether to log, at debug level, OTel resource attributes that collide after label name sanitization in the OTLP endpoint. Colliding attribute values may get concatenated with ';' in the resulting target_info label; empty values get overwritten or dropped instead.")
...
func (o *Overrides) OTelLogTargetInfoLabelNameCollisions(tenantID string) bool {
	return o.getOverridesForUser(tenantID).OTelLogTargetInfoLabelNameCollisions
}
