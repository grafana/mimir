...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.Var(&l.CompactorMaxLookback, "compactor.max-lookback", "Blocks uploaded before the lookback aren't considered in compactor cycles. If set, this value should be larger than the TSDB block range period (2h by default). A value of 0s means that all blocks are considered regardless of their upload time.")
