...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.StringVar(&l.SeparateMetricsLabel, "validation.separate-metrics-label", "", "Label used to further separate specific metrics.") // Where will these metrics be documented/defined?
