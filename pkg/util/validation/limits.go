...
const (
	...
	enableServiceOverloadErrorOnRateLimitFlag = "distributor.enable-service-overload-error-on-rate-limit"
...
type Limits struct {
	...
	EnableServiceOverloadErrorOnRateLimit bool                `yaml:"enable_service_overload_error_on_rate_limit" json:"enable_service_overload_error_on_rate_limit" category:"experimental"`
...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.BoolVar(&l.EnableServiceOverloadErrorOnRateLimit, enableServiceOverloadErrorOnRateLimitFlag, false, "Flag to determines the error code returned when distributor rate limits are reached. If set to true, the error code will be 529; if set to false, a 429 error is returned")
...
// EnableServiceOverloadErrorOnRateLimit return whether the distributor uses error code 529 instead of 429 when the rate limit is exceeded.
func (o *Overrides) EnableServiceOverloadErrorOnRateLimit(userID string) bool {
	return o.getOverridesForUser(userID).EnableServiceOverloadErrorOnRateLimit
}
