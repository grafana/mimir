...
type Limits struct {
	...
	OTelConvertScopeMetadata                 bool                   `yaml:"otel_convert_scope_metadata" json:"otel_convert_scope_metadata" category:"experimental"`
...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.BoolVar(&l.OTelConvertScopeMetadata, "distributor.otel-convert-scope-metadata", false, "Whether to convert OTel scope metadata (scope name, version, schema URL, attributes) to corresponding metric labels, prefixed with otel_scope_.")
...
func (o *Overrides) OTelConvertScopeMetadata(tenantID string) bool {
	return o.getOverridesForUser(tenantID).OTelConvertScopeMetadata
}
