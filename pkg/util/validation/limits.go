...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.IntVar(&l.ActiveSeriesResultsMaxSizeBytes, "querier.active-series-results-max-size-bytes", 400*1024*1024, "Maximum size of an active series request result shard in bytes. Maximum size of active native histogram series loaded for calculating active native histogram statistics. 0 to disable.")
