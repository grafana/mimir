...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.StringVar(&l.CustomUserLabelValue, "validation.custom-user-label-value", "", "User configured label value to be added to specific metrics") // Where will these metrics be documented/defined?
