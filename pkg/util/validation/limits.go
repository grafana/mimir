...
type Limits struct {
	...
	SeparateMetricsLabel string `yaml:"separate_metrics_label" json:"separate_metrics_label"`
...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.StringVar(&l.SeparateMetricsLabel, "validation.separate-metrics-label", "", "Label used to further separate specific distributor and ingester metrics. For each write request, the group is obtained from the first non-empty group label from the incoming list of timeseries.")
