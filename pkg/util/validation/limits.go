...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.BoolVar(&l.OTelLogTranslationWarnings, "distributor.otel-log-translation-warnings", false, "Whether to log OTLP translation warnings, e.g. about attribute names that collide after label name sanitization, in the OTLP endpoint, as usage insights. Warnings are deduplicated and rate-limited per tenant.")
