...
type Limits struct {
	...
	OTelLogTranslationWarnings               bool                         `yaml:"otel_log_translation_warnings" json:"otel_log_translation_warnings" category:"experimental"`
...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.BoolVar(&l.OTelLogTranslationWarnings, "distributor.otel-log-translation-warnings", false, "Whether to log OTLP translation warnings, e.g. about attribute names that collide after label name sanitization, in the OTLP endpoint, as usage insights. Warnings are deduplicated and rate-limited per tenant. The cortex_distributor_otlp_translation_warnings_total metric is recorded regardless of this setting.")
...
func (o *Overrides) OTelLogTranslationWarnings(tenantID string) bool {
	return o.getOverridesForUser(tenantID).OTelLogTranslationWarnings
}
