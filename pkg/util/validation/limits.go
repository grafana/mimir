...
type Limits struct {
	...
	LimitedQueries                         []*LimitedQuery        `yaml:"limited_queries,omitempty" json:"limited_queries,omitempty" doc:"nocli|description=List of queries to limit and duration to limit them for." category:"experimental"`
