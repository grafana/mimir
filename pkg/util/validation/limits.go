...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.Int64Var(&l.RulerMaxConcurrentRuleEvaluations, "ruler.max-concurrent-rule-evaluations", 4, "Maximum number of independent rules that can run concurrently. 0 to disable.")
...
// RulerMaxConcurrentRuleEvaluations returns the maximum number of independent rules that can run concurrently.
func (o *Overrides) RulerMaxConcurrentRuleEvaluations(userID string) int64 {
