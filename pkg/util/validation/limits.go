...
type Limits struct {
	...
	SeparateMetricsLabel string `yaml:"separate_metrics_label" json:"separate_metrics_label" category:"experimental"`
...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.StringVar(&l.SeparateMetricsLabel, "validation.separate-metrics-label", "", "Label used to further separate specific distributor and ingester metrics adding a 'group' label. For each write request, the group is obtained from the first non-empty group label from the incoming list of timeseries.")
...
// SeparateMetricsLabel returns the custom label used to separate specific metrics
