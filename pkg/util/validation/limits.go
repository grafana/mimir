...
type Limits struct {
	...
	RulerProtectedNamespaces               flagext.StringSlice `yaml:"ruler_protected_namespaces" json:"ruler_protected_namespaces" category:"experimental"`
...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.Var(&l.RulerProtectedNamespaces, "ruler.protected-namespaces", "Namespaces that are protected from modification unless a special HTTP header is used, the flag can be repeated in order to protect multiple namespaces. If a namespace is protected, it cannot be modified via the ruler's config API only read. The value is a string that represents the namespace name.")
