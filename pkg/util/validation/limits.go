...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.Var(&l.OutOfOrderAllowance, "ingester.out-of-order-allowance", "Non-zero value enables out-of-order support for most recent samples in this time window. Ingester will need more memory that is a factor of rate of out of order sample being ingested and number of series getting out of order samples. When enabled ingester will be enabled to query overlapping blocks.")
