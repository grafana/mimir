...
// Package slicesleak_test is intended reproduce the tests for the Go stdlib slices package
// as it existed in Go 1.21, prior to the acceptance of Proposal 63393.
// The desired slices package behavior is reproduced here by the slicesleak package.
// See slicesleak.go for references.
package slicesleak_test

// The code below is an unmodified copy of the slices_test.go at the commit prior to the Proposal 63393 changes.
// https://github.com/golang/go/blob/e14b96cb511ab3437dedf2be2fa49d4516189bbc/src/slices/slices_test.go
