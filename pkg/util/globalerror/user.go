...
const (
	...
	DistributorMaxOtelCompressedMessageSize   ID = "distributor-max-otel-compressed-message-size"
	DistributorMaxOtelUncompressedMessageSize ID = "distributor-max-otel-uncompressed-message-size"
