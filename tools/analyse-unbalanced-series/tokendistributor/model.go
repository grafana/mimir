...
func (i *instanceInfo) toStringVerbose() string {
	return fmt.Sprintf("instanceInfo{instanceId:%s,zone:%s,tokenCount:%d,weight:%.2f,adjustedOwnership:%.2f}", i.instanceId, i.zone, i.tokenCount, i.ownership, i.adjustedOwnership)
}
