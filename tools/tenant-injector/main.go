...
// Provenance-includes-location: https://github.com/cortexproject/cortex/blob/master/tools/auth-injector/main.go
...
func main() {
	...
	flag.StringVar(&cfg.RemoteURL, "remote-address", "", "URL of target to forward requests to (eg. http://domain.com:80).")
