// This file is vendored from Prometheus, prompb/io/prometheus/write/v2/types.pb.go
// It's snapshotted at the time that RW3 was at the Release Candidate 3 phase.
// RW2.0 has since moved on from that, but this file allows us to generate RW2.0-rc3 style proto messages for use in tests.
// This should no longer be needed once Mimir moves on to future RW2 release candidates.
//
// All fully-qualified Protobuf type names have been modified from the original
// io.prometheus.write.v2.* to the corresponding io.prometheus.write.v2rc3.*
//
...
type Metadata struct {
	Type Metadata_MetricType `protobuf:"varint,1,opt,name=type,proto3,enum=io.prometheus.write.v2rc3.Metadata_MetricType" json:"type,omitempty"`
...
type Histogram struct {
	...
	ResetHint      Histogram_ResetHint `protobuf:"varint,14,opt,name=reset_hint,json=resetHint,proto3,enum=io.prometheus.write.v2rc3.Histogram_ResetHint" json:"reset_hint,omitempty"`
	// timestamp represents timestamp of the sample in ms.
	//
	// For Go, see github.com/prometheus/prometheus/model/timestamp/timestamp.go
	// for conversion from/to time.Time to Prometheus timestamp.
...
func init() {
	proto.RegisterEnum("io.prometheus.write.v2rc3.Metadata_MetricType", Metadata_MetricType_name, Metadata_MetricType_value)
	proto.RegisterEnum("io.prometheus.write.v2rc3.Histogram_ResetHint", Histogram_ResetHint_name, Histogram_ResetHint_value)
	proto.RegisterType((*Request)(nil), "io.prometheus.write.v2rc3.Request")
	proto.RegisterType((*TimeSeries)(nil), "io.prometheus.write.v2rc3.TimeSeries")
	proto.RegisterType((*Exemplar)(nil), "io.prometheus.write.v2rc3.Exemplar")
	proto.RegisterType((*Sample)(nil), "io.prometheus.write.v2rc3.Sample")
	proto.RegisterType((*Metadata)(nil), "io.prometheus.write.v2rc3.Metadata")
	proto.RegisterType((*Histogram)(nil), "io.prometheus.write.v2rc3.Histogram")
	proto.RegisterType((*BucketSpan)(nil), "io.prometheus.write.v2rc3.BucketSpan")
}
