...
const (
	...
	grafanaAlertmanagerBucketName  = "grafana_alertmanager"
	alertmanagerFallbackConfigFile = "alertmanager-fallback-config.yaml"
)
...
var (
	...
	AlertmanagerMemberlistFlags = func(amJoinAddress string) map[string]string {
		return map[string]string{
			"-alertmanager.sharding-ring.store":              "memberlist",
			"-alertmanager.sharding-ring.replication-factor": "3",
			"-memberlist.join":                               amJoinAddress,
