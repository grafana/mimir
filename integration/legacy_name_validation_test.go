...
func testLegacyNameValidationQuerier(t *testing.T, queryEngine string) {
	...
	testCases := []struct {
		...
		{
			// this passes, we do not validate label matchers
			name:  "utf8 metric name",
...
// TestLegacyNameValidation_Ruler ensures ruler only accepts rules adhering to legacy naming conventions.
func TestLegacyNameValidation_Ruler(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "utf8 rule group label name",
			rg: rulefmt.RuleGroup{
				Name: "test",
				Rules: []rulefmt.Rule{
					{
		...
		{
			name: "utf8 rule group expression",
			rg: rulefmt.RuleGroup{
				Name: "test",
				Rules: []rulefmt.Rule{
					{
		...
		{
			name: "invalid utf8 recording rule metric name",
			rg: rulefmt.RuleGroup{
				Name: "test",
				Rules: []rulefmt.Rule{
					{
		...
		{
			name: "invalid utf8 rule label name",
			rg: rulefmt.RuleGroup{
				Name: "test",
				Rules: []rulefmt.Rule{
					{
		...
		{
			name: "invalid utf8 rule annotations",
			rg: rulefmt.RuleGroup{
				Name: "test",
				Rules: []rulefmt.Rule{
					{
