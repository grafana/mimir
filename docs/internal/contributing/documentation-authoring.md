...
Grafana Mimir adopts these instructions and guidelines for writing documentation. These apply to both human contributors and AI agents authoring documentation for Grafana Mimir.

For overall style guide and writing guidelines, see [Grafana Labs Writers' Toolkit](https://grafana.com/docs/writers-toolkit/).
