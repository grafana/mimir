...
The Grafana Mimir documentation is compiled into a website published at [grafana.com](https://grafana.com/). You can run `make docs` to build and run a local copy of the documentation website.
