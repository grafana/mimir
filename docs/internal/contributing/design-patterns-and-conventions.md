...
- When adding a new config option, look if a similar one already exists within the [config](../../sources/mimir/configure/configuration-parameters/index.md) and keep the same naming (ie. `addresses` for a list of network endpoints)
