...
When using split-and-merge compactor any split jobs are moved to the front of work queue, because finishing all split jobs in given time range unblocks all merge jobs.
