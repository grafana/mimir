...
To configure the compactors' hash ring, refer to [configuring hash rings]({{< relref "../../../configure/configuring-hash-rings.md" >}}).
...
Refer to the [compactor]({{< relref "../../../configure/reference-configuration-parameters/index.md#compactor" >}})
block section and the [limits]({{< relref "../../../configure/reference-configuration-parameters/index.md#limits" >}}) block section for details of compaction-related configuration.
