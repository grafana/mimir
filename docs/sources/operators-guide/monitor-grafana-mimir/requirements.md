...
for more information about the Helm chart metamonitoring refer to [Collect metrics and logs via the Helm chart]({{< relref "collecting-metrics-and-logs.md#collect-metrics-and-logs-via-the-helm-chart" >}}).
If you are using the Helm chart metamonitoring you can proceed to [Installing Grafana Mimir dashboards and alerts]({{< relref "installing-dashboards-and-alerts.md" >}}).

If you are not using the mimir-distributed Helm chart, then continue reading.
