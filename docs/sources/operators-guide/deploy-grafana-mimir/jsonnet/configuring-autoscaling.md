...
The [alert `MimirQuerierAutoscalerNotActive`]({{< relref "../../monitoring-grafana-mimir/_index.md" >}}) fires if HPA is unable to scale the deployment for any reason (e.g. unable to scrape metrics from KEDA metrics API server).
