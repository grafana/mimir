---
title: "Configuring high-availability deduplication"
...
For more information, see [distributor]({{< relref "../configuring/reference-configuration-parameters/index.md#distributor" >}}). The HA tracker flags are prefixed with `-distributor.ha-tracker.*`.
