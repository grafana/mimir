...
See also [Planning Grafana Mimir capacity](/docs/mimir/v2.6.x/operators-guide/run-production-environment/planning-capacity/).
...
component, refer to [Ingesters failure and data loss](/docs/mimir/v2.6.x/operators-guide/architecture/components/ingester/#ingesters-failure-and-data-loss/)
or [Store-gateway: Blocks sharding and replication](/docs/mimir/v2.6.x/operators-guide/architecture/components/store-gateway/#blocks-sharding-and-replication/).
...
For more information, see [Installing Grafana Mimir dashboards and alerts](/docs/mimir/v2.6.x/operators-guide/monitor-grafana-mimir/installing-dashboards-and-alerts/).
...
3. Add the following YAML snippet to your
   ...
   metrics and logs from Grafana Mimir](/docs/mimir/v2.6.x/operators-guide/monitor-grafana-mimir/collecting-metrics-and-logs/).
