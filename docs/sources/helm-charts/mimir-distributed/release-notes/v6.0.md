...
To upgrade from version 5.x, refer to the [Migrate the Helm chart from version 5.x to 6.0](https://grafana.com/docs/helm-charts/mimir-distributed/latest/migration-guides/migrate-helm-chart-5.x-to-6.0/) guide.
