...
Configuration for `active_series_custom_trackers_config` has been moved from `ingester` section to `limits` section and the former going to be deprecated from Mimir version 2.3 .
