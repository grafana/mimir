...
To avoid repetition, you can use the [common configuration]({{< relref "../_index.md#common-configurations" >}}) and fill the [`common`]({{< relref "../references/configuration-parameters/index.md#common" >}}) configuration block or by providing the `-common.storage.*` CLI flags.
...
> **Note**: If you're using a mixture of YAML files and CLI flags, pay attention to their [precedence logic]({{< relref "../_index.md#common-configurations" >}}).
