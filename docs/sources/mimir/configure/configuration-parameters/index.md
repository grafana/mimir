...
push_adaptive_limiter:
  ...
  # (experimental) Minimum duration of the window that is used to determine the recent,
...
read_adaptive_limiter:
  ...
  # (experimental) Maximum duration of the window that is used to determine recent,
  # short-term load on the system
