...
# If zero, it defaults to the base HA tracker configuration.
...
# a sample from. This value must be greater than the update timeout. If zero, it
# defaults to the base HA tracker configuration.
[ha_tracker_failover_timeout: <int> | default = ]
