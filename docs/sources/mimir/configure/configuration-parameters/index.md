...
# cortex_distributor_received_attributed_samples_total. To disable, set to an empty string.
# For example, 'team,service' produces metrics such as
# cortex_distributor_received_attributed_samples_total{team='frontend', service='api'}.
