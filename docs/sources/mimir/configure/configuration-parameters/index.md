...
# Encoding used for float chunks written for this tenant by the ingester and
# block-builder, and by the compactor when it re-encodes overlapping chunks.
# Supported values are: xor, xor2.
