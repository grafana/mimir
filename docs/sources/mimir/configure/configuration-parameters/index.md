...
tsdb:
  ...
  # (experimental) Enable periodic collection of head statistics for
  # optimization of query execution purposes.
  # CLI flag: -blocks-storage.tsdb.collect-head-statistics
  [collect_head_statistics: <boolean> | default = false]

  # (experimental) How frequently to collect head statistics. Must enable
  # collect-head-statistics to take effect.
  # CLI flag: -blocks-storage.tsdb.head-statistics-collection-frequency
  [head_statistics_collection_frequency: <duration> | default = 10m]
