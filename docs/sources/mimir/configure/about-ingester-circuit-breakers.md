...
{{% admonition type="note" %}}Push requests circuit breakers are only available in classic architecture. Refer to [Grafana Mimir architecture](https://grafana.com/docs/mimir/<MIMIR_VERSION>/get-started/about-grafana-mimir-architecture/).
{{% /admonition %}}
...
{{% admonition type="note" %}}Read requests circuit breakers are available in both classic and ingest storage architectures. Refer to [Grafana Mimir architecture](https://grafana.com/docs/mimir/<MIMIR_VERSION>/get-started/about-grafana-mimir-architecture/).
{{% /admonition %}}
