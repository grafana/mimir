...
- On a per-tenant basis, you can override all of the limits listed in the [`limits`](../configuration-parameters/#limits) block within the runtime configuration file.
...
Everything under the `instance_limits` section within the [`ingester`](../configuration-parameters/#ingester) block can be overridden via runtime configuration.
...
Everything under the `instance_limits` section within the [`distributor`](../configuration-parameters/#distributor) block can be overridden via runtime configuration.
