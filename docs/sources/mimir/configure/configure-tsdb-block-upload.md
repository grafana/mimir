...
To make performing block upload simple, we've built support for it into Mimir's CLI tool, [mimirtool]({{< relref "../operators-guide/tools/mimirtool" >}}). For more information, see [mimirtool backfill]({{< relref "../operators-guide/tools/mimirtool#backfill" >}}).
