...
You only need to configure spread-minimizing token generation if you're running Grafana Mimir with classic architecture. With ingest storage architecture, this process is automatic and doesn't require configuration.

Refer to [Grafana Mimir architecture](https://grafana.com/docs/mimir/<MIMIR_VERSION>/get-started/about-grafana-mimir-architecture/).{{< /admonition >}}
