...
- Querier
  ...
  - [Mimir query engine]({{< relref "../references/architecture/mimir-query-engine" >}}) (`-querier.query-engine=mimir` and `-querier.enable-query-engine-fallback`, and all flags beginning with `-querier.mimir-query-engine`)
