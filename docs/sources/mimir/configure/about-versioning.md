...
- etcd and Consul as backend storage options for the HA tracker (deprecated since Mimir 3.0)
  - Use `memberlist` instead. Refer to the migration guide for instructions on migrating from etcd or Consul to memberlist for the HA tracker.
