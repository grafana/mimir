...
- Query-frontend
  ...
  - Executing the remote read middleware chain separately for each query and merging the results in the query-frontend: `-query-frontend.use-remote-read-round-tripper-v2=true`
