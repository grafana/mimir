...
By default, Grafana Mimir uses memberlist to implement a [key-value (KV) store]({{< relref "./key-value-store" >}}) to share the [hash ring]({{< relref "./hash-ring" >}}) data structures between instances.
