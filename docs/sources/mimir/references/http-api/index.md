...
This endpoint displays the [runtime configuration]({{< relref "../../configure/overview/runtime-configuration.md" >}}) currently applied to Grafana Mimir, in YAML format, including default values.
