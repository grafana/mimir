...
There are multiple [ways to configure Google Cloud Storage client](https://grafana.com/docs/mimir/latest/reference-configuration-parameters/#gcs_storage_backend).
