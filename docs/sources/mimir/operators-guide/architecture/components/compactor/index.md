...
Refer to the [compactor]({{< relref "../../../../reference-configuration-parameters/index.md#compactor" >}})
block section and the [limits]({{< relref "../../../../reference-configuration-parameters/index.md#limits" >}}) block section for details of compaction-related configuration.
