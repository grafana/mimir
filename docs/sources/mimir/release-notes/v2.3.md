...
- [Query sharding](/docs/mimir/latest/operators-guide/architecture/query-sharding/) is now enabled by default which should give you better performance on high cardinality metrics queries.
  - To compensate for the increased number of queries generated by query sharding, the [query scheduler](/docs/mimir/latest/operators-guide/architecture/components/query-scheduler/) component is now enabled by default.
