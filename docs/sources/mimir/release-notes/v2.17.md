...
In query-frontends, you can set the `query-frontend.extra-propagated-headers` option to specify extra headers allowed to pass through to the rest of the query path.
