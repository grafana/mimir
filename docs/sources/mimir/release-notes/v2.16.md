...
Alpine Linux based Docker images are no longer built for releases, only [distroless](https://github.com/GoogleContainerTools/distroless) Docker images.
...
- OTLP: Fix response body and Content-Type header to align with spec. #10852
