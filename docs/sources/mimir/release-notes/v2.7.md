...
- For GEM 2.7 : The Deploy on Linux has the wrong URL for Download the binary section ( https://grafana.com/docs/enterprise-metrics/latest/setup/linux/#download-and-configure-the-gem-binary ). The correct URL should be https://dl.grafana.com/gem/releases/enterprise-metrics-v2.6.0-linux-amd64
