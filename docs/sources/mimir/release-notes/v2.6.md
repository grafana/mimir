...
The Grafana Mimir and Grafana Enterprise Metrics Helm chart is now released independently. See the [corresponding documentation](https://grafana.com/docs/helm-charts/mimir-distributed/latest/) for more information.
