...
- **Improved query-scheduler performance under load** by using a central dispatcher to allocate requests to queriers instead of having each querier spend cycles checking for work to do on each incoming request.
