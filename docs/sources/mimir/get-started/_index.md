...
> To opt out, refer to [Disable the anonymous usage statistics reporting]({{< relref "configure/overview/anonymous-usage-statistics-reporting.md#disable-the-anonymous-usage-statistics-reporting" >}}).
