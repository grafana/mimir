...
For more information, refer to [Listblocks](https://grafana.com/docs/mimir/<MIMIR_VERSION>/manage/tools/listblocks/).
...
For more information, refer to [Tenant injector](https://grafana.com/docs/mimir/<MIMIR_VERSION>/manage/tools/tenant-injector/).

## Query-tee

Query-tee is a standalone tool designed for testing and comparison purposes, specifically when evaluating the query results and performance of two Grafana Mimir clusters.

For more information, refer to [Query-tee](https://grafana.com/docs/mimir/<MIMIR_VERSION>/manage/tools/query-tee/).

## Continuous-test

Continuous-test provides continuous testing of Mimir's client-side functionalities, particularly around writing and querying series data.

For more information, refer to [Continuous-test](https://grafana.com/docs/mimir/<MIMIR_VERSION>/manage/tools/mimir-continuous-test/).
...
For more information, refer to [Mimirtool](https://grafana.com/docs/mimir/<MIMIR_VERSION>/manage/tools/mimirtool/).

## Mark-blocks

Mark-blocks manages the state of time series data blocks in object storage. This tool helps in maintaining data integrity and managing storage effectively, especially in scenarios involving data corruption or manual cleanup.

For more information, refer to [Mark-blocks](https://grafana.com/docs/mimir/<MIMIR_VERSION>/manage/tools/markblocks/).
