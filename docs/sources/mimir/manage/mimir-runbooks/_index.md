...
- If a job fails for longer than ingesters retain and are queried for the affected samples (typically after `-querier.query-ingesters-within`), query results may be missing data from the affected range.
