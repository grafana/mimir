...
- Grafana Mimir dashboards and alerts [require specific labels](../requirements/) to be set by Prometheus or Grafana Agent when scraping your Mimir cluster metrics
