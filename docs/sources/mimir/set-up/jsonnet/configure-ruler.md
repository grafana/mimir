...
For more information about the ruler, see [Grafana Mimir ruler](../../../references/architecture/components/ruler/).
...
For more information about the options available for storing ruler state, see [Grafana Mimir ruler: State](../../../references/architecture/components/ruler/#state).
...
For more information, refer to [Grafana Mimir configuration parameters: ruler_storage](../../../configure/configuration-parameters/#ruler_storage).
{{< /admonition >}}
...
For more information about these modes, see [Operational modes](../../../references/architecture/components/ruler/#operational-modes).
