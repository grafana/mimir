...
The [alert `MimirAutoscalerNotActive`]({{< relref "../../operators-guide/monitor-grafana-mimir" >}}) fires if HPA is unable to scale the deployment for any reason (e.g. unable to scrape metrics from KEDA metrics API server).
