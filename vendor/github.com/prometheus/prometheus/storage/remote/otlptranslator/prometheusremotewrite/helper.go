...
//
// Each finalKey is recorded at most once per FromMetrics call, so a collision
// repeated across data points costs one map lookup per occurrence instead of
// rebuilding the annotation. Accepted limitation: if different attribute sets
