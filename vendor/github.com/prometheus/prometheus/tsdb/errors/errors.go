...
// Package errors provides a multi-error type.
// This is a stub kept for backward compatibility with vendored dependencies
// that still reference this package (e.g., github.com/grafana/e2e).
package errors
