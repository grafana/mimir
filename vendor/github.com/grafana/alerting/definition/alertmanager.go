...
func (c *PostableApiAlertingConfig) Validate() error {
	...
	// Taken from https://github.com/prometheus/alertmanager/blob/e5821b78917591a5603e3e1788b6a94d5b2972e0/config/config.go
...
func (r *PostableApiReceiver) UnmarshalYAML(unmarshal func(interface{}) error) error {
	...
	// TODO: do we want the custom unmarshaller to run?
