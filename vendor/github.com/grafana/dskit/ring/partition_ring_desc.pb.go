...
const (
	...
	// This state is not visible to ring clients. It's only used for gossiping, to propagate the information that a
	// owner has been removed. Owners in this state are removed before client can see them.
