...
func (orig *ExportProfilesServiceResponse) UnmarshalProtoOpts(buf []byte, opts *pdata.UnmarshalOptions) error {
	var err error
	var fieldNum int32
	...
	for pos < l {
		...
		case 1:
			...
			err = orig.PartialSuccess.UnmarshalProtoOpts(buf[startPos:pos], opts)
			if err != nil {
				return err
			}
		default:
...
func SkipExportProfilesServiceResponseProto(buf []byte) error {
	var err error
	var fieldNum int32
	var wireType proto.WireType
	...
	for pos < l {
		...
		case 1:
			...
			err = SkipExportProfilesPartialSuccessProto(buf[startPos:pos])
			if err != nil {
				return err
			}
		default:
