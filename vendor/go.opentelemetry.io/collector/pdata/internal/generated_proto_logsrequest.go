...
func (orig *LogsRequest) UnmarshalProtoOpts(buf []byte, opts *pdata.UnmarshalOptions) error {
	var err error
	var fieldNum int32
	...
	for pos < l {
		...
		case 3:
			...
			err = orig.LogsData.UnmarshalProtoOpts(buf[startPos:pos], opts)
			if err != nil {
				return err
			}
...
func SkipLogsRequestProto(buf []byte) error {
	var err error
	var fieldNum int32
	var wireType proto.WireType
	...
	for pos < l {
		...
		case 3:
			...
			err = SkipLogsDataProto(buf[startPos:pos])
			if err != nil {
				return err
			}
