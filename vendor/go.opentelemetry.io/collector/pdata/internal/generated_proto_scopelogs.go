...
func (orig *ScopeLogs) UnmarshalProtoOpts(buf []byte, opts *pdata.UnmarshalOptions) error {
	var err error
	var fieldNum int32
	...
	for pos < l {
		...
		case 2:
			...
			startPos := pos - length
			orig.LogRecords = append(orig.LogRecords, NewLogRecord())
			err = orig.LogRecords[len(orig.LogRecords)-1].UnmarshalProtoOpts(buf[startPos:pos], opts)
			if err != nil {
				return err
			}
...
func SkipScopeLogsProto(buf []byte) error {
	var err error
	var fieldNum int32
	var wireType proto.WireType
	...
	for pos < l {
		...
		case 2:
			...
			err = SkipLogRecordProto(buf[startPos:pos])
			if err != nil {
				return err
			}
