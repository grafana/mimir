...
func (orig *Summary) UnmarshalProtoOpts(buf []byte, opts *pdata.UnmarshalOptions) error {
	var err error
	var fieldNum int32
...
func SkipSummaryProto(buf []byte) error {
	var err error
	var fieldNum int32
	var wireType proto.WireType
	...
	for pos < l {
		...
		case 1:
			...
			err = SkipSummaryDataPointProto(buf[startPos:pos])
			if err != nil {
				return err
			}
		default:
