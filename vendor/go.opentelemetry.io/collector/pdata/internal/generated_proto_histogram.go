...
func (orig *Histogram) UnmarshalProtoOpts(buf []byte, opts *pdata.UnmarshalOptions) error {
	var err error
	var fieldNum int32
...
func SkipHistogramProto(buf []byte) error {
	var err error
	var fieldNum int32
	var wireType proto.WireType
	...
	for pos < l {
		...
		case 1:
			...
			err = SkipHistogramDataPointProto(buf[startPos:pos])
			if err != nil {
				return err
			}
