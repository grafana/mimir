...
func (orig *ProfilesData) UnmarshalProtoOpts(buf []byte, opts *pdata.UnmarshalOptions) error {
	var err error
	var fieldNum int32
	...
	for pos < l {
		...
		case 1:
			...
			startPos := pos - length
			orig.ResourceProfiles = append(orig.ResourceProfiles, NewResourceProfiles())
			err = orig.ResourceProfiles[len(orig.ResourceProfiles)-1].UnmarshalProtoOpts(buf[startPos:pos], opts)
			if err != nil {
				return err
			}
		...
		case 2:
			...
			err = orig.Dictionary.UnmarshalProtoOpts(buf[startPos:pos], opts)
			if err != nil {
				return err
			}
		default:
...
func SkipProfilesDataProto(buf []byte) error {
	var err error
	var fieldNum int32
	var wireType proto.WireType
	...
	for pos < l {
		...
		case 1:
			...
			err = SkipResourceProfilesProto(buf[startPos:pos])
			if err != nil {
				return err
			}
		...
		case 2:
			...
			err = SkipProfilesDictionaryProto(buf[startPos:pos])
			if err != nil {
				return err
			}
		default:
