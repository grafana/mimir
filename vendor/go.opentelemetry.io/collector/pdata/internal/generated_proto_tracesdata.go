...
func (orig *TracesData) UnmarshalProtoOpts(buf []byte, opts *pdata.UnmarshalOptions) error {
	var err error
	var fieldNum int32
	...
	for pos < l {
		...
		case 1:
			...
			startPos := pos - length
			orig.ResourceSpans = append(orig.ResourceSpans, NewResourceSpans())
			err = orig.ResourceSpans[len(orig.ResourceSpans)-1].UnmarshalProtoOpts(buf[startPos:pos], opts)
			if err != nil {
				return err
			}
		default:
