...
func (orig *ExportProfilesPartialSuccess) UnmarshalProtoOpts(buf []byte, opts *pdata.UnmarshalOptions) error {
	var err error
	var fieldNum int32
...
func SkipExportProfilesPartialSuccessProto(buf []byte) error {
	var err error
	var fieldNum int32
	var wireType proto.WireType
