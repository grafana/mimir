std.manifestYamlDoc({
  ...
  write:: {
    ...
    'mimir-write-zone-a-1': mimirService({
      ...
      extraArguments: ['-ingester.ring.instance-availability-zone=zone-a', '-ingester.ring.token-generation-strategy=spread-minimizing', '-ingester.ring.spread-minimizing-zones=zone-a'],
