...
require (
	...
	github.com/grafana/alerting v0.0.0-20250923211036-ce8dbe36e67e
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20250919144151-14d2a30d6abe
