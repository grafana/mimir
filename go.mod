...
require (
	...
	github.com/grafana/dskit v0.0.0-20260401084324-1cf1f4c6679f
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20260408161655-c2a1e35924db
