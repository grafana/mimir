...
require (
	...
	github.com/grafana/dskit v0.0.0-20250627131744-6e0e9e3dac34
...
replace github.com/prometheus/prometheus => github.com/juliusmh/mimir-prometheus v1.8.2-0.20250704091229-c0349fdf57b1
