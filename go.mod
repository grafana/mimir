...
require (
	...
	github.com/grafana/wiresmith v0.0.0-20260416135656-59d4396359f0 // indirect
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20260415064817-bc33690c4b5d
