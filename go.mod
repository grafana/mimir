...
require (
	...
	github.com/grafana/dskit v0.0.0-20251125153219-1b93cfe76e9f
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20251127134437-3429c6e5158a
