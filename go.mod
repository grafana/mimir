...
require (
	...
	github.com/grafana/dskit v0.0.0-20250715115838-7fac058e0e7b
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20250716024150-acace3cd1e02
