...
require (
	...
	github.com/grafana/dskit v0.0.0-20231016230140-3866fa1df2cb
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v0.0.0-20231018162332-a889bf6ad22e
