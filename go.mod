...
require (
	...
	github.com/grafana/alerting v0.0.0-20250911133503-d54fc2df0100
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20250908132932-c2f03d6d14d2
