...
require (
	...
	github.com/grafana/alerting v0.0.0-20240528170012-79c3bdbe3f18
...
replace github.com/prometheus/alertmanager => github.com/grafana/prometheus-alertmanager v0.25.1-0.20240603083939-5121fbc59b84
