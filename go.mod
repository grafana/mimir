...
require (
	...
	github.com/grafana/dskit v0.0.0-20260505132841-f8de11864f04
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20260504033849-ef7a650fb3f3
