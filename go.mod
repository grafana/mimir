...
require (
	...
	github.com/grafana/alerting v0.0.0-20240829185616-8454ac21d7e5
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v0.0.0-20240917150110-e2d2207214b0
