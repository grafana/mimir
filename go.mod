...
require (
	...
	github.com/grafana/dskit v0.0.0-20230427024853-1e1de772476d
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v0.0.0-20230418223807-fc3fa8995a23
