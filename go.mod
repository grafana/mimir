...
require (
	...
	github.com/twmb/franz-go/pkg/kfake v0.0.0-20240721000510-c5c735757b6b
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v0.0.0-20240724081032-8edbe15e04b1
