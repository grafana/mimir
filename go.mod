...
require (
	...
	github.com/grafana/dskit v0.0.0-20260821204132-06829887f955
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20260828055509-688a512d36e9
