...
require (
	...
	github.com/grafana/warpstream-go v0.2.0
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20260917121724-294731b01c33
