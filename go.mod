...
require (
	...
	github.com/thanos-community/promql-engine v0.0.0-20230302205437-4b302059e882
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v0.0.0-20230313074516-1b8dfd8b83f5
