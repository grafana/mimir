...
// TODO: update version when mimir-prometheus PR is merged
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20251008175648-4fad8469be50
