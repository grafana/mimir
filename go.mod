...
require (
	...
	github.com/prometheus/alertmanager v0.24.1-0.20220930115155-545529639209
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v0.0.0-20220909203510-0fc083242789
