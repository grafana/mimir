...
require (
	...
	github.com/grafana/dskit v0.0.0-20231108194149-6165201f1cfd
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v0.0.0-20231031225653-00f101a4fb0d
