...
require (
	...
	github.com/grafana/dskit v0.0.0-20211011075556-a9ba3a81d4a2
...
replace github.com/prometheus/prometheus => github.com/grafana/prometheus-private v0.0.0-20211007131609-50c1060328fa
