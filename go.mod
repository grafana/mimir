...
require (
	...
	github.com/grafana/dskit v0.0.0-20250321191649-22a660c74157
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20250327142729-bf5711f44eb5
