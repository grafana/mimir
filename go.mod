...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v0.0.0-20250320233455-d775645157f9
...
// Pin gRPC to v1.66 as we're slowly upgrading to the latest available version.
