...
require (
	...
	github.com/prometheus-community/parquet-common v0.0.0-20250612090827-2b68cd3ab6ca
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20250623074142-d4f9840f8e38
