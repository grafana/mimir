...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/prometheusremotewrite v0.0.0-20220128193601-10cfdaac1387
...
require (
	...
	go.opentelemetry.io/collector v0.43.1 // indirect
