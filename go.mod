...
require (
	...
	github.com/grafana/alerting v0.0.0-20250729175202-b4b881b7b263
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20250729140020-bcb357089a30
