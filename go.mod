...
require (
	...
	github.com/grafana/warpstream-go v0.0.0-20260624113718-031c593a2417
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20260624141652-472af4a70b0a
