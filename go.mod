...
require (
	...
	github.com/prometheus/common v0.65.1-0.20250728084850-6caa6ccca8f6
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20250728085455-ec3c6b7b626a
