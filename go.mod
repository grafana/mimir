...
require (
	...
	github.com/grafana/dskit v0.0.0-20250606102959-80007d5fb850
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20250616154151-f30db23b1e0c
