...
require (
	...
	github.com/grafana/alerting v0.0.0-20260223215711-4271d73d344a
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20260220070428-95607198cbca
