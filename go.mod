...
require (
	...
	github.com/grafana/dskit v0.0.0-20260410133035-18c15d1f04be
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20260413114145-d77cfd48694a
