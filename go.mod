...
require (
	...
	github.com/grafana/dskit v0.0.0-20260417094613-712b80713189
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20260812165702-847d1e06c085
