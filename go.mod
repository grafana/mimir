...
require (
	...
	github.com/grafana/alerting v0.0.0-20240812131556-611a23ff0f7f
...
replace github.com/prometheus/alertmanager => github.com/grafana/prometheus-alertmanager v0.25.1-0.20240830135110-ca3d9add3996
