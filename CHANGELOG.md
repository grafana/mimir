...
* [FEATURE] Ingester: Experimental support for ignoring context cancellation when querying chunks. Enable with `-ingester.chunks-query-ignore-cancellation`. #6408
