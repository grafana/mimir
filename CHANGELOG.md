...
* [FEATURE] Ingester: add experimental support for creating tokens by using ring.SpreadMinimizingTokenGenerator. This can be enabled with `-ingester.ring.token-generation-strategy: spread-minimizing` and `-ingester.ring.spread-minimizing-zones: <all available zones>`. #5308
