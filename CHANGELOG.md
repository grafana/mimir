...
* [FEATURE] Query-frontend: Introduce experimental `-query-frontend.max-series-per-shard` to allow query sharding to take into account cardinality of similar requests executed previously. #4121
