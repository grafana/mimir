...
* [CHANGE] Store-gateway: the `cortex_bucket_store_series_blocks_queried` metric is now a histogram instead of a summary, so it exposes the per-request distribution of queried blocks. #15646
