...
* [CHANGE] Ruler: `-ruler.alertmanager-discovery` flag has been removed. To keep backward compatibility URLs where the host part adheres to [RFC2782](https://datatracker.ietf.org/doc/html/rfc2782) will be used as URL for SRV service discovery. #993
