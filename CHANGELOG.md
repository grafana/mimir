...
* [ENHANCEMENT] Query-frontend: The `/prometheus/api/v1/read` requests are send to the querier from the middleware chain, improving the middleware support and executing the queries concurrently. #16525
