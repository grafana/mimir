...
* [ENHANCEMENT] Store-gateway, Ingester: Add read support for Prometheus HistogramST and FloatHistogramST chunk encodings. These encodings preserve per-sample start timestamps for native histograms. #16202
