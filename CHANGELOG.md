...
* [ENHANCEMENT] Query Frontend: Optimize the case where the `-query-frontend.instant-queries-with-subquery-spin-off` flag is set to `.*`. In that case, the feature is enabled for all queries. #11038
