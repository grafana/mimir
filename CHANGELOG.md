...
* [ENHANCEMENT] Distributor: vendor update OpenTelemetry translator for exponential to Prometheus native histograms to implement downscale of exponential histograms that are over the native histogram scale limit of 8. #5532
