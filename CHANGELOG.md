...
* [FEATURE] Ruler: added experimental config `-ruler.rule-evaluation-write-enabled` to disable writing the result of rule evaluation to ingesters. This feature can be used for testing purposes. #9060
