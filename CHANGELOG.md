...
* [ENHANCEMENT] Add extra KEDA ScaledObject trigger to prevent from down-scaling during OOM kills, if memory trigger is disabled and $._config.autoscaling_oom_protection_enabled is true. #13509
