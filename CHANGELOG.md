...
* [BUGFIX] MQE: Fix instant queries with a top-level subquery that removes the metric name (e.g. `(rate(foo[5m]))[1h:5m]`) failing with an error when delayed name removal is enabled. #16666
