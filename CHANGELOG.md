...
* [ENHANCEMENT] Query-frontend: Wait for in-flight queries to finish before shutting down. Only applicable when the query-frontend is used with the query scheduler. #4073
