...
* [CHANGE] MQE: The experimental results cache (`-query-frontend.use-mimir-query-engine-for-splitting-and-caching-results`) removes duplicate tenant IDs from the cache keys. Existing cached entries are ignored after upgrading. #15847
