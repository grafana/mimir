...
* [CHANGE] Alertmanager: UTF-8 strict mode (`-alertmanager.utf8-strict-mode-enabled`) now defaults to `true` and is deprecated. It will be removed in Mimir 3.3. #13109
