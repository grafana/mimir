...
* [ENHANCEMENT] Query-frontend: emit `frontend_query_payload_codec_duration_seconds` and `frontend_query_payload_codec_payload_bytes` metrics to measure the time taken and bytes read / written while encoding and decoding query result payloads. #4110
