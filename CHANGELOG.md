...
* [ENHANCEMENT] Distributor, Ingester, Querier: Replace the gogoproto protobuf code generator with wiresmith for Mimir's own protobuf messages, making marshalling faster and reducing allocations on the write and query paths. The wire format and public APIs are unchanged. #15632
