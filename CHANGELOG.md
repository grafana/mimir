...
* [FEATURE] Compactor: Add the experimental `-compactor.scheduler-client.disable-ring-based-cleanup` option to stop a scheduler-mode compactor from running the ring-based background blocks cleaner. #16457
