...
* [CHANGE] Query-frontend: the `topic` label of the `cortex_ingest_storage_reader_last_produced_offset_*` metrics now reports `topic="mixed"` for the batched last-produced-offset fetch used to enforce strong read consistency, instead of the actual topic name. #15770
