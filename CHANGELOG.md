...
* [ENHANCEMENT] Ruler: Add `cortex_prometheus_notifications_errors_sum` and `cortex_prometheus_notifications_sent_sum` metrics to enable low-cardinality SLO alerting. #13271
