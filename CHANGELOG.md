...
* [FEATURE] Store-gateway: Added `/store-gateway/users` and `/store-gateway/user/{user}/blocks` endpoints that provide functionality that was provided by `tools/listblocks`. #911
