...
* [CHANGE] Querier / Query-frontend: Remove maximum `limit` value in `GET,POST <prometheus-http-prefix>/api/v1/cardinality/label_names` and `GET,POST <prometheus-http-prefix>/api/v1/cardinality/label_values` HTTP endpoints. #11025
