...
* [ENHANCEMENT] Distributor: target 90% of requested CPU usage when autoscaling by default instead of 100%. This can be adjusted with `_config.autoscaling_distributor_cpu_target_utilization`. #5525
