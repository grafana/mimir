...
* [ENHANCEMENT] Added an in-memory cache for regular expression matchers, to avoid parsing the compiling the same expression multiple times when used in recurring queries. #4633
