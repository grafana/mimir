...
* [CHANGE] Rollout-operator: Support for zone and partition aware pod disruption budgets, enabling finer control over pod eviction policies. #12315. Refer to [rollout-operator#253](https://github.com/grafana/rollout-operator/pull/253).
