...
* [ENHANCEMENT] Querier: track physical and equivalent samples read for remote read requests in query statistics, functionally enabling query metering for remote read. #15694
