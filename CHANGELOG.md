...
* [FEATURE] Query-scheduler: Add `cortex_query_scheduler_oldest_inflight_request_duration_seconds` metric reporting how long the oldest inflight request has been waiting since it was enqueued. Reports NaN when no requests are inflight. #15419
