...
* [ENHANCEMENT] MQE: Add metrics for tracking in-flight memory consumption tracking. `cortex_querier_inflight_query_max_estimated_memory_consumption_limit_bytes`, `cortex_querier_inflight_query_current_estimated_memory_consumption_limit_bytes`, `cortex_querier_inflight_query_peak_estimated_memory_consumption_limit_bytes` and `cortex_querier_inflight_query_sampled_count`. #14807
