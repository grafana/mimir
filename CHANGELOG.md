...
* [FEATURE] Continuous test: Add `prometheus2` option `-tests.write-protocol` flag to select Prometheus Remote-Write 2.0 as protocol. #13659
* [FEATURE] Continuous test: Write metrics metadata along with samples. #13659
