...
* [CHANGE] Distributor: Previously incoming OTLP requests were size-limited by using limit from `-distributor.max-recv-msg-size` option. We have added option `-distributor.max-otlp-request-size` for OTLP request, which defaults to 100 MiB. #8574 
