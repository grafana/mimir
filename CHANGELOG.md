...
* [FEATURE] Ingester: Shipper has now`out_of_order_blocks_external_label_enabled` option to label out-of-order blocks before shipping them to cloud storage. #4182
