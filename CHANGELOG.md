...
* [FEATURE] Ingest storage: Add `-ingest-storage.kafka.producer-compression-type` flag to configure the compression algorithm used by the Kafka producer. Supported values: `snappy` (default), `none`, `gzip`, `lz4`, `zstd`. #14454
