...
* [BUGFIX] Store-gateway: Fix toRawPostingGroup incorrectly using an intersecting posting group for MatchRegexp matchers with empty-string alternatives, causing series with absent labels to be silently dropped from query results. #15767
