...
* [CHANGE] Removed `$._config.querier.replicas` and `$._config.queryFrontend.replicas`. If you need to customize the number of querier and query-frontend replicas, and autoscaling is disabled, please set an override like you're used to do for other stateless components (e.g. distributors). #5130
