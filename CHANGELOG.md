...
* [CHANGE] Ruler: upon shutdown leave the ring first before stopping rule evaluations. This reduces the time it takes for other rulers to start evaluating the rule groups of the leaving ruler. The tradeoff is that this increases the risk of duplicate evaluation of rule groups by multiple rulers. #5781
