...
* [ENHANCEMENT] Query-frontend: track `cortex_frontend_query_payload_codec_duration_seconds` and `cortex_frontend_query_payload_codec_payload_bytes` metrics to measure the time taken and bytes read / written while encoding and decoding query result payloads. #4110
