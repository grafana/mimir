...
* [ENHANCEMENT] Query-frontend: Allow users to use `query-frontend.extra-propagate-headers` flag to configure the extra headers to be allowed to pass through. #12174
