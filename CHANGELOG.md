...
* [ENHANCEMENT] Ingester: Limiting on owned series (`-ingester.use-ingester-owned-series-for-limits`) now prevents discards in cases where shuffle sharding is disabled and the ingester count increases. #7411
