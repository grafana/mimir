...
* [ENHANCEMENT] Server: Add `-server.http-log-closed-connections-without-response-enabled` option to log HTTP requests that were closed before any data was sent back. This can happen if client doesn't manage to send complete HTTP headers before timeout.
