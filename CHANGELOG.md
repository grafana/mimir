...
* [FEATURE] Querier: Make the max series limit for cardinality API requests configurable on a per-tenant basis with the `cardinality_api_max_series_limit` option. #11456
