...
* [CHANGE] The endpoints `<prometheus-http-prefix>/api/v1/status/buildinfo` and `<alertmanager-http-prefix>/api/v1/status/buildinfo` have been added to display build information and enabled features. #1219
