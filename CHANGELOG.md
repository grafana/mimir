...
* [BUGFIX] Cost attribution: Replace `prometheus.MustNewConstMetric` with `prometheus.NewConstMetric` to prevent panics when creating metrics with invalid labels. #13174
