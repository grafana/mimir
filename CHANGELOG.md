...
* [FEATURE] Query-frontend and querier: Add experimental support for performing query planning in query-frontends and distributing portions of the plan to queriers for execution. #12302 #12551 #12665 #12687 #12745 #12757 #12798 #12808 #12809 #12835 #12856 #12870 #12883 #12885 #12886 #12911 #12933 #12934 #12961
...
* [ENHANCEMENT] Memcached: added the following config fields to allow to customise the node affinity matchers: #12987
  * `$._config.memcached_frontend_node_affinity_matchers`
  * `$._config.memcached_index_queries_node_affinity_matchers`
  * `$._config.memcached_chunks_node_affinity_matchers`
  * `$._config.memcached_metadata_node_affinity_matchers`
