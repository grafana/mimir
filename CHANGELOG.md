...
* [BUGFIX] Ruler, Query-frontend: Close `promql.Query` after every successful evaluation to prevent leaking one MQE in-flight memory consumption tracker per evaluation. #15393
