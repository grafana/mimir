...
* [ENHANCEMENT] Usage-tracker: Add admin debug pages, linked from the admin index, that list the partitions owned by an instance and, per partition, show per-(tenant, shard) tracker-store stats (resident and dead elements, limit, index length, and rehashes). #15876
