...
* [FEATURE] Querier: experimental NDJSON-streaming label/value search HTTP endpoints `/api/v1/search/{metric_names,label_names,label_values}` mirroring the [Prometheus search API](https://github.com/prometheus/prometheus/pull/18573). Gated by `-querier.experimental-search-api-enabled` (default false). #15349
