...
* [ENHANCEMENT] Query-scheduler: Remove the experimental `query-scheduler.prioritize-query-components` flag. Request queues will always prioritize query component dequeuing above tenant fairness. #9703
