...
* [CHANGE] Ingester: Add  `user` label to `cortex_ingester_tsdb_head_min_timestamp_seconds` and `cortex_ingester_tsdb_head_max_timestamp_seconds` metrics, which return minimum and maximum times of TSDB Heads open in an ingester. #11945
