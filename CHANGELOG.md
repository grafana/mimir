...
* [ENHANCEMENT] Querier and ingester: add experimental support for streaming chunks from ingesters to queriers while evaluating queries enabled with `-querier.prefer-streaming-chunks=true`. #4886
