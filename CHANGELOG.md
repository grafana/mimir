...
* [CHANGE] Ingest storage: Removed the `node_id` label from broker-level Kafka client metrics (e.g. `cortex_ingest_storage_writer_kafka_connects_total`, `cortex_ingest_storage_reader_kafka_read_bytes_total`) to reduce cardinality. #15194
