  ...
  [filename]:
    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.queryPanel('sum by (%s) (cortex_bucket_store_blocks_loaded{component="store-gateway",%s})' % [$._config.per_instance_label, $.jobMatcher($._config.job_names.store_gateway)], '{{%s}}' % $._config.per_instance_label) +
