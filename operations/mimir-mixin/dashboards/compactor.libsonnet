  ...
  [filename]:
    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.latencyPanelNativeHistogram('cortex_compactor_block_max_time_delta_seconds', $.jobMatcher($._config.job_names.compactor)) +
        $.panelDescription(
          'Source blocks age',
          |||
      ...
      .addPanel(
        ...
        $.latencyPanelNativeHistogram('prometheus_tsdb_compaction_duration_seconds', $.jobMatcher($._config.job_names.compactor)) +
        $.panelDescription(
    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.latencyPanelNativeHistogram('cortex_compactor_meta_sync_duration_seconds', $.jobMatcher($._config.job_names.compactor)),
      )
    )
