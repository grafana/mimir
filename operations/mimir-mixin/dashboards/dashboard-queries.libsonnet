...

{
  ...
  queries:: {
    ...
    local variables = {
      ...
      gatewayMatcher: $.jobContainerMatchers($._config.job_names.gateway, $._config.container_names.gateway),
      distributorMatcher: $.jobContainerMatchers($._config.job_names.distributor, $._config.container_names.distributor),
      ingesterMatcher: $.jobContainerMatchers($._config.job_names.ingester, $._config.container_names.ingester),
      queryFrontendMatcher: $.jobContainerMatchers($._config.job_names.query_frontend, $._config.container_names.query_frontend),
      rulerMatcher: $.jobContainerMatchers($._config.job_names.ruler, $._config.container_names.ruler),
      alertmanagerMatcher: $.jobContainerMatchers($._config.job_names.alertmanager, $._config.container_names.alertmanager),
      namespaceMatcher: $.namespaceMatcher(),
      storeGatewayMatcher: $.jobContainerMatchers($._config.job_names.store_gateway, $._config.container_names.store_gateway),
      rulerQueryFrontendMatcher: $.jobContainerMatchers($._config.job_names.ruler_query_frontend, $._config.container_names.ruler_query_frontend),
