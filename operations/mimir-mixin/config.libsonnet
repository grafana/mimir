{
  ...
  _config+:: {
    ...
    job_names: {
      ...
      ruler: '(ruler|cortex|mimir|mimir-read)',
      ...
      query_scheduler: 'query-scheduler.*|mimir-read',  // Not part of single-binary. Match also custom query-scheduler deployments.
      ...
      store_gateway: '(store-gateway.*|cortex|mimir|mimir-store)',  // Match also per-zone store-gateway deployments.
      gateway: '(gateway|cortex-gw|cortex-gw-internal)',
      compactor: 'compactor.*|cortex|mimir|mimir-store',  // Match also custom compactor deployments.
