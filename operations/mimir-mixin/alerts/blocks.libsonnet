(import 'alerts-utils.libsonnet') {
  // Adds a "zone" label parsed from the job name, absent for non-zonal deployments. The WAL corruption
  // alerts count zones this way rather than counting jobs: with compartments a zone has several jobs.
