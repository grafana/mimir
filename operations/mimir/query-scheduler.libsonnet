...
// are reconfigured to use query-scheduler service.
{
  ...
  query_scheduler_deployment: if $._config.deployment_mode != 'microservices' || !$._config.query_scheduler_enabled then {} else
    self.newQuerySchedulerDeployment('query-scheduler', $.query_scheduler_container),

  query_scheduler_service: if $._config.deployment_mode != 'microservices' || !$._config.query_scheduler_enabled then {} else
  ...
  query_scheduler_discovery_service: if $._config.deployment_mode != 'microservices' || !$._config.query_scheduler_enabled then {} else
