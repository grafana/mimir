{
  ...
  query_frontend_deployment: if $._config.deployment_mode != 'microservices' then null else
    self.newQueryFrontendDeployment('query-frontend', $.query_frontend_container),

  query_frontend_service: if $._config.deployment_mode != 'microservices' then null else
    $.util.serviceFor($.query_frontend_deployment, $._config.service_ignored_labels),

  query_frontend_discovery_service: if $._config.deployment_mode != 'microservices' then null else
