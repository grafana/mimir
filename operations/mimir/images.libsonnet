{
  _images+:: {
    ...
    // Our services.
<<<<<<< HEAD
    mimir: 'grafana/mimir:3.0.1',
=======
    mimir: 'grafana/mimir:2.17.4',
>>>>>>> origin/release-2.17
...
<<<<<<< HEAD
    query_tee: 'grafana/query-tee:3.0.1',
    continuous_test: self.mimir,
=======
    query_tee: 'grafana/query-tee:2.17.4',
    continuous_test: 'grafana/mimir-continuous-test:2.17.4',
