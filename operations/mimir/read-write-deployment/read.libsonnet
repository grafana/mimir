{
  ...
  mimir_read_container:: if $._config.deployment_mode != 'read-write' then null else
  ...
  mimir_read_deployment: if $._config.deployment_mode != 'read-write' then null else
  ...
  mimir_read_service: if $._config.deployment_mode != 'read-write' then null else
