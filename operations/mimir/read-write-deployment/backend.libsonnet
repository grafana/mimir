{
  ...
  mimir_backend_zone_a_container:: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirBackendZoneContainer('a', $.mimir_backend_zone_a_args),

  mimir_backend_zone_b_container:: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirBackendZoneContainer('b', $.mimir_backend_zone_b_args),

  mimir_backend_zone_c_container:: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirBackendZoneContainer('c', $.mimir_backend_zone_c_args),

  mimir_backend_zone_a_statefulset: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirBackendZoneStatefulset('a', $.mimir_backend_zone_a_container),

  mimir_backend_zone_b_statefulset: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirBackendZoneStatefulset('b', $.mimir_backend_zone_b_container),

  mimir_backend_zone_c_statefulset: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirBackendZoneStatefulset('c', $.mimir_backend_zone_c_container),

  mimir_backend_zone_a_service: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirBackendZoneService($.mimir_backend_zone_a_statefulset),

  mimir_backend_zone_b_service: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirBackendZoneService($.mimir_backend_zone_b_statefulset),

  mimir_backend_zone_c_service: if $._config.deployment_mode != 'read-write' then null else
  ...
  mimir_backend_service: if $._config.deployment_mode != 'read-write' then null else
  ...
  mimir_backend_rollout_pdb: if $._config.deployment_mode != 'read-write' then null else
