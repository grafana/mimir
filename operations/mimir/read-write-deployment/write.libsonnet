{
  ...
  mimir_write_zone_a_container:: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirWriteZoneContainer('a', $.mimir_write_zone_a_args),

  mimir_write_zone_b_container:: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirWriteZoneContainer('b', $.mimir_write_zone_b_args),

  mimir_write_zone_c_container:: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirWriteZoneContainer('c', $.mimir_write_zone_c_args),

  mimir_write_zone_a_statefulset: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirWriteZoneStatefulset('a', $.mimir_write_zone_a_container),

  mimir_write_zone_b_statefulset: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirWriteZoneStatefulset('b', $.mimir_write_zone_b_container),

  mimir_write_zone_c_statefulset: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirWriteZoneStatefulset('c', $.mimir_write_zone_c_container),

  mimir_write_zone_a_service: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirWriteZoneService($.mimir_write_zone_a_statefulset),

  mimir_write_zone_b_service: if $._config.deployment_mode != 'read-write' then null else
    $.newMimirWriteZoneService($.mimir_write_zone_b_statefulset),

  mimir_write_zone_c_service: if $._config.deployment_mode != 'read-write' then null else
  ...
  mimir_write_service: if $._config.deployment_mode != 'read-write' then null else
  ...
  mimir_write_rollout_pdb: if $._config.deployment_mode != 'read-write' then null else
