{
  ...
  _config+:: {
    ...
    overridesExporterRingConfig+: if !$._config.memberlist_ring_enabled then {} else (setupGossipRing('overrides-exporter.ring.store', 'overrides-exporter.ring.consul.hostname', 'overrides-exporter.ring.multi') + $._config.memberlistConfig),
