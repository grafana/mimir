{
  ...
  distributor_deployment: if $._config.deployment_mode != 'microservices' then null else
  ...
  distributor_service: if $._config.deployment_mode != 'microservices' then null else
