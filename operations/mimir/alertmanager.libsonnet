{
  ...
  alertmanager_statefulset:
    if $._config.deployment_mode == 'microservices' && $._config.alertmanager_enabled then
  ...
  alertmanager_pdb: if $._config.deployment_mode != 'microservices' || !$._config.alertmanager_enabled then null else
