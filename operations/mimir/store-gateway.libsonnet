{
  ...
  store_gateway_statefulset: if $._config.deployment_mode != 'microservices' then null else
  ...
  store_gateway_service: if $._config.deployment_mode != 'microservices' then null else
    $.util.serviceFor($.store_gateway_statefulset, $._config.service_ignored_labels),

  store_gateway_pdb: if $._config.deployment_mode != 'microservices' then null else
