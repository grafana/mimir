...
> **Note:** The documentation version is derived from the Helm chart version which is 5.2.0-weekly.274.
...
![Version: 5.2.0-weekly.274](https://img.shields.io/badge/Version-5.2.0--weekly.274-informational?style=flat-square) ![AppVersion: r274](https://img.shields.io/badge/AppVersion-r274-informational?style=flat-square)
