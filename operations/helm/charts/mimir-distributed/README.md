...
> **Note:** The documentation version is derived from the Helm chart version which is 4.5.0-weekly.246.
...
![Version: 4.5.0-weekly.246](https://img.shields.io/badge/Version-4.5.0--weekly.246-informational?style=flat-square) ![AppVersion: r246](https://img.shields.io/badge/AppVersion-r246-informational?style=flat-square)
