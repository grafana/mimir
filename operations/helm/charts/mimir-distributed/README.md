...
> **Note:** The documentation version is derived from the Helm chart version which is 5.2.0-weekly.263.
...
![Version: 5.2.0-weekly.263](https://img.shields.io/badge/Version-5.2.0--weekly.263-informational?style=flat-square) ![AppVersion: r263](https://img.shields.io/badge/AppVersion-r263-informational?style=flat-square)
