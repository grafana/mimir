...
> **Note:** The documentation version is derived from the Helm chart version which is 5.5.0-weekly.303.
...
![Version: 5.5.0-weekly.303](https://img.shields.io/badge/Version-5.5.0--weekly.303-informational?style=flat-square) ![AppVersion: r303](https://img.shields.io/badge/AppVersion-r303-informational?style=flat-square)
