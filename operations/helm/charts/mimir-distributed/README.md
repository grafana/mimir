...
> **Note:** The documentation version is derived from the Helm chart version which is 5.4.0-weekly.294.
...
![Version: 5.4.0-weekly.294](https://img.shields.io/badge/Version-5.4.0--weekly.294-informational?style=flat-square) ![AppVersion: r294](https://img.shields.io/badge/AppVersion-r294-informational?style=flat-square)
