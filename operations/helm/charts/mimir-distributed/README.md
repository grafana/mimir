...
> **Note:** The documentation version is derived from the Helm chart version which is 5.2.0-weekly.259.
...
![Version: 5.2.0-weekly.259](https://img.shields.io/badge/Version-5.2.0--weekly.259-informational?style=flat-square) ![AppVersion: r259](https://img.shields.io/badge/AppVersion-r259-informational?style=flat-square)
...
| https://grafana.github.io/helm-charts | grafana-agent-operator(grafana-agent-operator) | 0.3.6 |
