...
> **Note:** The documentation version is derived from the Helm chart version which is 5.2.0-weekly.256.
...
![Version: 5.2.0-weekly.256](https://img.shields.io/badge/Version-5.2.0--weekly.256-informational?style=flat-square) ![AppVersion: r256](https://img.shields.io/badge/AppVersion-r256-informational?style=flat-square)
