...
> **Note:** The documentation version is derived from the Helm chart version which is 5.4.0-weekly.298.
...
![Version: 5.4.0-weekly.298](https://img.shields.io/badge/Version-5.4.0--weekly.298-informational?style=flat-square) ![AppVersion: r298](https://img.shields.io/badge/AppVersion-r298-informational?style=flat-square)
