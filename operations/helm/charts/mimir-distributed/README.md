...
> **Note:** The documentation version is derived from the Helm chart version which is 5.8.0-weekly.355.
...
![Version: 5.8.0-weekly.355](https://img.shields.io/badge/Version-5.8.0--weekly.355-informational?style=flat-square) ![AppVersion: r355](https://img.shields.io/badge/AppVersion-r355-informational?style=flat-square)
