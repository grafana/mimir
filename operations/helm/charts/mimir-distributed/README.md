...
> **Note:** The documentation version is derived from the Helm chart version which is 4.5.0-weekly.245.
...
![Version: 4.5.0-weekly.245](https://img.shields.io/badge/Version-4.5.0--weekly.245-informational?style=flat-square) ![AppVersion: r245](https://img.shields.io/badge/AppVersion-r245-informational?style=flat-square)
