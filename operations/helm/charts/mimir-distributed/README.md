...
> **Note:** The documentation version is derived from the Helm chart version which is 4.5.0-weekly.243.
...
![Version: 4.5.0-weekly.243](https://img.shields.io/badge/Version-4.5.0--weekly.243-informational?style=flat-square) ![AppVersion: r243](https://img.shields.io/badge/AppVersion-r243-informational?style=flat-square)
