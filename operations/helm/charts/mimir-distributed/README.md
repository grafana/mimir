...
> **Note:** The documentation version is derived from the Helm chart version which is 6.3.0-weekly.411.
...
![Version: 6.3.0-weekly.411](https://img.shields.io/badge/Version-6.3.0--weekly.411-informational?style=flat-square) ![AppVersion: r411-a5b92939](https://img.shields.io/badge/AppVersion-r411--a5b92939-informational?style=flat-square)
...
| https://grafana.github.io/helm-charts | rollout_operator(rollout-operator) | 0.52.0 |
