...
> **Note:** The documentation version is derived from the Helm chart version which is 5.8.0-weekly.348.
...
![Version: 5.8.0-weekly.348](https://img.shields.io/badge/Version-5.8.0--weekly.348-informational?style=flat-square) ![AppVersion: r348](https://img.shields.io/badge/AppVersion-r348-informational?style=flat-square)
