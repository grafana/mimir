...
> **Note:** The documentation version is derived from the Helm chart version which is 6.1.0-weekly.399.
...
![Version: 6.1.0-weekly.399](https://img.shields.io/badge/Version-6.1.0--weekly.399-informational?style=flat-square) ![AppVersion: r399-2ef9a3d4](https://img.shields.io/badge/AppVersion-r399--2ef9a3d4-informational?style=flat-square)
