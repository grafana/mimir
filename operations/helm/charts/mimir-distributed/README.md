...
> **Note:** The documentation version is derived from the Helm chart version which is 5.2.0-weekly.265.
...
![Version: 5.2.0-weekly.265](https://img.shields.io/badge/Version-5.2.0--weekly.265-informational?style=flat-square) ![AppVersion: r265](https://img.shields.io/badge/AppVersion-r265-informational?style=flat-square)
