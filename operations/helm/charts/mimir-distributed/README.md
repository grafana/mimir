...
> **Note:** The documentation version is derived from the Helm chart version which is 5.8.0-weekly.335.
...
![Version: 5.8.0-weekly.335](https://img.shields.io/badge/Version-5.8.0--weekly.335-informational?style=flat-square) ![AppVersion: r335](https://img.shields.io/badge/AppVersion-r335-informational?style=flat-square)
