...
> **Note:** The documentation version is derived from the Helm chart version which is 6.2.0-rc.0.
...
![Version: 6.2.0-rc.0](https://img.shields.io/badge/Version-6.2.0--rc.0-informational?style=flat-square) ![AppVersion: 3.2.0-rc.0](https://img.shields.io/badge/AppVersion-3.2.0--rc.0-informational?style=flat-square)
