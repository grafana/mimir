...
> **Note:** The documentation version is derived from the Helm chart version which is 5.8.0-weekly.354.
...
![Version: 5.8.0-weekly.354](https://img.shields.io/badge/Version-5.8.0--weekly.354-informational?style=flat-square) ![AppVersion: r354](https://img.shields.io/badge/AppVersion-r354-informational?style=flat-square)
