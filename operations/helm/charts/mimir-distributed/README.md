...
> **Note:** The documentation version is derived from the Helm chart version which is 5.2.0-weekly.260.
...
![Version: 5.2.0-weekly.260](https://img.shields.io/badge/Version-5.2.0--weekly.260-informational?style=flat-square) ![AppVersion: r260](https://img.shields.io/badge/AppVersion-r260-informational?style=flat-square)
