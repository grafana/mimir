...
> **Note:** The documentation version is derived from the Helm chart version which is 5.4.0-weekly.295.
...
![Version: 5.4.0-weekly.295](https://img.shields.io/badge/Version-5.4.0--weekly.295-informational?style=flat-square) ![AppVersion: r295](https://img.shields.io/badge/AppVersion-r295-informational?style=flat-square)
