...
> **Note:** The documentation version is derived from the Helm chart version which is 4.5.0-weekly.244.
...
![Version: 4.5.0-weekly.244](https://img.shields.io/badge/Version-4.5.0--weekly.244-informational?style=flat-square) ![AppVersion: r244](https://img.shields.io/badge/AppVersion-r244-informational?style=flat-square)
