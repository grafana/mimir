...
> **Note:** The documentation version is derived from the Helm chart version which is 5.1.0-weekly.247.
...
![Version: 5.1.0-weekly.247](https://img.shields.io/badge/Version-5.1.0--weekly.247-informational?style=flat-square) ![AppVersion: r247](https://img.shields.io/badge/AppVersion-r247-informational?style=flat-square)
