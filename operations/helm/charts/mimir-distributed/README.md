...
> **Note:** The documentation version is derived from the Helm chart version which is 6.1.0-weekly.394.
...
![Version: 6.1.0-weekly.394](https://img.shields.io/badge/Version-6.1.0--weekly.394-informational?style=flat-square) ![AppVersion: r394-d0bc9480](https://img.shields.io/badge/AppVersion-r394--d0bc9480-informational?style=flat-square)
...
| https://grafana.github.io/helm-charts | rollout_operator(rollout-operator) | 0.48.0 |
