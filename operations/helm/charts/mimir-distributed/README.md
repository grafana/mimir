...
**IMPORTANT**: Always consult the Deprecated features section in [CHANGELOG.md](./CHANGELOG.md#deprecated-features) file to learn about breaking changes that require action during upgrade.
