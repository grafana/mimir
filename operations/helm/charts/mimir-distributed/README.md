...
> **Note:** The documentation version is derived from the Helm chart version which is 5.2.0-weekly.270.
...
![Version: 5.2.0-weekly.270](https://img.shields.io/badge/Version-5.2.0--weekly.270-informational?style=flat-square) ![AppVersion: r270](https://img.shields.io/badge/AppVersion-r270-informational?style=flat-square)
