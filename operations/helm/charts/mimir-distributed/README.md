...
> **Note:** The documentation version is derived from the Helm chart version which is 6.1.0-weekly.398.
...
![Version: 6.1.0-weekly.398](https://img.shields.io/badge/Version-6.1.0--weekly.398-informational?style=flat-square) ![AppVersion: r398-fa878573](https://img.shields.io/badge/AppVersion-r398--fa878573-informational?style=flat-square)
...
| https://grafana.github.io/helm-charts | rollout_operator(rollout-operator) | 0.50.0 |
