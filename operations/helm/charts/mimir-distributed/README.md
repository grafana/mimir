...
> **Note:** The documentation version is derived from the Helm chart version which is 5.8.0-weekly.338.
...
![Version: 5.8.0-weekly.338](https://img.shields.io/badge/Version-5.8.0--weekly.338-informational?style=flat-square) ![AppVersion: r338](https://img.shields.io/badge/AppVersion-r338-informational?style=flat-square)
