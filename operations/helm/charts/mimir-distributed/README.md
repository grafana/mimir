...
> **Note:** The documentation version is derived from the Helm chart version which is 5.1.0-weekly.253.
...
![Version: 5.1.0-weekly.253](https://img.shields.io/badge/Version-5.1.0--weekly.253-informational?style=flat-square) ![AppVersion: r253](https://img.shields.io/badge/AppVersion-r253-informational?style=flat-square)
