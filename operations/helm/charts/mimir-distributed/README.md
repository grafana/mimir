...
> **Note:** The documentation version is derived from the Helm chart version which is 5.2.0-weekly.267.
...
![Version: 5.2.0-weekly.267](https://img.shields.io/badge/Version-5.2.0--weekly.267-informational?style=flat-square) ![AppVersion: r267](https://img.shields.io/badge/AppVersion-r267-informational?style=flat-square)
