...
Helm chart for deploying [Grafana Mimir](https://grafana.com/docs/mimir/latest/) to Kubernetes.
...
> **Note:** The documentation version is derived from the Helm chart version which is 5.9.0-weekly.364.
...
![Version: 5.9.0-weekly.364](https://img.shields.io/badge/Version-5.9.0--weekly.364-informational?style=flat-square) ![AppVersion: r364](https://img.shields.io/badge/AppVersion-r364-informational?style=flat-square)
