...
> **Note:** The documentation version is derived from the Helm chart version which is 5.5.0-weekly.304.
...
![Version: 5.5.0-weekly.304](https://img.shields.io/badge/Version-5.5.0--weekly.304-informational?style=flat-square) ![AppVersion: r304](https://img.shields.io/badge/AppVersion-r304-informational?style=flat-square)
