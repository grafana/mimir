...
> **Note:** The documentation version is derived from the Helm chart version which is 5.3.0-weekly.285.
...
![Version: 5.3.0-weekly.285](https://img.shields.io/badge/Version-5.3.0--weekly.285-informational?style=flat-square) ![AppVersion: r285](https://img.shields.io/badge/AppVersion-r285-informational?style=flat-square)
