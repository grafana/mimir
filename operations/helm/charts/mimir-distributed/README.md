...
> **Note:** The documentation version is derived from the Helm chart version which is 5.8.0-weekly.336.
...
![Version: 5.8.0-weekly.336](https://img.shields.io/badge/Version-5.8.0--weekly.336-informational?style=flat-square) ![AppVersion: r336](https://img.shields.io/badge/AppVersion-r336-informational?style=flat-square)
