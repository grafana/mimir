...
> **Note:** The documentation version is derived from the Helm chart version which is 6.1.0-weekly.375.
...
![Version: 6.1.0-weekly.375](https://img.shields.io/badge/Version-6.1.0--weekly.375-informational?style=flat-square) ![AppVersion: r375-d35f77d6](https://img.shields.io/badge/AppVersion-r375--d35f77d6-informational?style=flat-square)
