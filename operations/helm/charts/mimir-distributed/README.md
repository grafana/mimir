...
> **Note:** The documentation version is derived from the Helm chart version which is 5.8.0-weekly.347.
...
![Version: 5.8.0-weekly.347](https://img.shields.io/badge/Version-5.8.0--weekly.347-informational?style=flat-square) ![AppVersion: r347](https://img.shields.io/badge/AppVersion-r347-informational?style=flat-square)
