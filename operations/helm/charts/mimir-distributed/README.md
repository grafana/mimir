...
> **Note:** The documentation version is derived from the Helm chart version which is 5.9.0-weekly.363.
...
![Version: 5.9.0-weekly.363](https://img.shields.io/badge/Version-5.9.0--weekly.363-informational?style=flat-square) ![AppVersion: r363](https://img.shields.io/badge/AppVersion-r363-informational?style=flat-square)
