...
> **Note:** The documentation version is derived from the Helm chart version which is 5.8.0-weekly.346.
...
![Version: 5.8.0-weekly.346](https://img.shields.io/badge/Version-5.8.0--weekly.346-informational?style=flat-square) ![AppVersion: r346](https://img.shields.io/badge/AppVersion-r346-informational?style=flat-square)
