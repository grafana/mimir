...
> **Note:** The documentation version is derived from the Helm chart version which is 5.8.0-weekly.339.
...
![Version: 5.8.0-weekly.339](https://img.shields.io/badge/Version-5.8.0--weekly.339-informational?style=flat-square) ![AppVersion: r339](https://img.shields.io/badge/AppVersion-r339-informational?style=flat-square)
