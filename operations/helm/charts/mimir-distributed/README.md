...
> **Note:** The documentation version is derived from the Helm chart version which is 5.2.0-weekly.261.
...
![Version: 5.2.0-weekly.261](https://img.shields.io/badge/Version-5.2.0--weekly.261-informational?style=flat-square) ![AppVersion: r261](https://img.shields.io/badge/AppVersion-r261-informational?style=flat-square)
