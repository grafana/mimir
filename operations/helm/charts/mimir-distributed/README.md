...
> **Note:** The documentation version is derived from the Helm chart version which is 6.1.0-weekly.366.
...
![Version: 6.1.0-weekly.366](https://img.shields.io/badge/Version-6.1.0--weekly.366-informational?style=flat-square) ![AppVersion: r366](https://img.shields.io/badge/AppVersion-r366-informational?style=flat-square)
...
| https://grafana.github.io/helm-charts | rollout_operator(rollout-operator) | 0.37.0 |
