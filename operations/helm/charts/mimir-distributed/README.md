...
> **Note:** The documentation version is derived from the Helm chart version which is 6.1.0-weekly.370.
...
![Version: 6.1.0-weekly.370](https://img.shields.io/badge/Version-6.1.0--weekly.370-informational?style=flat-square) ![AppVersion: r370](https://img.shields.io/badge/AppVersion-r370-informational?style=flat-square)
