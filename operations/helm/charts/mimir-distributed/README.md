...
> **Note:** The documentation version is derived from the Helm chart version which is 5.3.0-weekly.278.
...
![Version: 5.3.0-weekly.278](https://img.shields.io/badge/Version-5.3.0--weekly.278-informational?style=flat-square) ![AppVersion: r278](https://img.shields.io/badge/AppVersion-r278-informational?style=flat-square)
