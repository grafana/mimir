...
> **Note:** The documentation version is derived from the Helm chart version which is 5.4.0-weekly.296.
...
![Version: 5.4.0-weekly.296](https://img.shields.io/badge/Version-5.4.0--weekly.296-informational?style=flat-square) ![AppVersion: r296](https://img.shields.io/badge/AppVersion-r296-informational?style=flat-square)
