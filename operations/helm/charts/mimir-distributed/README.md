...
> **Note:** The documentation version is derived from the Helm chart version which is 5.5.0-weekly.300.
...
![Version: 5.5.0-weekly.300](https://img.shields.io/badge/Version-5.5.0--weekly.300-informational?style=flat-square) ![AppVersion: r300](https://img.shields.io/badge/AppVersion-r300-informational?style=flat-square)
