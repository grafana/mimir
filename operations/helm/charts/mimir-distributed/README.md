...
> **Note:** The documentation version is derived from the Helm chart version which is 5.9.0-weekly.365.
...
![Version: 5.9.0-weekly.365](https://img.shields.io/badge/Version-5.9.0--weekly.365-informational?style=flat-square) ![AppVersion: r365](https://img.shields.io/badge/AppVersion-r365-informational?style=flat-square)
