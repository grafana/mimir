...
> **Note:** The documentation version is derived from the Helm chart version which is 5.6.1.
...
![Version: 5.6.1](https://img.shields.io/badge/Version-5.6.1-informational?style=flat-square) ![AppVersion: 2.15.2](https://img.shields.io/badge/AppVersion-2.15.2-informational?style=flat-square)
