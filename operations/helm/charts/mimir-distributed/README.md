...
> **Note:** The documentation version is derived from the Helm chart version which is 5.3.0-weekly.282.
...
![Version: 5.3.0-weekly.282](https://img.shields.io/badge/Version-5.3.0--weekly.282-informational?style=flat-square) ![AppVersion: r282](https://img.shields.io/badge/AppVersion-r282-informational?style=flat-square)
