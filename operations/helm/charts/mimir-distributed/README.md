...
> **Note:** The documentation version is derived from the Helm chart version which is 5.4.0-weekly.293.
...
![Version: 5.4.0-weekly.293](https://img.shields.io/badge/Version-5.4.0--weekly.293-informational?style=flat-square) ![AppVersion: r293](https://img.shields.io/badge/AppVersion-r293-informational?style=flat-square)
