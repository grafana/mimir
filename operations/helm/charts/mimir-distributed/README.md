...
> **Note:** The documentation version is derived from the Helm chart version which is 5.8.0-weekly.352.
...
![Version: 5.8.0-weekly.352](https://img.shields.io/badge/Version-5.8.0--weekly.352-informational?style=flat-square) ![AppVersion: r352](https://img.shields.io/badge/AppVersion-r352-informational?style=flat-square)
