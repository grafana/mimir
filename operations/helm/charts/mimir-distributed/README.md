...
> **Note:** The documentation version is derived from the Helm chart version which is 5.5.0-weekly.299.
...
![Version: 5.5.0-weekly.299](https://img.shields.io/badge/Version-5.5.0--weekly.299-informational?style=flat-square) ![AppVersion: r299](https://img.shields.io/badge/AppVersion-r299-informational?style=flat-square)
