...
> **Note:** The documentation version is derived from the Helm chart version which is 5.3.0-weekly.283.
...
![Version: 5.3.0-weekly.283](https://img.shields.io/badge/Version-5.3.0--weekly.283-informational?style=flat-square) ![AppVersion: r283](https://img.shields.io/badge/AppVersion-r283-informational?style=flat-square)
