...
**IMPORTANT**: Always consult the Deprecated features section in the [CHANGELOG.md](./CHANGELOG.md#deprecated-features) file to learn about breaking changes that require action during upgrade.
