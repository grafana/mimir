...
> **Note:** The documentation version is derived from the Helm chart version which is 5.8.0-weekly.349.
...
![Version: 5.8.0-weekly.349](https://img.shields.io/badge/Version-5.8.0--weekly.349-informational?style=flat-square) ![AppVersion: r349](https://img.shields.io/badge/AppVersion-r349-informational?style=flat-square)
