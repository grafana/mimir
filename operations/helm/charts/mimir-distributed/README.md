...
> **Note:** The documentation version is derived from the Helm chart version which is 5.7.0-weekly.325.
...
![Version: 5.7.0-weekly.325](https://img.shields.io/badge/Version-5.7.0--weekly.325-informational?style=flat-square) ![AppVersion: r325](https://img.shields.io/badge/AppVersion-r325-informational?style=flat-square)
