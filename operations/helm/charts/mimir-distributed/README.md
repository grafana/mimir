...
> **Note:** The documentation version is derived from the Helm chart version which is 5.5.0-weekly.305.
...
![Version: 5.5.0-weekly.305](https://img.shields.io/badge/Version-5.5.0--weekly.305-informational?style=flat-square) ![AppVersion: r305](https://img.shields.io/badge/AppVersion-r305-informational?style=flat-square)
