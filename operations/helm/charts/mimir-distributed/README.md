...
> **Note:** The documentation version is derived from the Helm chart version which is 5.2.0-weekly.266.
...
![Version: 5.2.0-weekly.266](https://img.shields.io/badge/Version-5.2.0--weekly.266-informational?style=flat-square) ![AppVersion: r266](https://img.shields.io/badge/AppVersion-r266-informational?style=flat-square)
