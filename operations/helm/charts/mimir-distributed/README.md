...
> **Note:** The documentation version is derived from the Helm chart version which is 5.8.0-weekly.358.
...
![Version: 5.8.0-weekly.358](https://img.shields.io/badge/Version-5.8.0--weekly.358-informational?style=flat-square) ![AppVersion: r358](https://img.shields.io/badge/AppVersion-r358-informational?style=flat-square)
