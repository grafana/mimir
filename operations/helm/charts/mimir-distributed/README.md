...
> **Note:** The documentation version is derived from the Helm chart version which is 5.8.0-weekly.341.
...
![Version: 5.8.0-weekly.341](https://img.shields.io/badge/Version-5.8.0--weekly.341-informational?style=flat-square) ![AppVersion: r341](https://img.shields.io/badge/AppVersion-r341-informational?style=flat-square)
