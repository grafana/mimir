...
> **Note:** The documentation version is derived from the Helm chart version which is 5.5.0-weekly.312.
...
![Version: 5.5.0-weekly.312](https://img.shields.io/badge/Version-5.5.0--weekly.312-informational?style=flat-square) ![AppVersion: r312](https://img.shields.io/badge/AppVersion-r312-informational?style=flat-square)
