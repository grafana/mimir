...
> **Note:** The documentation version is derived from the Helm chart version which is 5.8.0-weekly.337.
...
![Version: 5.8.0-weekly.337](https://img.shields.io/badge/Version-5.8.0--weekly.337-informational?style=flat-square) ![AppVersion: r337](https://img.shields.io/badge/AppVersion-r337-informational?style=flat-square)
...
| https://grafana.github.io/helm-charts | rollout_operator(rollout-operator) | 0.26.0 |
