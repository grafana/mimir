...
> **Note:** The documentation version is derived from the Helm chart version which is 5.8.0-weekly.353.
...
![Version: 5.8.0-weekly.353](https://img.shields.io/badge/Version-5.8.0--weekly.353-informational?style=flat-square) ![AppVersion: r353](https://img.shields.io/badge/AppVersion-r353-informational?style=flat-square)
