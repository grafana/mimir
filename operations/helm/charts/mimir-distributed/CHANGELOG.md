...
* [CHANGE] **breaking change** The value `serviceMonitor` and everything under it is moved under `metaMonitoring.serviceMonitor` to group all meta-monitoring settings under one section. #2236
