...
* [ENHANCEMENT] Store-gateway: dynamically set `GOMAXPROCS` based on the CPU request. This should reduce the likelihood an high load on the store-gateway will slow down the entire Kubernetes node. #5104
