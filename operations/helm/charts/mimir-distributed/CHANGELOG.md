...
* [ENHANCEMENT] Enhanced `extraObjects` to support map format input where keys are ignored and values are extracted as manifests, improving flexibility for multiple values files input. #<PR>
