...
* [CHANGE] Remove deprecated `nginx` top-level values section. #12702
  * Use the `gateway` instead. Refer to https://grafana.com/docs/helm-charts/mimir-distributed/latest/migration-guides/migrate-to-unified-proxy-deployment/ for a detailed migration guide.
