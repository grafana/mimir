...
- With the pre-release, the release shepherd is responsible for coordinating or running the release candidate in any end user production environment for 3 days. This is typically done at Grafana Labs.
...
1. Make a PR to update `CHANGELOG.md` on main
   ...
   - The new section should say `## x.y.0 in progress`.
