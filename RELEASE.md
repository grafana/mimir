...
- [ ] Create new release branch
  ...
  - [ ] Adjust the settings in the `renovate.json` configuration on the main branch to ensure that dependency updates maintain the latest two minor versions. For instance, if the current release version is 3.0, this means keeping versions 3.0 and the latest minor version from major version 2, such as 2.x.
